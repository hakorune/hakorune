...
//!
//! This module is parser/MIR-neutral: parsers validate reserved names while MIR
//! plan builders can expand profiles into primitive facts through the main
//! crate compatibility re-export.
