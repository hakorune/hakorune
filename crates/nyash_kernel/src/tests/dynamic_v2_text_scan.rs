...
fn strict_text_scan_exports_are_linked_and_typed() {
    ...
    assert_eq!(out.disposition, DynamicV2CallDispositionV1::EndAuthorized as u32);
    ...
    assert_eq!(nyash_rust::runtime::dynamic_v2_lease::consume_end_authorized(token), Ok(()));
