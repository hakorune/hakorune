...
#[inline(always)]
pub(crate) fn store_array_str_reason_source_kind_via_object() {
    with_tls(ThreadCounters::store_array_str_reason_source_kind_via_object);
}

#[inline(always)]
pub(crate) fn store_array_str_reason_retarget_keep_source_arc() {
    with_tls(ThreadCounters::store_array_str_reason_retarget_keep_source_arc);
}
...
#[inline(always)]
pub(crate) fn borrowed_alias_as_str_fast_live_source() {
    with_tls(ThreadCounters::borrowed_alias_as_str_fast_live_source);
}

#[inline(always)]
pub(crate) fn borrowed_alias_as_str_fast_stale_source() {
    with_tls(ThreadCounters::borrowed_alias_as_str_fast_stale_source);
}

#[inline(always)]
pub(crate) fn borrowed_alias_array_len_by_index_latest_fresh() {
    with_tls(ThreadCounters::borrowed_alias_array_len_by_index_latest_fresh);
}

#[inline(always)]
pub(crate) fn borrowed_alias_array_indexof_by_index_latest_fresh() {
    with_tls(ThreadCounters::borrowed_alias_array_indexof_by_index_latest_fresh);
}
...
pub(crate) fn snapshot() -> [u64; 86] {
    ...
    [
        ...
        GLOBAL
            .borrowed_alias_as_str_fast_live_source
            .load(Ordering::Relaxed),
        GLOBAL
            .borrowed_alias_as_str_fast_stale_source
            .load(Ordering::Relaxed),
        GLOBAL
            .borrowed_alias_array_len_by_index_latest_fresh
            .load(Ordering::Relaxed),
        GLOBAL
        ...
        GLOBAL
            ...
            .load(Ordering::Relaxed),
        GLOBAL
            .store_array_str_reason_source_kind_via_object
            .load(Ordering::Relaxed),
        GLOBAL
