use super::handle_cache::{array_get_index_encoded_i64, with_array_box_borrowed};
...
pub(super) fn array_slot_has_index(handle: i64, idx: i64) -> i64 {
    ...
    with_array_box_borrowed(handle, |arr| if arr.has_index_i64(idx) { 1 } else { 0 }).unwrap_or(0)
}
