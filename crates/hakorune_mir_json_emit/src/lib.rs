//! MIR JSON DTO serializer boundary.
//!
//! This crate owns serialization for JSON-ready MIR export DTOs. It must not
//! depend on `MirModule`, MIR instructions, AST, runtime boxes, or the runner.

use serde_json::{json, Value};

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum MirJsonExportSchema {
    LegacyV0,
    V1,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum MirJsonExportRootKind {
    FunctionsOnly,
    SchemaVersioned,
}
...
pub struct MirJsonExportModelSummary {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct MirJsonFunctionExportSummary {
    pub name: String,
...
pub struct MirJsonExportSurface {
    pub key: String,
    pub value: Value,
}
...
#[derive(Debug, Clone, PartialEq)]
pub struct MirJsonExportInstruction {
    pub payload: Value,
}
...
#[derive(Debug, Clone, PartialEq)]
pub struct MirJsonExportBlock {
    pub id: u32,
    pub instructions: Vec<MirJsonExportInstruction>,
}

impl MirJsonExportBlock {
    pub fn new(id: u32, instructions: Vec<MirJsonExportInstruction>) -> Self {
        Self { id, instructions }
    }
}

#[derive(Debug, Clone, PartialEq)]
pub struct MirJsonExportFunction {
    pub name: String,
    pub params: Vec<u32>,
...
#[derive(Debug, Clone, PartialEq)]
pub struct MirJsonExportDocument {
    pub schema: MirJsonExportSchema,
    pub root_kind: MirJsonExportRootKind,
...
pub fn serialize_document(document: &MirJsonExportDocument) -> Value {
...
impl MirJsonExportModelSummary {
    ...
    pub fn is_schema_versioned(&self) -> bool {
