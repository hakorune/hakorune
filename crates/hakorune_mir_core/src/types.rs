/*!
 * MIR Core Types — shared type and operator shapes.
 *
 * This crate keeps the pure, low-dependency MIR value/type surface separate
 * from the larger `src/mir` workspace so future crate seams can be split
 * mechanically.
 */
