...
- None. `HAKO-ALLOC-USIZE-FIELD-GROUP-060` migrates the page model
  local-free collection counter group selected after the page-local counter
  group.
