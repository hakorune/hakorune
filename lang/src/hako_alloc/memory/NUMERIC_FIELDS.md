...
- None. `HAKO-ALLOC-USIZE-FIELD-GROUP-061` migrates the page model lifecycle
  event/reject counter group selected after the local-free collection counter
  group.
