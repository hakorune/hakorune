...
- `provider_activation_dry_run_unsupported_behavior_box.hako`
- `provider_activation_input_bundle_inventory_box.hako`
- `provider_activation_modeled_open_pilot_box.hako`
- `provider_activation_unsupported_outcome_ledger_box.hako`
- `provider_boundary_diagnostic_vocabulary_box.hako`
- `provider_call_capability_gate_inventory_box.hako`
- `provider_call_dry_run_unsupported_behavior_box.hako`
- `provider_call_execution_capability_preflight_box.hako`
- `provider_call_external_api_adapter_inventory_box.hako`
- `provider_call_external_api_adapter_preflight_box.hako`
- `provider_call_external_api_call_stub_execution_pilot_box.hako`
- `provider_call_modeled_open_pilot_box.hako`
- `provider_call_noop_execution_seam_pilot_box.hako`
- `provider_call_real_api_execution_preflight_box.hako`
- `provider_call_real_api_stub_execution_pilot_box.hako`
- `provider_inactive_boundary_inventory_box.hako`
- `provider_readiness_preflight_box.hako`
- `provider_selection_inventory_box.hako`
- `real_external_provider_api_adapter_execution_preflight_box.hako`
- `real_external_provider_api_call_first_pattern_pilot_box.hako`
