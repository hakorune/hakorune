...
- `segment_allocation_modeled_local_free_reuse_ledger_box.hako` owns
  MIMAP-130A, MIMAP-138A, MIMAP-142A, and MIMAP-192A. It may consume successful MIMAP-126A local-free
  ...
  and record the same deterministic live reuse row shape. It must not widen the bump-shaped
