...
- Migration plan SSOT: `docs/development/current/main/design/kernel-implementation-phase-plan-ssot.md`.
- Collection phases SSOT: `docs/development/current/main/design/array-map-owner-and-ring-cutover-ssot.md`.
