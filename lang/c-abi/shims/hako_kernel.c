...
static nyrt_hako_plugin_invoke_by_name_fn g_hako_plugin_invoke_by_name = NULL;
static nyrt_hako_future_spawn_instance_fn g_hako_future_spawn_instance = NULL;
static nyrt_hako_string_dispatch_fn g_hako_string_dispatch = NULL;
