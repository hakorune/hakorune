...
static void accepts(const char* json) {
  char* error = NULL;
  write_json(json);
  assert(hako_llvmc_validate_published_lifecycle_physical_v2(path, &error) == 0);
  assert(error == NULL);
}
...
int main(void) {
  ...
  const char* valid =
      ...
      "{\"name\":\"main\",\"role\":\"root_i64\",\"receiver\":null,\"params\":[],\"entry\":0,\"blocks\":["
  ...
  rejects_replace(valid, "\"args\":[{\"kind\":1,\"value\":4},{\"kind\":1,\"value\":6}]", "\"args\":[{\"kind\":1,\"value\":4}]", "function-body");
  ...
  rejects_replace(valid, "\"op\":\"return\",\"value\":5", "\"op\":\"return\",\"value\":0", "function-body");
  ...
  rejects_replace(valid, "hako.published-lifecycle-physical-program.v2", "hako.published-lifecycle-physical-program.v1", "schema");
  rejects_replace(valid, "\"receiver\":null", "\"receiver\":1", "function-body");
  rejects_replace(valid, "\"receiver\":0", "\"receiver\":null", "function-body");
  rejects_replace(valid, "\"receiver\":0", "\"receiver\":1", "function-body");
  rejects_replace(valid, "\"representation\":\"kind_payload_v1\"", "\"representation\":\"i64\"", "function-body");
  rejects_replace(valid, "\"value\":1,\"representation\":\"kind_payload_v1\"", "\"value\":2,\"representation\":\"kind_payload_v1\"", "function-body");
  rejects_replace(valid, "\"kind\":1,\"value\":4", "\"value\":4", "function-body");
  rejects_replace(valid, "\"kind\":1,\"value\":4", "\"kind\":3,\"value\":4", "function-body");
