...
static void rejects_body(
  ...
  assert(json);
  fputs("{\"functions\":[{\"name\":\"main\",\"blocks\":[{\"id\":7,\"instructions\":[{\"op\":\"const\"},{\"op\":\"const\"},{\"op\":\"const\"},{\"op\":\"published_lifecycle_invoke\",\"kind\":2,\"fault_frame\":4,\"normal\":8,\"fault\":9}]}]}]}", json);
  fclose(json);
