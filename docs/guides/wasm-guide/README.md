...
- **[WSM-P4-min7 契約ロック](../../development/current/main/phases/phase-29cc/29cc-177-wsm-p4-min7-buffer-file-binary-contract-lock-ssot.md)** - `.hako` binary writer 向け BufferBox/FileBox バイナリI/O API を固定した記録。
