...
| `tools/checks/k2_wide_mimap022a_next_row_selection_guard.sh` | MIMAP-022A の post-lifecycle row selection を固定し、次 row が MIMAP-022B facade huge-request fail-fast routing であること、current pointers / taskboard / granularity SSOT が同じ導線を指すことを検証する。 |
