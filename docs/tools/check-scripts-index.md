...
| `tools/checks/route_detector_legacy_surface_guard.sh` | JoinIR route detector の private `legacy/` storage が親 module や旧 compatibility path から再公開されないことを fail-fast で検出する。 |
