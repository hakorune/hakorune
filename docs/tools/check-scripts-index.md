...
| `tools/checks/k2_wide_mimalloc_facade_cleanup_reason_ssot_guard.sh` | MIMAP-FACADE-CLEAN-001 の facade reason-code SSOT と known-page scan helper を固定し、release/realloc の page-map lookup や numeric reason literal の再増殖を防ぐ。 |
