...
; M11b-decl static const table syntax.
; Declaration-only row: no table read expression or const evaluation yet.
...
- Static const tables: `static const NAME: u16[] = [...]` is accepted for M11b-decl. Reads from the table, const expressions, and const fn are still reserved.
