...
- Static const table declarations and reads are live for the narrow M11b `u16[]` row. Const eval remains reserved. See reference/language/types.md “Static Const Tables (M11b live)” and `docs/development/current/main/design/static-const-table-syntax-ssot.md`.
