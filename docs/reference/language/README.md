...
- Static const table declarations are live for the M11b-decl `u16[]` row. Reads and const eval remain reserved. See reference/language/types.md “Static Const Tables (M11b-decl live)” and `docs/development/current/main/design/static-const-table-syntax-ssot.md`.
