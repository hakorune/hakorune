...
Scope: JoinIR 回帰パックに real-world LoopBreak route（historical label 2）を追加（仕様不変）
...
- historical replay basename は retirement SSOT の replay lane を参照
...
- `docs/development/current/main/phases/phase-29ae/README.md`
  - Regression pack (SSOT) に `loop_break_realworld_vm` を追記
- `docs/development/current/main/10-Now.md`
  - JoinIR 回帰確認のSSOTが “この1本” であることは維持（記述の更新のみ）

current guidance では `loop_break_realworld_vm` と `apps/tests/loop_break_realworld_min.hako` を主語にし、
exact `phase263_pattern2_*` basename は inventory/evidence lane に閉じる。
