# 293x-876 HAKO-ALLOC-REPORT-RECORD-021 Allocation-Plan Diagnostic ReportFields Helper Scalarization Pilot
...
- Added `makeAllocationPlanDiagnosticReport(fields)` as the same-owner helper
  for the allocation-plan diagnostic `ReportFields` owner.
...
Select `HAKO-ALLOC-REPORT-RECORD-022` to close out the allocation-plan
