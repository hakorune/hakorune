...
- Added `makeAllocationLedgerDiagnosticReport(fields)` as the same-owner
  helper for the allocation-ledger diagnostic `ReportFields` owner.
...
Select `HAKO-ALLOC-REPORT-RECORD-016` to close out the allocation-ledger
