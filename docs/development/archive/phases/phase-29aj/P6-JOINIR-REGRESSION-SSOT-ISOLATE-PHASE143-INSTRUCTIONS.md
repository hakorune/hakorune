...
1) docs 更新
   - `docs/development/archive/phases/phase-29aj/README.md`
   - `docs/development/current/main/phases/phase-29ae/README.md`
   - `docs/development/current/main/10-Now.md`
   - `docs/development/current/main/30-Backlog.md`
   - `CURRENT_TASK.md`
2) phase143 legacy pack 追加
   - `tools/smokes/v2/profiles/archive/joinir/phase143_legacy_pack.sh` を SKIP で用意

## Verification

- `./tools/smokes/v2/run.sh --profile quick`
- `./tools/smokes/v2/profiles/integration/joinir/phase29ae_regression_pack_vm.sh`
- `./tools/smokes/v2/profiles/archive/joinir/phase143_legacy_pack.sh` (SKIP)
