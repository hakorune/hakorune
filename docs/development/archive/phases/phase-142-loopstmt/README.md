...
- [10-Now.md](../../../current/main/10-Now.md) - Current progress
- [30-Backlog.md](../../../current/main/30-Backlog.md) - Future phases
- [phase-143-loopvocab/README.md](../phase-143-loopvocab/README.md) - Next planned vocabulary expansion
- [normalized-expr-lowering.md](../../../current/main/design/normalized-expr-lowering.md) - Normalized design SSOT
- [control-tree.md](../../../current/main/design/control-tree.md) - ControlTree design
