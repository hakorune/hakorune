...
- SSOT:
  - `docs/development/archive/phases/phase-171x/171x-90-substring-concat-exact-seed-loop-shape-ssot.md`
  - `docs/development/archive/phases/phase-171x/171x-91-task-board.md`
- code owner seam:
  - `lang/c-abi/shims/hako_llvmc_ffi_string_loop_seed.inc`
