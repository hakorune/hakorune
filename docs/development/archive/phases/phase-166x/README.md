...
- precursor:
  - `docs/development/archive/phases/phase-165x/README.md`
- current snapshot:
...
- SSOT:
  - `docs/development/archive/phases/phase-166x/166x-90-semantic-refresh-and-generic-relation-ssot.md`
  - `docs/development/archive/phases/phase-166x/166x-92-boundary-lifecycle-decision.md`
