...
! rg -g '!docs/development/archive/phases/phase-29cv/P48-ARCHIVE-HAKO-CHECK-DEADCODE-SHIM.md' --fixed-strings 'tools/hako_check_deadcode_smoke.sh' docs/development/current/main docs/development/testing tools src lang Makefile dev README.md README.ja.md
