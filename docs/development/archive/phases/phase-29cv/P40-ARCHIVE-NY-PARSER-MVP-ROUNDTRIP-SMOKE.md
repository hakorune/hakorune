...
Related:
  - docs/development/archive/phases/phase-29cv/P39-ARCHIVE-STANDALONE-STAGEB-LOOP-CANARY.md
...
! rg -g '!docs/development/archive/phases/phase-29cv/P40-ARCHIVE-NY-PARSER-MVP-ROUNDTRIP-SMOKE.md' --fixed-strings 'tools/ny_parser_mvp_roundtrip.sh' docs/development/current/main docs/development/testing tools src lang
