...
Related:
  - docs/development/archive/phases/phase-29cv/P33-DELETE-LAST-BLOCKERS-ONLY.md
  - docs/development/archive/phases/phase-29cv/P37-PROGRAM-JSON-V0-COMPAT-CAPSULE-SSOT.md
  - docs/development/archive/phases/phase-29ci/P24-STAGE1-CONTRACT-MODE-ALIAS-PRUNE.md
...
| 3 | Program(JSON)->MIR bridge capsule | `tools/selfhost/lib/program_json_mir_bridge.sh`, `tools/dev/phase29cg_stage2_bootstrap_phi_verify.sh`, `tools/selfhost_exe_stageb.sh` (`stageb-delegate`) | explicit capsule / keep |
...
| 5 | Stage-B / Core / JoinIR fixture capsule | `tools/smokes/v2/lib/stageb_helpers.sh`, `phase29bq_hako_program_json_contract_pin_vm.sh`, `phase29bq_hako_mirbuilder_*`, Stage-B/Core fixture smokes | true keeper |
