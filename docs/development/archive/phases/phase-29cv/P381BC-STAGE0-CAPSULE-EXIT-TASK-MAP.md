...
Related:
  - docs/development/archive/phases/phase-29cv/P381AT-UNIFORM-MULTI-FUNCTION-EMITTER-GAP-PLAN.md
  - docs/development/archive/phases/phase-29cv/P381AV-SELECTED-SET-FIRST-SLICE.md
  - docs/development/archive/phases/phase-29cv/P381AW-SELECTED-DECLARATIONS-ONLY.md
  - docs/development/archive/phases/phase-29cv/P381BA-REMAINING-CAPSULE-RETIRE-INVENTORY.md
...
Status: landed in
`docs/development/archive/phases/phase-29cv/P381BD-STAGE0-MEASUREMENT-SCOPE-LOCK.md`.
...
Status: landed in
`docs/development/archive/phases/phase-29cv/P381BE-UNIFORM-BODY-EMITTER-CONTRACT-INVENTORY.md`.
...
`docs/development/archive/phases/phase-29cv/P381BF-VOID-LOGGING-DIRECT-CONTRACT-SHRINK.md`;
Rust-side downstream return-contract readers landed in
`docs/development/archive/phases/phase-29cv/P381BG-GLOBAL-CALL-RETURN-CONTRACT-READERS.md`;
return-contract storage landed in
`docs/development/archive/phases/phase-29cv/P381BH-GLOBAL-CALL-RETURN-CONTRACT-STORAGE.md`;
proof storage landed in
`docs/development/archive/phases/phase-29cv/P381BI-GLOBAL-CALL-PROOF-CONTRACT-STORAGE.md`;
target-shape retirement landed in
`docs/development/archive/phases/phase-29cv/P381BJ-VOID-LOGGING-TARGET-SHAPE-RETIRE.md`;
the first static-array Rust consumer decoupling landed in
`docs/development/archive/phases/phase-29cv/P381BK-STATIC-ARRAY-CONSUMER-CONTRACT-READ.md`;
static-array target-shape retirement landed in
`docs/development/archive/phases/phase-29cv/P381BL-STATIC-ARRAY-TARGET-SHAPE-RETIRE.md`;
MIR-schema map target-shape retirement landed in
`docs/development/archive/phases/phase-29cv/P381BM-MIR-SCHEMA-MAP-TARGET-SHAPE-RETIRE.md`;
Parser Program(JSON) target-shape retirement landed in
`docs/development/archive/phases/phase-29cv/P381BN-PARSER-PROGRAM-JSON-TARGET-SHAPE-RETIRE.md`;
...
`docs/development/archive/phases/phase-29cv/P381BP-PATTERN-UTIL-LOCAL-VALUE-PROBE-TARGET-SHAPE-RETIRE.md`;
generic string-or-void sentinel target-shape retirement landed in
`docs/development/archive/phases/phase-29cv/P381BQ-GENERIC-STRING-OR-VOID-SENTINEL-TARGET-SHAPE-RETIRE.md`.
...
`docs/development/archive/phases/phase-29cv/P381BR-MODULE-GENERIC-SELECTED-KIND-REGISTRY.md`.
...
`docs/development/archive/phases/phase-29cv/P381BS-PARSER-PROGRAM-JSON-BODY-EMITTER-BLOCKER.md`;
...
`docs/development/archive/phases/phase-29cv/P381BT-MODULE-GENERIC-ARRAY-PUSH-HELPER-CLEANUP.md`:
...
`docs/development/archive/phases/phase-29cv/P381BU-MODULE-GENERIC-ARRAY-APPEND-EMIT-HELPER-CLEANUP.md`:
...
`docs/development/archive/phases/phase-29cv/P381BV-MODULE-GENERIC-STRING-NEEDLE-CALL-HELPER-CLEANUP.md`:
...
`docs/development/archive/phases/phase-29cv/P381BW-MODULE-GENERIC-GET-HELPER-SYMBOL-CLEANUP.md`:
...
`docs/development/archive/phases/phase-29cv/P381BX-MODULE-GENERIC-LEN-HELPER-SYMBOL-CLEANUP.md`:
...
`docs/development/archive/phases/phase-29cv/P381BY-MODULE-GENERIC-I64-CALL-EMIT-HELPER-CLEANUP.md`:
...
`docs/development/archive/phases/phase-29cv/P381BZ-MODULE-GENERIC-BIRTH-CALL-EMIT-HELPER-CLEANUP.md`:
...
`docs/development/archive/phases/phase-29cv/P381CP-MIR-CALL-EXTERN-VIEW-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381CQ-MIR-CALL-EXTERN-NEED-CONTRACT-CLEANUP.md`:
...
`docs/development/archive/phases/phase-29cv/P381CR-GENERIC-METHOD-ROUTE-TUPLE-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381CS-MODULE-GENERIC-OWNERLESS-VIEW-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381CT-MODULE-GENERIC-PREPASS-VIEW-REUSE.md`:
...
`docs/development/archive/phases/phase-29cv/P381CU-MODULE-GENERIC-METHOD-DISPATCH-VIEW-REUSE.md`:
...
`docs/development/archive/phases/phase-29cv/P381CV-MODULE-GENERIC-ORIGIN-PUBLISH-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381CW-MODULE-GENERIC-I64-ORIGIN-PUBLISH-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381CX-MODULE-GENERIC-MIR-JSON-KEY-ORIGIN-HELPERS.md`:
...
`docs/development/archive/phases/phase-29cv/P381CY-MODULE-GENERIC-GET-ROUTE-VIEW.md`:
...
`docs/development/archive/phases/phase-29cv/P381CZ-MODULE-GENERIC-PREPASS-GET-ROUTE-VIEW.md`:
...
`docs/development/archive/phases/phase-29cv/P381DA-MODULE-GENERIC-PREPASS-METHOD-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DB-MODULE-GENERIC-METHOD-EMIT-DISPATCH-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DC-MODULE-GENERIC-METHOD-BIRTH-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DD-MODULE-GENERIC-GLOBAL-EMIT-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DE-MODULE-GENERIC-METHOD-EMIT-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DF-MODULE-GENERIC-PREPASS-GLOBAL-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DG-MODULE-GENERIC-PREPASS-CALL-INSTRUCTION-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DH-MODULE-GENERIC-EMIT-CALL-INSTRUCTION-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DI-MODULE-GENERIC-EMIT-EXTERNCALL-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DJ-MODULE-GENERIC-EMIT-RET-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DK-MODULE-GENERIC-EMIT-CONST-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DL-MODULE-GENERIC-EMIT-CONTROL-TERMINATOR-HELPERS.md`:
...
`docs/development/archive/phases/phase-29cv/P381DM-MODULE-GENERIC-EMIT-INSTRUCTION-DISPATCH.md`:
...
`docs/development/archive/phases/phase-29cv/P381DN-MODULE-GENERIC-PREPASS-INSTRUCTION-DISPATCH.md`:
...
`docs/development/archive/phases/phase-29cv/P381DO-MODULE-GENERIC-FUNCTION-SIGNATURE-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DP-MODULE-GENERIC-FUNCTION-CONTEXT-SNAPSHOT.md`:
...
`docs/development/archive/phases/phase-29cv/P381DQ-MODULE-GENERIC-FUNCTION-CONTEXT-ACTIVATE.md`:
function context activation now has one named transition helper.

Module-generic function emit pipeline cleanup landed in
`docs/development/archive/phases/phase-29cv/P381DR-MODULE-GENERIC-FUNCTION-EMIT-PIPELINE.md`:
...
`docs/development/archive/phases/phase-29cv/P381DS-MODULE-GENERIC-FUNCTION-ELIGIBILITY-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DT-MODULE-GENERIC-RESTORE-LABEL-PRUNE.md`:
...
`docs/development/archive/phases/phase-29cv/P381DU-MODULE-GENERIC-FUNCTION-VIEW-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DV-MODULE-GENERIC-PLANNED-DEFINITION-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DW-PHASE1-UNIFORM-MIR-DEFINITION-OWNER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DX-LOWERING-PLAN-GLOBAL-CALL-PROOF-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381DY-SAME-MODULE-DEFINITION-HELPER-NAME.md`:
...
`docs/development/archive/phases/phase-29cv/P381DZ-SAME-MODULE-FUNCTION-REGISTRY-NAMES.md`:
the Stage0 selected-set registry now uses same-module function wording instead
of module-generic string wording.

Same-module function entry naming cleanup landed in
`docs/development/archive/phases/phase-29cv/P381EA-SAME-MODULE-FUNCTION-ENTRY-NAMES.md`:
...
`docs/development/archive/phases/phase-29cv/P381EB-SAME-MODULE-REGISTRY-DIAGNOSTIC.md`:
...
`docs/development/archive/phases/phase-29cv/P381EC-BOX-TYPE-INSPECTOR-UNIFORM-OWNER.md`:
...
`docs/development/archive/phases/phase-29cv/P381ED-PATTERN-UTIL-PROBE-UNIFORM-OWNER.md`:
PatternUtil local-value probe direct-call definitions now serialize
`definition_owner=uniform_mir` with runner MIR JSON owner/trace coverage.

Void logging runner MIR JSON coverage landed in
`docs/development/archive/phases/phase-29cv/P381EE-VOID-LOGGING-JSON-COVERAGE.md`:
...
MirSchema map-constructor runner MIR JSON coverage landed in
`docs/development/archive/phases/phase-29cv/P381EF-MIR-SCHEMA-MAP-JSON-COVERAGE.md`:
MirSchema map-constructor routes and lowering plans now pin
`definition_owner=uniform_mir` and `emit_trace_consumer=mir_call_global_uniform_mir_emit`.

Same-module definition boundary rename landed in
`docs/development/archive/phases/phase-29cv/P381EG-SAME-MODULE-DEFINITION-BOUNDARY-NAMES.md`:
...
`docs/development/archive/phases/phase-29cv/P381EH-SAME-MODULE-PREPASS-SPLIT.md`:
...
`docs/development/archive/phases/phase-29cv/P381EI-MODULE-GENERIC-I64-HELPER-NAME.md`:
...
`docs/development/archive/phases/phase-29cv/P381EJ-UNIFORM-MIR-HELPER-NAME.md`:
...
`docs/development/archive/phases/phase-29cv/P381EK-PRINT-PREPASS-SPLIT.md`:
the local module-generic string print fallback now sits behind its own helper.

Same-module planner lookup cleanup landed in
`docs/development/archive/phases/phase-29cv/P381EL-SAME-MODULE-LOOKUP-SCOPE.md`:
...
`docs/development/archive/phases/phase-29cv/P381EM-GLOBAL-CALL-READINESS-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381EN-STRING-OR-VOID-SENTINEL-UNIFORM-OWNER.md`:
...
`docs/development/archive/phases/phase-29cv/P381EO-STAGE0-GLOBAL-CALL-TARGET-SHAPE-READ-PRUNE.md`:
...
`docs/development/archive/phases/phase-29cv/P381EP-GLOBAL-CALL-DEFINITION-PREPASS-NAME.md`:
...
`docs/development/archive/phases/phase-29cv/P381EQ-GLOBAL-CALL-DEFINITION-EDGE-PLANNER-NAME.md`:
...
`docs/development/archive/phases/phase-29cv/P381ER-SAME-MODULE-FUNCTION-PLAN-FILE.md`:
...
`docs/development/archive/phases/phase-29cv/P381ES-SAME-MODULE-METHOD-VIEWS-FILE.md`:
...
`docs/development/archive/phases/phase-29cv/P381ET-SAME-MODULE-FUNCTION-EMIT-FILE.md`:
...
`docs/development/archive/phases/phase-29cv/P381EU-SAME-MODULE-METHOD-VIEW-HELPER-NAMES.md`:
...
`docs/development/archive/phases/phase-29cv/P381EV-SAME-MODULE-FUNCTION-HELPER-NAMES.md`:
...
`docs/development/archive/phases/phase-29cv/P381EW-EXTERN-RUNTIME-ROUTE-MATCH-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381EX-MIR-CALL-NEED-FLAGS-NAME.md`:
...
`docs/development/archive/phases/phase-29cv/P381EY-GENERIC-METHOD-SYMBOLIC-ROUTE-MATCH-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381EZ-GENERIC-METHOD-NEED-RULE-NAMES.md`:
...
`docs/development/archive/phases/phase-29cv/P381GK-MIR-CALL-EXTERN-EMIT-RULE-SSOT.md`:
...
`docs/development/archive/phases/phase-29cv/P381GL-SAME-MODULE-METHOD-VIEW-KEY-HELPER.md`:
...
`docs/development/archive/phases/phase-29cv/P381GM-STAGE1-EMIT-PROGRAM-RUNTIME-HELPER-REPAIR.md`:
...
P381GC fixes the current T6 bucket counts and the first-wave rule. P381GD fixes
`tools/checks/smoke_inventory_report.sh` so per-script orphan summaries read the
