...
Related:
  ...
  - docs/development/archive/phases/phase-29cv/P38-CAPSULE-POINTER-DOCS-SYNC.md
...
! rg --fixed-strings 'tools/dev/stageb_loop_json_canary.sh' docs/development/current/main docs/development/testing tools src lang --glob '!docs/development/archive/phases/phase-29cv/P39-ARCHIVE-STANDALONE-STAGEB-LOOP-CANARY.md'
