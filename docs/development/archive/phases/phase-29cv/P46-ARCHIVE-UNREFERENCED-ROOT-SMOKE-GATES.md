...
Related:
  - docs/development/archive/phases/phase-29cv/P45-ARCHIVE-UNREFERENCED-ROOT-PHASE-TEST-WRAPPERS.md
...
! rg -g '!docs/development/archive/phases/phase-29cv/P46-ARCHIVE-UNREFERENCED-ROOT-SMOKE-GATES.md' --fixed-strings \
