...
Related:
  - docs/development/archive/phases/phase-29cv/P41-ARCHIVE-PHASE15-STAGE2-PARSER-MVP-SMOKES.md
...
! rg -g '!docs/development/archive/phases/phase-29cv/P42-REPAIR-NY-ROUNDTRIP-SMOKE-CONTRACT.md' --fixed-strings 'tools/ny_parser_run.sh' docs/development/current/main docs/development/testing tools src lang Makefile dev README.md README.ja.md
