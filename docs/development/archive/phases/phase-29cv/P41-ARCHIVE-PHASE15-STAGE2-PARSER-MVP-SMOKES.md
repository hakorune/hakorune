...
Related:
  - docs/development/archive/phases/phase-29cv/P40-ARCHIVE-NY-PARSER-MVP-ROUNDTRIP-SMOKE.md
...
! rg -g '!docs/development/archive/phases/phase-29cv/P41-ARCHIVE-PHASE15-STAGE2-PARSER-MVP-SMOKES.md' --fixed-strings \
