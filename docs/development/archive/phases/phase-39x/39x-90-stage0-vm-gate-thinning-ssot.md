...
| --- | --- |
| `tools/selfhost/selfhost_build.sh` | `tools/smokes/v2/profiles/integration/selfhost/selfhost_minimal.sh`, `tools/smokes/v2/profiles/quick/selfhost/selfhost_build_{binop,return}_vm.sh`, `tools/smokes/v2/profiles/quick/selfhost/selfhost_build_exe_return.sh`, `tools/selfhost/README.md`, `docs/development/current/main/design/selfhost-bootstrap-route-ssot.md` |
...
| `tools/selfhost/run_stage1_cli.sh` | `tools/selfhost/stage1_mainline_smoke.sh`, `docs/development/archive/phases/phase-39x/README.md`, `docs/development/current/main/05-Restart-Quick-Resume.md` |
| `tools/selfhost/stage1_mainline_smoke.sh` | `docs/development/archive/phases/phase-39x/README.md`, `docs/development/current/main/10-Now.md`, `docs/development/current/main/15-Workstream-Map.md` |
