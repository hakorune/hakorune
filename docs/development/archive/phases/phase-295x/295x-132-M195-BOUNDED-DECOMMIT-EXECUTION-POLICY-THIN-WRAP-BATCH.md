...
Status: Landed
Date: 2026-05-25
Scope: thin-wrap the M195 bounded decommit execution policy guard root into an impl-backed wrapper and keep the memory README owner note in sync.
Related:
  - tools/checks/k2_wide_hako_alloc_bounded_decommit_policy_guard.sh
  - tools/checks/impl/k2_wide_hako_alloc_bounded_decommit_policy_guard.sh
  - lang/src/hako_alloc/memory/README.md
---

# 295x-132 M195 Bounded Decommit Execution Policy Thin-Wrap Batch
...
Thin-wrap the M195 bounded decommit execution policy guard root. The batch
...
- `k2_wide_hako_alloc_bounded_decommit_policy_guard.sh`

## Cleanup

- Keep the root script as a thin wrapper that execs its impl body.
- Keep the M195 bounded decommit execution policy owner visible in
  `lang/src/hako_alloc/memory/README.md`.
- Leave the current mimalloc comparison blocker unchanged.

## Result

The M195 bounded decommit execution policy guard is now easier to scan at the
