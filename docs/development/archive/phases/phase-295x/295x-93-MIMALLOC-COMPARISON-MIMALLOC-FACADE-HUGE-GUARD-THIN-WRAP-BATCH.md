...
Status: Landed
Date: 2026-05-25
Scope: thin-wrap the remaining mimalloc facade huge guard roots into impl-backed wrappers.
Related:
...
# 295x-93 Mimalloc Comparison Mimalloc Facade Huge Guard Thin-Wrap Batch

## Blocker

```text
MIMALLOC-COMPARISON-MIMALLOC-FACADE-HUGE-GUARD-THIN-WRAP-BATCH-295X-001
```

## Decision

Thin-wrap the remaining mimalloc facade huge guard roots first. The selected
...
- `k2_wide_mimalloc_facade_huge_unregister_exe_guard.sh`
- `k2_wide_mimalloc_facade_huge_failfast_exe_guard.sh`
