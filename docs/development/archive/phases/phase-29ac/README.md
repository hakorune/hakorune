...
- legacy label-6 / label-7 fixture pin families are tracked in [phase-29ad/README.md](/home/tomoaki/git/hakorune-selfhost/docs/development/archive/phases/phase-29ad/README.md); active current entries are the two semantic regression packs above
