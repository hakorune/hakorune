...
- ✅ COMPLETE
- 指示書: `docs/development/archive/phases/phase-29ag/P0-COORDINATOR-USES-BOUNDARY-CARRIER-LAYOUT-INSTRUCTIONS.md`

## P1: Eliminate ValueId(i) fallback; remap via boundary.join_inputs

- ✅ COMPLETE
- 指示書: `docs/development/archive/phases/phase-29ag/P1-COORDINATOR-REMAPPERS-USE-JOIN_INPUTS-INSTRUCTIONS.md`
