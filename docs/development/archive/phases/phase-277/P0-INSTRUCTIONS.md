...
入口SSOT:
- `docs/development/archive/phases/phase-277/README.md`

参照:
- P0設計メモ: `docs/development/archive/phases/phase-277/P0-DESIGN.md`
- P2完了（env var 統合）: `docs/development/archive/phases/phase-277/P2-COMPLETION.md`
...
`docs/development/archive/phases/phase-277/README.md` に以下の節を追加/更新して、READMEだけ読めば導線が分かる状態にする。
