...
- 設計メモ（このPhase配下のSSOT案）:
  - `docs/development/archive/phases/phase-277/P0-DESIGN.md`
- 指示書（Claude Code）:
  - `docs/development/archive/phases/phase-277/P0-INSTRUCTIONS.md`
...
- 検証メモ（このPhase配下のSSOT案）:
  - `docs/development/archive/phases/phase-277/P1-VALIDATION.md`
- 指示書（Claude Code）:
  - `docs/development/archive/phases/phase-277/P1-INSTRUCTIONS.md`
- 完了報告:
  - `docs/development/archive/phases/phase-277/P1-COMPLETION.md`
...
- **根治（パイプライン二重化の解消）**: `docs/development/archive/phases/phase-279/README.md`
