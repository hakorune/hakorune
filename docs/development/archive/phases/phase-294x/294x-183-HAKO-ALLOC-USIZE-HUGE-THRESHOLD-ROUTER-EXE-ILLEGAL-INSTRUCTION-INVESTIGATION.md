...
Related:
  ...
  - docs/development/archive/phases/phase-294x/294x-180-HAKO-ALLOC-USIZE-HUGE-THRESHOLD-OBSERVER-SELECTION.md
  - docs/development/archive/phases/phase-294x/294x-181-HAKO-ALLOC-USIZE-HUGE-THRESHOLD-OBSERVER-DEFER-ALIGNED-PADDED-SELECTION.md
  - docs/development/archive/phases/phase-294x/294x-182-HAKO-ALLOC-USIZE-ALIGNED-SMALL-PADDED-SIZE.md
