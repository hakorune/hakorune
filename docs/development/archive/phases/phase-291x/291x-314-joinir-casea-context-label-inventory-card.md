...
Related:
  ...
  - docs/development/archive/phases/phase-291x/291x-311-joinir-casea-name-policy-inventory-card.md
  - docs/development/archive/phases/phase-291x/291x-312-joinir-casea-target-descriptor-table-card.md
  - docs/development/archive/phases/phase-291x/291x-313-joinir-casea-fallback-dispatch-descriptor-card.md
---
