...
Related:
  ...
  - docs/development/archive/phases/phase-291x/291x-575-plan-compat-residue-inventory-card.md
  - docs/development/archive/phases/phase-291x/291x-577-unused-plan-facts-wrapper-prune-card.md
  - docs/development/archive/phases/phase-291x/291x-578-small-plan-facts-owner-path-migration-card.md
