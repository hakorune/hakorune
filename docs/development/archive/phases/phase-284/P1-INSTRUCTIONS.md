...
前提SSOT（P0）:
- `docs/development/archive/phases/phase-284/README.md`
- Phase 282 の境界ルール（SSOT=extract / close-but-unsupported=Err）: `docs/development/archive/phases/phase-282/README.md`
...
成果物: `docs/development/archive/phases/phase-284/P1-NOTES.md`（短い箇条書きでOK）
