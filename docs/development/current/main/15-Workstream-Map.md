...
| Front | `array/string windows, generic_method.has, Sum seeds, UserBox seeds, array_getset_micro, MapBox duplicate receiver, and Hako LL/provider predelete fixes landed` |
| Guardrail | `phase-137x observe-only perf reopen rule` |
| Blocker | `retry pure_compile_minimal_paths #1/#2 deletion` |
| Next | `pure_compile_minimal_paths delete-probe #1/#2` |
| After Next | `pure_compile_minimal_paths Map/Array paths, then String const-eval decision` |
...
27. `phase-292x retry pure_compile_minimal_paths delete-probe #1/#2`
