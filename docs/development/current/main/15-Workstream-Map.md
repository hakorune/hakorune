...
| Blocker | `phase-291x CoreMethod one-family mirror migration pending` |
| Next | `migrate one CoreMethod mirror family only after the no-growth preflight` |
...
2. Migrate one CoreMethod mirror family only after the no-growth preflight.
