...
| Blocker | `phase-291x Stage-B main detection helper split pending` |
| Next | `continue Stage-B adapter thinning with the main detection helper split` |
...
2. Continue Stage-B adapter thinning with the main detection helper split.
