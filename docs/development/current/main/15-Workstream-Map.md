...
| Blocker | `phase-291x Stage-B args/source resolver split pending` |
| Next | `continue Stage-B adapter thinning with the args/source resolver split` |
...
2. Continue Stage-B adapter thinning with the args/source resolver split.
