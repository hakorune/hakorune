...
(`"name" => "main"`, `"params" => []`, `"locals" => []`) and the
...
`EntryStore(Opaque)` payload representation (a `CheckedMapPayload`
Text/Array/MapChild variant Decision), then `ArgumentHandoff` (call-edge
