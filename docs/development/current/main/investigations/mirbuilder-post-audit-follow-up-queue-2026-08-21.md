...
| `MIR-CALL-COMPATIBILITY-RETIRE-R7-D0` | **Design stop; first owner selected 2026-09-11**; [owner-unit retirement card](./mir-call-compatibility-retire-r7-d0-2026-09-11.md) | existing M7-S compatibility owners | strict/dev JSON-v0 `boxcall` ingress is the first bounded reader-stop owner; release compatibility remains live | record the exact caller, named terminal, mutation evidence, and exclusive strict/dev delete-set in the existing `MIR-CALL-LEGACY-READER-STOP-R0`; no aggregate LegacyCallV0 deletion or second resolver |
