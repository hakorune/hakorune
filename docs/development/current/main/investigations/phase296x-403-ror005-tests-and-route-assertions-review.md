...
Status: Draft
Date: 2026-05-30
Scope: row403 ROR-005 tests and route assertions review
Related:
...
The tests pin the current route split well enough to keep the row403 route-order inventory honest, but they are still surface assertions rather than deep semantic proofs.
