...
33. Phase 87: LLVM Exe Line SSOT ✅
   ...
   - **Deliverables**:
     ...
     - Integration smoke: `tools/smokes/v2/profiles/integration/apps/archive/phase87_llvm_exe_min.sh` (SKIP if no LLVM)
...
- current active selfhost lane は `phase-29bq` だよ
  - blocker=`none`
