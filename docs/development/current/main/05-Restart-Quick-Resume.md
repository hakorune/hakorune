...
- latest known checkpoint: `291x-464` inventories direct
  `GenericMethodRoute` construction sites
...
- implement `GenericMethodRoute::new` and remove direct route literals
