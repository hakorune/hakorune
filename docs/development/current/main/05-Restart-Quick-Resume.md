...
- current blocker token: `MIMAP-246A segment arena backing no-escape address capability closeout pack`
...
- continue `phase-293x` with `MIMAP-246A`; current blocker is
  segment arena backing no-escape address capability closeout pack
- latest allocator row: `MIMAP-245A` landed and selected MIMAP-246A
