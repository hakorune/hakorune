...
- current blocker token: `MIMAP-011 allocator facade lifecycle route pilot`
...
- continue `phase-293x` after MIMAP-010; next blocker is MIMAP-011 allocator facade lifecycle route pilot
