...
- continue `phase-293x` after `GLOBAL-STRING-BODY-ANALYSIS-SPLIT-002`;
  current blocker is `NUMERIC-SUBSTRATE-SPLIT-001`, a numeric substrate
  owner-layout cleanup
- next row: selected row after `NUMERIC-SUBSTRATE-SPLIT-001`
