...
- continue `phase-293x` after `MIMAP-048B`; current blocker is `MIMAP-049A`,
  the secure entropy source inventory
- next row: add the read-only inventory owner/proof/guard without opening
