...
- continue `phase-293x` after `MIMAP-047B`; current blocker is `MIMAP-048A`,
  the OSVM release capability inventory
- next row: document/guard the release boundary without opening release
