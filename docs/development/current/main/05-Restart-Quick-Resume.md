...
- handoff frontier: `LANGV1-FAILURE-OUTCOME-S4-EXHAUSTIVENESS-CHECKER-001`
- read `docs/development/current/main/phases/phase-296x/3509-LANGV1-FAILURE-OUTCOME-S4-EXHAUSTIVENESS-CHECKER-001.md`
