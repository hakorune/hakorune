...
- current blocker token: `GEN-001 generic type annotation metadata capsule`
...
- continue `phase-293x` after USES-001; next blocker is GEN-001 generic type annotation metadata capsule
