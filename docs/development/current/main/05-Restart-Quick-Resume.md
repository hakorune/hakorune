...
- Script classification, CONTRACT0, ENTRY-SELECTION0, SOURCE-ENTRY0, and PHYSICAL-THUNK0 are closed. The next exact task is the
  disconnected `ENTRY-RESULT-PROJECTION0-VM-REFERENCE0` slice. Normal-entry cutover,
