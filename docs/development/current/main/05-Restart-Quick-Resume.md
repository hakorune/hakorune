...
- Script classification and CONTRACT0 are closed. The next exact task is the
  disconnected `ENTRY-RESULT-PROJECTION0-ENTRY-SELECTION0` slice. Normal-entry cutover,
