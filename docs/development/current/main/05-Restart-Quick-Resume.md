...
- continue `phase-293x` after `GENERIC-METHOD-ROUTE-SPLIT-004`; current
  blocker is `GLOBAL-STRING-BODY-ANALYSIS-SPLIT-001`, a generic string body
  analysis cleanup
- next row: selected row after `GLOBAL-STRING-BODY-ANALYSIS-SPLIT-001`
