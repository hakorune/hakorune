...
- continue `phase-293x` after `PROOF-APPS-MANIFEST-SCHEMA-002`; current
  blocker is `EXPRS-INDEXING-001`, a MIR builder indexing owner cleanup
- next row: selected row after `EXPRS-INDEXING-001`
