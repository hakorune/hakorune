...
- SA0, disconnected SA1 shadow resolution, and SA2 canonical verification,
  seal, and normalized graph are closed; the active slice is SA3 atomic
  BindingId authority cutover named by `latest_card_path`
