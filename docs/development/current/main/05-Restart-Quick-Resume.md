...
- Script classification, CONTRACT0, ENTRY-SELECTION0, SOURCE-ENTRY0, PHYSICAL-THUNK0, VM-REFERENCE0, and EXE-AOT0 are closed. The next exact task is the
  disconnected `ENTRY-RESULT-PROJECTION0-PARITY-G0` slice. Normal-entry cutover,
