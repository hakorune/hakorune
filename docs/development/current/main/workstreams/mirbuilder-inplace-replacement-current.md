...
| E | Loop/M8 S6/M9 S7 | Active internal design in [existing D0](../investigations/generic-loop-mainline-source-front-d0-2026-09-23.md): source-backed GenericV1 CorePlan caller -> portable whole-callable consumer -> selected old edge and acceptance. NoExistingObserver is missing evidence, not owner absence or external wait. Resolve control/prelude/tail/ABI mapping before implementation; same-run tests and caller-zero are outputs. No S6E/S6G/M9 completion claim. |
