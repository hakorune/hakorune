...
Smallest next slice: bind affine Lifecycle Call and original Completion in existing emitter/ledger; record Normal projection and full pending cleanup with two exact ingress paths. Physical Unit/I64 contract passes Invoke16/package155/physical+JSON10; max744. Ordinary exporter/install remain stopped. Do not weaken one-entry validation without recorded Call ingress. Retention and baseline evidence remain in Map owner; no repeated census.
