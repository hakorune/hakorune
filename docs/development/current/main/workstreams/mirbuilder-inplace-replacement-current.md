...
| B | M7-S remaining owner-unit Stop/Promote/Delete | Closed as `NoSafeSlice__M7SNoRemainingUnsharedDeleteSet`: the finite reader matrix found no exclusive delete set. Do not split shared owners by callee or reopen the census without a changed caller/owner premise. |
...
| E | Loop/M8 S6/M9 S7 | Repair closed ([I0](../investigations/generic-loop-source-facts-accessor-compile-repair-i0-2026-09-23.md)); fixed VM front is retired Compatibility, not selected source evidence ([closure](../investigations/generic-post-selection-static-call-site-identity-d0-2026-09-23.md)). Current D0 designs one MIR source-front observation ([task](../investigations/generic-loop-mainline-source-front-d0-2026-09-23.md)); no S6E/S6G producer or M9 parity until its outcome is proven. |
