...
| E | Loop/M8 S6/M9 S7 | Landed [Continue](../investigations/generic-loop-mainline-source-front-d0-2026-09-23.md) `993fd3c943`, [in-body-step](../investigations/generic-loop-mainline-in-body-step-front-d0-2026-09-23.md) `897ac4ba8c`, [derived-predicate](../investigations/generic-loop-mainline-derived-predicate-front-d0-2026-09-23.md) `0adb0fb8af` D0s: RC 4/3/4+release PASS, raw reach zero; reds baseline. S6E P1 batch1 `849daed591` (12: 9 reject/3 pre-loop); next `route-observation-p1-batch2`. |
