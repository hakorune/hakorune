...
Smallest next slice: observe three-owner Fault order through the existing selected runtime probe, keeping the source-ordered groups and explicit two-local cohort guard unchanged.
