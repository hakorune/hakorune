...
| E | Loop/M8 S6 and Loop/M9 S7 | Active design stop: recheck only pinned `generic_loop_continue_strict_shadow_vm` / `phase29ca_generic_loop_continue_min.hako` through `GENERIC-LEGACY-OBSERVATION-FRONT-G0` ([card](../investigations/generic-legacy-observation-front-g0-premise-recheck-2026-09-23.md)). Require Loop-reached or exact named pre-Loop terminal before serial P1 observations. No corpus recensus, S6E producer, S6G, or M9 parity yet. |
