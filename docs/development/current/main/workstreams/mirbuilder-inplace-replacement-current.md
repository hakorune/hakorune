...
| F | `LOOP-PRODUCTION-SELECTION-D0` → Loop/M10b → M11 → M12 | VAR `b579959a3d`; R0 `6e88441c0b`; guard re-pin `a97f564250`; M11-A `9f55aea31b`; M11-B `8dff99ef22`. M12-R2A landed the [disposition manifest](../design/fixtures/loop-legacy-family-disposition-r2a-v1.tsv) ([card](../investigations/joinir-loop-legacy-family-disposition-r2a-2026-09-25.md)): residual + oracle-only chains -> R2B; break cohort, 19-row schedule, issuer route-vector, facts-layer keys -> decide. Open: R2B/R2C/R2G. |
