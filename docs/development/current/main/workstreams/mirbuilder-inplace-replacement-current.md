...
| E | Loop/M8 S6/M9 S7 | Landed [Continue D0](../investigations/generic-loop-mainline-source-front-d0-2026-09-23.md) `993fd3c943`, [in-body-step D0](../investigations/generic-loop-mainline-in-body-step-front-d0-2026-09-23.md) `897ac4ba8c`, [derived-predicate D0](../investigations/generic-loop-mainline-derived-predicate-front-d0-2026-09-23.md) `0adb0fb8af`: canonical Main, RC 4/3/4 + release PASS, raw reach zero; reds are baseline debt. Cohort exhausted; frontier pause. |
