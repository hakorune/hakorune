...
#### MAP-LITERAL-THREE-ORDINARY-OWNER-COVERAGE-I0 — active implementation
...
Smallest next slice: close out the three-owner I0 with the existing selected runtime probe evidence; keep the source-ordered groups and explicit two-local cohort guard unchanged until a separate fourth-owner design stop.
...
Direct EXE and linked OBJ both exit30. Fault-order prefix probes show later owners are skipped. This I0 is ready for closeout; fourth-owner coverage remains a separate design stop.
