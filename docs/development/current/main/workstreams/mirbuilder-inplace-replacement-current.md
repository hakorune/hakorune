...
ordered after B-prime correction
  ...
  3. D1, D2-S1, and D2-S2 are closed as cfg(test)-only source evidence; execute D3-S0 as a private source-backed eligibility protocol for natural Both plus typed mismatch negatives, with no production issuer/selector/route. Keep Compound/Unavailable as a later source-matrix row before parent D2 closeout
