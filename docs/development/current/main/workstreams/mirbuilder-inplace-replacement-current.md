...
Smallest next slice: accepted declaration capability -> Home-aware ordinary Map Completion, with Value/TransferHome source entries and mandatory Indexed-consumer refusal. One-loan prerequisite closed at60b0abe3d6 (package141/guards). The Map owner bounded implementation fixes exact coverage, deletion and acceptance; preserve AppMain/Dynamic/S6C. No runtime/V4 promotion or generic fallback.
