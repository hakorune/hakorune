...
Smallest next slice: close distinct-binding/non-Map annotation acceptance and reconcile the finite selected cohort with the next retirement row. Source13/direct EXE/OBJ30 and12 source-object completion observations pass; package9 passes. Selected Named retry is absent; raw/normalizer cohorts remain outside. See ownership checkpoints; no all-Map/R7 claim.
