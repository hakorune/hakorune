...
Smallest next slice: audit declaration capability -> Home-aware ordinary Completion in design_stop. One-loan prerequisite closed: candidates and seeds share a declaration loan, independent seed walk deleted; package141/guards pass (details in Map owner). Preserve AppMain root, Dynamic borrowed Completion and S6C take. No Map runtime/V4 widening or generic fallback; do not repeat the closed loan census.
