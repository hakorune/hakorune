...
closed — GENERIC-G0-CANDIDATE-S1 -> Less/+Add Candidate/Unresolved/Rejected; 28 tests+guards+docs green; no selector/Recipe/Builder/MIR/retry/fallback/production. closed — LOOP-FAMILY-DIRECT-OBSERVATION-S1 -> test-only adapter + AST-free observer; 3-mode Candidate, shape Declined, incomplete/unsealed Unresolved, identity/binding Rejected; 7 tests+guard+docs green; no selector/Recipe/Builder/MIR/retry/fallback/production. next — LOOP-FAMILY-NESTED-OBSERVATION-S1.
```
