...
| E | Loop/M8 S6/M9 S7 | Repair closed ([I0](../investigations/generic-loop-source-facts-accessor-compile-repair-i0-2026-09-23.md)); VM is retired Compatibility ([closure](../investigations/generic-post-selection-static-call-site-identity-d0-2026-09-23.md)). MIR D0 is `NoSafeSlice__NoExistingObserver`: no same-run proof binds bytes/lineage, admission, and GenericLoop terminal ([card](../investigations/generic-loop-mainline-source-front-d0-2026-09-23.md)). No S6E/S6G/M9 yet. |
