...
Smallest next slice: finish the existing pending and exit local-binding storage as source-ordered site-tagged groups, keep the explicit two-local cohort guard for three owners, and add grouped mutation/Fault acceptance before closeout.
