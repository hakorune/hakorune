...
closed — Loop-family S1 observers + common D0 caller-zero; selector/Recipe/Builder/MIR/production=0. closed — S0C neutral owner, Generic normalization, R0 evidence retention, and resolver window lease S0; tests/guards/docs green (R0: 89; lease: 3). next — common admission assembler; selector/production/retirement closed.
```
