...
Smallest next slice: CHRONIC-MEASUREMENT-GENERATED-REGISTRY-RETENTION-D0;
  preserve five exact RetainNamed bindings, carry 69 candidate joins as non-authoritative;
  issue policy for 5 conditional rows; 5 conditional blocked, policy-ready 5/79 before map/deletion.
