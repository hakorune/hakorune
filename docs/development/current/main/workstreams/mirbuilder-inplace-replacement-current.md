...
Substrate checkpoint: MIR/Core/readers, v2 wire/actions, borrowed index and original-demand propagation are implemented. Map-focused17 pass, including formal separation, used call result, Select, PHI backedge and CopyOwned; prior v1 Stop1/alias1/vocabulary20 remain dependency evidence. Next: exact producer admission and frame backing. Complete reader inventory/malformed-frame tests remain Step1 work; source/host switch stays closed.
