...
| F | `LOOP-PRODUCTION-SELECTION-D0` → Loop/M10b → M11 → M12 | VAR `b579959a3d`; R0 `6e88441c0b`; guard re-pin `a97f564250`; M11-A `9f55aea31b`; M11-B `8dff99ef22`; R2A manifest `682acbc2ca` ([card](../investigations/joinir-loop-legacy-family-disposition-r2a-2026-09-25.md)). R2B partial: generic_residual chain + M8E wire arm retired; `GenericLoopV1` is typed-declined (7 backed/12 declined). Open: R2B oracle chain, Section C decisions, R2C/R2G. |
