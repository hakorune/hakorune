...
closed — GENERIC-G0-CANDIDATE-S1; Direct S1; Nested S1 -> caller-zero observers, tests/guard/docs green, no selector/Recipe/Builder/MIR/production; Nested preserves forest errors. next — LOOP-FAMILY-LOOPTRUE-OBSERVATION-S1 design.
```
