...
Smallest next slice: fix source-owned generic/checked callable Map selection per [collection SSOT](../design/collection-literal-construction-ssot.md#static-v2-host-checkpoint-and-remaining-selection-2026-09-09). Name one issuer and replace the unconditional checked dispatch; no missing-map_flow fallback. Script6/EXE12, Array5/EXE10 and physical formal tests do not close natural mixed-formal source execution. Whole Map/R7 remains open.
