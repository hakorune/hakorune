...
| E | Loop/M8 S6/M9 S7 | S0 `798551e8de`; S6D `b0fe3bf6a2`; S6E `0bdfbda1da`; **S6G `b419b84c3d`** all19 closeout; M8 closed. **S7A `f6c1d71015`** (D1): `.hako` wire subtree (scalar/string only). **S7B1 `f4b1432929`** / **S7B2 `e2a1e58eb8`** / **S7B3 `9377b746df`** / **S7B4 `5be1808a3b`**: M8A/M8B/M8C(V2)/M8D wire + parity vs producer issuers; M9 producer half deferred. **S7B5 landed**: M8E Generic residual V1 wire — all five S7B producer cohorts covered; S7G remains. |
