...
| H | unified selfhost resume owner | Gate 1 `real-apps-exe-boundary` (receipt 4/7): QUALIFIED-PREFLIGHT-S0 + UNTYPED-OBJECT-STORAGE-S0 + EXACT-USIZE-S0 landed — usize admitted parameter-scoped; boxtorrent->`main-import-view/selected-header-missing`, mimalloc->`ordinary-new/birth-global-legacy-stopped`. Next: `MIRBUILDER-EXE-ACCEPTANCE-OWNER-SELECTION-D2`. Gates 2-4 queued. |
