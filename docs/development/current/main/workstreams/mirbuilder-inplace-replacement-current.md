...
| E | Loop/M8 S6/M9 S7 | Landed [D0](../investigations/generic-loop-mainline-source-front-d0-2026-09-23.md) at `993fd3c943`: Main0 Continue selects pre-wrapper, one canonical Main draft, canonical finalize, RC 4 + variants + release gate PASS, raw reachability zero. Strict-shadow red is baseline `to_i64` debt. Next [D0](../investigations/generic-loop-mainline-in-body-step-front-d0-2026-09-23.md): in-body-step profile. No S6E/S6G/M9 claim. |
