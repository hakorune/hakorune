...
| E | Loop/M8 S6/M9 S7 | Active [D0](../investigations/generic-loop-mainline-source-front-d0-2026-09-23.md): Main0 Continue selected for design; static route is LoopCondContinueOnly, source arm missing. Select before legacy wrapper creation; one canonical Main draft, existing publication. Next close semantic-program/one-loan/finished-root contracts, then cut over and remove selected raw body/finish edges. No repeated target search or runtime/S6E/S6G/M9 claim. |
