...
Smallest next slice: actual source-object Fault/cleanup observations and finite selected old-edge retirement closeout. Preflight and source host connection pass13 cases with direct EXE/linked OBJ30; package8/root refusal1 pass. See the ownership source execution checkpoint. No whole-library/R7 claim.
