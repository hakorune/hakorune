...
| F | `LOOP-PRODUCTION-SELECTION-D0` → Loop/M10b → M11 → M12 | [M10b-I0-R0-VAR](../investigations/mir-call-variable-accum-recurrence-production-i0-2026-09-24.md) landed `b579959a3d`; R0 flip + ordered-scheduler retirement landed `6e88441c0b`; guard re-pin + test split `a97f564250`. Gates/guards green. Residual: M11 row (guard-pinned located/composer husks), then M12. |
