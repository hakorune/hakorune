---
Status: Fast — chronic measurement receipt range hardening I0
Date: 2026-08-27
...
Active card:
  - docs/development/current/main/investigations/chronic-measurement-receipt-range-hardening-i0-2026-08-27.toml
Task map:
...
Smallest next slice:
  `CHRONIC-MEASUREMENT-RECEIPT-RANGE-HARDENING-I0` is the only implementation cell: reject zero-length source ranges in the landed neutral receipt validator without changing its 185-row artifact; then return to the owner-map design stop.
