...
| F | `LOOP-PRODUCTION-SELECTION-D0` → Loop/M10b → M11 → M12 | P1/P2-E landed (`1aa7ac25b3`); R0 uncommitted. First [M10b-I0-R0-VAR](../investigations/mir-call-variable-accum-recurrence-production-i0-2026-09-24.md): correct CallableSingleLoop attribution, preserve accepted recurrence through VAR callable owner; then R0 acceptance/retirement. No sixth node family or fixture downgrade. |
