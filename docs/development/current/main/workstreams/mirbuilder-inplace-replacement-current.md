...
| E | Loop/M8 S6/M9 S7 | Active [D0](../investigations/generic-loop-mainline-source-front-d0-2026-09-23.md): choose one route-specific source-backed callable -> portable whole-callable consumer, old-edge deletion, and acceptance. GenericV1/LoopCond/LoopTrue have distinct consumers; the Continue fixture does not establish GenericV1. NoExistingObserver means evidence missing, not owners absent/external wait. Same-run tests/caller-zero are outputs. No S6E/S6G/M9 claim. |
