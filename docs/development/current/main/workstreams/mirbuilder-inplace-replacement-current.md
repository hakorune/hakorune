...
Smallest next slice: audit source issuer of ordinary Call normal/Fault/result correspondence (Map owner ordinary frontier step1); do not issue placeholder retention. Completion borrowing is implemented: misleading summary removed, package148/source6/control33 and guards pass. APrime keeps separate invocation cleanup. AppMain Value source cutover remains verified; ordinary/unknown/Script/transferred-lambda restrictions remain.
