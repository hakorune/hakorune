...
| E | Loop/M8 S6/M9 S7 | Repair closed ([I0](../investigations/generic-loop-source-facts-accessor-compile-repair-i0-2026-09-23.md)); G0 exits 1 at an uncorrelated static-call terminal ([front](../investigations/generic-legacy-observation-front-g0-premise-recheck-2026-09-23.md)). Resolve caller/site via [D0](../investigations/generic-post-selection-static-call-site-identity-d0-2026-09-23.md). Require exit 4 before P1; no S6E/S6G producer or M9 parity. |
