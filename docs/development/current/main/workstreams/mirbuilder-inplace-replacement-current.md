...
Wider ordinary Map owners, New/Home transfer, unknown scalar values, and whole Map/R7 claims remain stopped. Owner-gate, child-symbol-drift, Call-handoff, child/root/field, physical Call-admission and ignored Pair/Bool/ordinary-child/two-Call tests pass; Pair ABI/OBJ/EXE/Fault evidence and the single-terminal retirement are closed. Two-owner admission and distinct-A/B Pair exit30 are closed; this I0 owns three-owner source-ordered local binding retention and the bounded owner-set widening.
