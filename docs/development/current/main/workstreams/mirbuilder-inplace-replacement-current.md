...
| E | Loop/M8 S6/M9 S7 | Landed 3 App-Main0 D0s (`993fd3c943`..`0adb0fb8af`); reds baseline. S6E P1 done: 398 corpus rows observed (40 acc/196 rej/162 pre-loop), 10 batches `849daed591`..`f5514cf608`; D0 `f91e5ba82c`+`197ea80fa4`; nondeterminism repair `e6178e7335` (HashMap-order ret-sig fix + 20x2 guard): **398/398 checked**, unclassified accepted=0. S0 `798551e8de`: 270 edge rows; 180 candidates classified, shared items outside R1. Next: family reselection. |
