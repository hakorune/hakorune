...
| F | `LOOP-PRODUCTION-SELECTION-D0` → Loop/M10b → M11 → M12 → C0 | R0 `6e88441c0b`; M11 `9f55aea31b`/`8dff99ef22`; M12 `682acbc2ca`→`b50e8b9a56`; baseline `e53c0693c5`. C0 `25a030b5f3`/`f8f76d5ade`/`94ffe5e5cc`: 605-row census (457 durable/134 test/7 bootstrap/7 orphan-retired); move manifest = 598 keep, homes already satisfy four-box split. Next: `MIR-TOPOLOGY-REBASE0-P0` per cleanup SSOT step 2. |
