...
| E | Loop/M8 S6/M9 S7 | Landed 3 App-Main0 D0s (`993fd3c943`..`0adb0fb8af`); reds baseline. S6E P1: 398 corpus rows (40 acc/196 rej/162 pre-loop), batches `849daed591`..`f5514cf608`; D0 `f91e5ba82c`+`197ea80fa4`; ret-sig determinism fix `e6178e7335`: **398/398 checked**. S0 `798551e8de`: 270 edge rows, shared items outside R1. S6D LoopCond producer cohort landed caller-zero (typed map + demand + producer; 20/20+42/42+48/48+63/63). Next: S6E Generic residual. |
