...
Checkpoint: owned V2 four-table frame passes Map36 and live query integration1 plus guards. Recursive/mixed formal flags, logical target/arity, internal-name collisions, backing lifetime and empty arrays are verified. Actual C-query observations construct the frame. C admission/emission/internal linkage and source cutover remain open; no Map-through-V1 claim.
