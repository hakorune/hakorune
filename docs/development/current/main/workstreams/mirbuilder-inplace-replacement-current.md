...
| E | Loop/M8 S6/M9 S7 | Landed 3 App-Main0 D0s; reds baseline. S0 `798551e8de`: 270 edge rows. S6D `b0fe3bf6a2`. S6E `0bdfbda1da` (cursor 18 Exact-only). **S6G all-route closeout landed caller-zero**: 19-row observation set + lease-bound coverage proof + `NoCandidate` arm on the S2 selector + 19-route parity receipt; M8 coverage gate closed, M9/Row F remain gated. |
