...
ordered after B-prime correction
  ...
  3. D1, D2-S1, and D2-S2 are closed as cfg(test)-only source evidence; D2-S2 records parsed IndexWrite/Ambiguous with actual Release/Strict raw [V0,V1] and typed unresolved disposition. Return to the parent Generic D2 design stop before M7 five-family parity, M8 all-19 producers, and M9 host parity
