...
Smallest next slice: extend the existing owner cap and local-call cohort guard for the accepted four-owner slice; keep source-ordered groups, prior-home rejection and physical collection unchanged.
...
Direct EXE and linked OBJ both exit30. Fault-order prefix probes show later owners are skipped. This I0 is closed; the linked collection SSOT now owns the accepted four-owner implementation slice.
