...
| E | Loop/M8 S6 and Loop/M9 S7 | Repair the current Generic source-facts compile red ([I0](../investigations/generic-loop-source-facts-accessor-compile-repair-i0-2026-09-23.md)); then run only the pinned G0 VM case ([front](../investigations/generic-legacy-observation-front-g0-premise-recheck-2026-09-23.md)). Require exit 4 plus Loop tag before serial P1. Named terminals stay unclassified; no corpus census, S6E producer, S6G, or M9 parity. |
