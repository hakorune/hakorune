...
| E | Loop/M8 S6/M9 S7 | Landed 3 App-Main0 D0s (`993fd3c943`,`897ac4ba8c`,`0adb0fb8af`); reds baseline. S6E P1 done: all 398 corpus rows observed (40 acc/196 rej/162 pre-loop) via `849daed591`+`fa44524d9b`+`9622b1ca5c`+`3e20b17e53`+`d888419d6e`+`50dee7a92e`+`c6434e6ad7`+`b80659301e`+`9e277c5b4a`+`f5514cf608`; D0 landed `f91e5ba82c`+`197ea80fa4`: 394/398 checked; 4 held on if_else_return void @main nondeterminism; repair card `generic-legacy-ifelse-return-nondeterminism-d0` open. |
