...
Smallest next slice: existing ownership queue14 Delete BoxShape (duplicate Local record propagation and sole with_types forwarder), with parity/placement tests. Bounded callable I64 Map is verified: source13/EXE26, completion12, package10. Raw/Script/Core/static-host/V1/six-edge obligations remain open. Queue11 lookup scans are separate; no all-Map/R7 claim.
