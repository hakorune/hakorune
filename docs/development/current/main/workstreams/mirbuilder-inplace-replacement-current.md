...
Smallest next slice: existing ownership queue11 exact declaration-key Local lookup with BindingRef verification; preserve uniqueness and refusal. Queue14 deletion is closed (parity6/placement2). Bounded callable I64 Map: source13/EXE26, completion12, package10. Raw/Script/Core/static-host/V1/six-edge and alias scans remain open; no all-Map/R7 claim.
