...
ordered after B-prime correction
  ...
  3. run `JOINIR-GENERIC-RESOLVED-CARRIER-PROJECTOR-DESIGN0-D0` as one cfg(test)-only S2A coverage extension; production handoff and parent D2 remain unresolved, then close M7 five-family parity, M8 all-19 producers, and M9 host parity
