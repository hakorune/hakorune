...
| H | unified selfhost resume owner | Lane entry D0 accepted 2026-09-25: arrow = unified resume order gates 1-4; gate 1 `real-apps-exe-boundary` last receipt 2/9 — first actionable work. Gates 2-4 stay queued (language board parked, mimalloc gate0 parked, parity pilot needs gates 1-3). Next: `MIRBUILDER-EXE-ACCEPTANCE-OWNER-SELECTION-D0` — package one of the nine typed fail classes into a complete (authority, caller, delete) tuple; rerun receipt confirms class selection. |
