---
Status: Fast — RawLegacy nested Main C fate I0
Date: 2026-08-27
...
Smallest next slice:
  ...
  D0a is complete at e51dab7212 and C D0 is accepted. I0 now observes static Main at the shared child dispatcher, queries a zero-payload two-state RawLegacy policy once, and retires only C before helper/prepare effects. G/J, non-Box, Root I1, RawInvocation, and explicit root compatibility remain unchanged.
