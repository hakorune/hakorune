...
| E | Loop/M8 S6/M9 S7 | Landed [Continue D0](../investigations/generic-loop-mainline-source-front-d0-2026-09-23.md) `993fd3c943` and [in-body-step D0](../investigations/generic-loop-mainline-in-body-step-front-d0-2026-09-23.md) `897ac4ba8c`: pre-wrapper arms, canonical Main draft, RC 4/RC 3 + variants + release PASS, raw reach zero; strict red is baseline `to_i64`. Next [D0](../investigations/generic-loop-mainline-derived-predicate-front-d0-2026-09-23.md). |
