...
Smallest next slice: connect the accepted four-owner source admission to direct/linked physical artifact and Fault-prefix evidence; keep source-ordered groups, prior-home rejection and physical collection unchanged.
...
Direct EXE and linked OBJ both exit30. Fault-order prefix probes show later owners are skipped. This three-owner I0 is closed; the four-owner source admission passes semantic 14/14, with physical artifact/Fault evidence next.
