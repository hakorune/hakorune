...
| E | Loop/M8 S6/M9 S7 | S0 `798551e8de`; S6D `b0fe3bf6a2`; S6E `0bdfbda1da`; **S6G `b419b84c3d`** all19 closeout; M8 closed. **S7A `f6c1d71015`** (D1): `.hako` wire subtree (scalar/string only). **S7B1 `f4b1432929`** / **S7B2 `e2a1e58eb8`**: M8A/M8B wire + parity vs producer issuers; M9 producer half deferred. **S7B3 landed**: M8C first `LoopRecipeArtifactV2` wire — `scan_with_init_v2`, call_slot/text_eq/return-exit; `NormalizerV2` + `ScanWithInitV2` producer-id landed. |
