...
| F | `LOOP-PRODUCTION-SELECTION-D0` → Loop/M10b → M11 → M12 | R0 `6e88441c0b`; M11 `9f55aea31b`/`8dff99ef22`; M12 `682acbc2ca`→`b50e8b9a56` (R2A→R2G landed; oracle/residual/schedule/attestation chains retired; `LoopRouteId` diagnostic-only; sole issuer audited). Baseline re-pinned `e53c0693c5`. Next: `LOOP-POST-CUTOVER-BOXSHAPE-C0` ([card](../investigations/loop-post-cutover-boxshape-c0-2026-09-25.md)). |
