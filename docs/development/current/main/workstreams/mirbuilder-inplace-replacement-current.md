...
Smallest next slice: design the existing C child New/Birth/HomeRelease consumer and its exact selected-C/OBJ/EXE boundary; do not activate it during this Rust handoff closeout.
...
The existing final-owner and physical-boundary owners are reused. Rust handoff implementation landed at c3fa1f8a75; focused root/child compiled-entry, JSON, and cleanup tests pass. C child gates remain stopped; sources stay below800; no whole Map/R7 closure.
