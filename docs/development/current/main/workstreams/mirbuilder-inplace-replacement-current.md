...
Smallest next slice: close source install preflight using existing root claims and the Local annotation owner before switching Map. Complete Map alone misses unrelated New readiness and early annotation refusal. Common Stop remains; see the ownership source preflight Decision. C consumer and NativeArray regression are verified at bb74fa8078.
