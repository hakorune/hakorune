...
| E | Loop/M8 S6/M9 S7 | Landed 3 App-Main0 D0s (`993fd3c943`..`0adb0fb8af`); reds baseline. S6E P1 398 rows + D0 `f91e5ba82c`+`197ea80fa4` + ret-sig fix `e6178e7335`: 398/398 checked. S0 `798551e8de`: 270 edge rows. S6D LoopCond cohort `b0fe3bf6a2`. **S6E Generic residual cohort landed caller-zero**: projection+typed map+demand (cursor 18 Exact-only)+`GenericResidualV1`+Recipe/JoinSig producer; gates 18/18+54/54+49/49+63/63. Next: S6G all-route closeout. |
