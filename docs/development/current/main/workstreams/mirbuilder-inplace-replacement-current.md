...
ordered after B-prime correction
  ...
  3. D1, D2-S1, D2-S2, D3-S0, D2-S3, D2-S4, and D2-S5-S1 are cfg(test)-only closed. S1 records exact CompleteNoRecursive + [V0,V1] as typed NonRecursiveOutOfTarget for one flat Assignment shape. D3-S1 is now the docs-only disposition/winner/disjointness design stop; no production issuer/selector/route or winner claim follows
