...
| E | Loop/M8 S6/M9 S7 | Landed 3 App-Main0 D0s; reds baseline. S6E P1 398 rows + D0 + ret-sig fix `e6178e7335`: 398/398 checked. S0 `798551e8de`: 270 edge rows. S6D `b0fe3bf6a2`. S6E Generic residual cohort `0bdfbda1da` (cursor 18 Exact-only, 18/18+54/54+49/49+63/63). **S6G all-route closeout D0 open**: observation set (19 routes)+coverage proof+`NoCandidate` arm+19-row parity receipt, caller-zero. |
