...
structural cleanup is deleting only the P381GE zero-ref v2 archive candidate
wave.
...
`docs/development/current/main/phases/phase-29cv/P381EA-SAME-MODULE-FUNCTION-ENTRY-NAMES.md`:
...
`docs/development/current/main/phases/phase-29cv/P381EF-MIR-SCHEMA-MAP-JSON-COVERAGE.md`:
...
`docs/development/current/main/phases/phase-29cv/P381EL-SAME-MODULE-LOOKUP-SCOPE.md`:
...
archive scripts; the next slice is deleting only that candidate wave.
