...
- Latest landed cleanup target: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- Next implementation target: close out GenericMethodRoute root re-export prune
...
3. `docs/development/current/main/phases/phase-291x/291x-473-generic-method-route-root-export-prune-card.md`
