...
3. `docs/development/current/main/phases/phase-291x/291x-405-normalized-shadow-stale-legacy-wording-cleanup-card.md`
...
- latest known cleanup checkpoint: `291x-405`
