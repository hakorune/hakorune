...
- Latest landed cleanup target: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- Next implementation target: post-runtime-meta cleanup inventory
...
3. `docs/development/current/main/phases/phase-291x/291x-300-runtime-meta-root-closeout-card.md`
...
- latest known cleanup checkpoint: `291x-300`
- BuildBox thinning series is closed; residual MapBox.has sentinel retirement
  ...
  next cleanup is post-runtime-meta inventory
