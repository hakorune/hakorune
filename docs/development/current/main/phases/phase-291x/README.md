...
- Latest landed cleanup target: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- Next implementation target: JoinIR Case-A carrier-count heuristic inventory
...
3. `docs/development/current/main/phases/phase-291x/291x-320-joinir-casea-update-summary-name-only-prune-card.md`
...
- latest known cleanup checkpoint: `291x-320`
