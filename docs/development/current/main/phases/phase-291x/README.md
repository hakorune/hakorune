...
- Latest landed cleanup target: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- Next implementation target: JoinIR `LoopFeatures` if-phi signature stub inventory
...
3. `docs/development/current/main/phases/phase-291x/291x-338-joinir-loopfeatures-update-summary-prune-card.md`
...
- latest known cleanup checkpoint: `291x-338`
...
- next cleanup: JoinIR `LoopFeatures` if-phi signature stub inventory
