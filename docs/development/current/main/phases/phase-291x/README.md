...
- Latest landed cleanup target: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- Next implementation target: JoinIR route detector physical owner closeout
  review
...
3. `docs/development/current/main/phases/phase-291x/291x-391-joinir-route-detector-body-local-physical-owner-closeout-card.md`
...
- latest known cleanup checkpoint: `291x-391`
