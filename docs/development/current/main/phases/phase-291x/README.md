...
- Latest landed cleanup target: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- Next implementation target: loop-if-break-continue placeholder/fossil
  boundary review
...
3. `docs/development/current/main/phases/phase-291x/291x-433-normalization-default-path-wording-cleanup-card.md`
...
- latest known cleanup checkpoint: `291x-433`
