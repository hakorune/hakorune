...
- Latest landed cleanup target: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- Next implementation target: normalized-shadow k-exit legacy naming inventory
...
3. `docs/development/current/main/phases/phase-291x/291x-407-normalized-shadow-support-contract-wording-cleanup-card.md`
...
- latest known cleanup checkpoint: `291x-407`
