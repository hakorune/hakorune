...
3. `docs/development/current/main/phases/phase-291x/291x-363-joinir-route-detector-legacy-route-function-definition-prune-card.md`
...
- latest known cleanup checkpoint: `291x-363`
