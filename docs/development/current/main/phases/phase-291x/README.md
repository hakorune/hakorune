...
- Latest landed cleanup target: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- Next implementation target: JoinIR loop-update stale docs/comments inventory
...
3. `docs/development/current/main/phases/phase-291x/291x-332-joinir-loop-update-summary-helper-split-card.md`
...
- latest known cleanup checkpoint: `291x-332`
...
- next cleanup: JoinIR loop-update stale docs/comments inventory
