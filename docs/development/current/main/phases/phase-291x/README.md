...
- Latest landed cleanup target: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- Next implementation target: normalized-shadow public surface prune
...
3. `docs/development/current/main/phases/phase-291x/291x-424-normalized-shadow-public-surface-inventory-card.md`
...
- latest known cleanup checkpoint: `291x-424`
