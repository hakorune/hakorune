...
3. `docs/development/current/main/phases/phase-291x/291x-419-normalized-shadow-exit-reconnector-deprecated-stub-cleanup-card.md`
...
- latest known cleanup checkpoint: `291x-419`
