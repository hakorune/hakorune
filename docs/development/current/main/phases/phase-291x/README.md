...
- Latest landed cleanup target: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- Next implementation target: verify `GenericMethodRoute` site/operands split
...
3. `docs/development/current/main/phases/phase-291x/291x-461-generic-method-route-site-operands-record-card.md`
...
- latest known cleanup checkpoint: `291x-461`
...
- next cleanup: verify `GenericMethodRoute` site/operands split
