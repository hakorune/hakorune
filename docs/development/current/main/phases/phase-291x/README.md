...
3. `docs/development/current/main/phases/phase-291x/291x-413-normalized-shadow-generic-function-name-cleanup-card.md`
...
- latest known cleanup checkpoint: `291x-413`
