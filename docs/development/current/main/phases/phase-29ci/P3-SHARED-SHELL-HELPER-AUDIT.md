...
- retreat note: `registry_optin_method_arraymap_direct_canary_vm.sh` remains explicit legacy keep because it still carries a direct-lower contract that should not be hidden behind the shared registry helpers
