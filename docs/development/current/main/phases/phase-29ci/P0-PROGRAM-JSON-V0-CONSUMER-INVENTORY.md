...
Related:
  ...
  - src/runner/stage1_bridge/program_json.rs
---
...
| `build surrogate test keep` | [crates/nyash_kernel/src/plugin/module_string_dispatch/build_surrogate.rs](/home/tomoaki/git/hakorune-selfhost/crates/nyash_kernel/src/plugin/module_string_dispatch/build_surrogate.rs) | same as above | route-selection plus invoke-by-name build-box/MIR handoff regression coverage are now co-located with the surrogate owner |
| `future-retire bridge` | [src/runner/stage1_bridge/program_json.rs](/home/tomoaki/git/hakorune-selfhost/src/runner/stage1_bridge/program_json.rs), [src/runner/stage1_bridge/program_json/source.rs](/home/tomoaki/git/hakorune-selfhost/src/runner/stage1_bridge/program_json/source.rs), [src/runner/stage1_bridge/program_json/read_input.rs](/home/tomoaki/git/hakorune-selfhost/src/runner/stage1_bridge/program_json/read_input.rs), [src/runner/stage1_bridge/program_json/emit_payload.rs](/home/tomoaki/git/hakorune-selfhost/src/runner/stage1_bridge/program_json/emit_payload.rs), [src/runner/stage1_bridge/program_json/writeback.rs](/home/tomoaki/git/hakorune-selfhost/src/runner/stage1_bridge/program_json/writeback.rs) | `emit_program_json_v0_for_stage1_bridge_emit_program_json(...)` | `program_json.rs` is now a thin facade; source-path precedence, source-text read policy, bridge-local payload emission, and bridge-local writeback policy are owner-local submodules under the same future-retire bucket |
| `future-retire bridge entry` | [src/runner/stage1_bridge/program_json_entry.rs](/home/tomoaki/git/hakorune-selfhost/src/runner/stage1_bridge/program_json_entry.rs), [src/runner/emit.rs](/home/tomoaki/git/hakorune-selfhost/src/runner/emit.rs), [src/runner/mod.rs](/home/tomoaki/git/hakorune-selfhost/src/runner/mod.rs) | `NyashRunner::emit_program_json_v0(...)` | delegate-only entry; `mod.rs` no longer owns this bridge entry directly and now queries `program_json_entry.rs` instead of reading the emit flag itself, while `emit.rs` no longer owns bridge-specific branch formatting |
...
- the only remaining root-level kernel regression touching this bucket is launcher MIR handoff through owner-1 helper payloads, not the build-surrogate route contract itself
