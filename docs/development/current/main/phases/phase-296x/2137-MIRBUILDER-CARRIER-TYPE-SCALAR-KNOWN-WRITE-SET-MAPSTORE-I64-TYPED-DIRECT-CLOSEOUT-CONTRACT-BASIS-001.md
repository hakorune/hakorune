# 2137 - MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-SET-MAPSTORE-I64-TYPED-DIRECT-CLOSEOUT-CONTRACT-BASIS-001
...
`SetSurfacePolicy / MapStoreI64` Write surface.

This card defines contract vocabulary only. It does not materialize direct
closeout, does not include `MapStoreAny`, and does not close
...
decision:
  SelectWriteSetMapStoreI64DirectCloseoutRerun
...
```text
tools/checks/
  rust_lifecycle_mirbuilder_carrier_type_scalar_known_write_set_mapstore_i64_typed_direct_closeout_contract_basis_guard.sh
```
...
tool:
  tools/rust_lifecycle/
    mirbuilder_carrier_type_scalar_known_write_set_mapstore_i64_typed_direct_closeout_contract_basis.py
```
