# 2061 - MIRBUILDER-CARRIER-TYPE-TRANSPORT-EVIDENCE-INVENTORY-RERUN-003
...
Result, Option, collection, constructor, or ID/domain transport by count.
...
tool:
  tools/rust_lifecycle/
    mirbuilder_carrier_type_transport_evidence_inventory_rerun_003.py

guard:
  tools/checks/
    rust_lifecycle_mirbuilder_carrier_type_transport_evidence_inventory_rerun_003_guard.sh
```
