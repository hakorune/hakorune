# 2125 - MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-PARITY-GATE-001
...
`write_delete_surface_policy_classifier` `.hako` implementation.

This card proves the 2124 `.hako` classifier output matches the 2123 Rust
oracle fixture for the scoped `DeleteSurfacePolicy / MapDeleteAny` pilot.
...
```text
output_contract =
  rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-delete-surface-parity-gate-v0
...
reason_token:
  WriteDeleteSurfaceParityGateGreen
