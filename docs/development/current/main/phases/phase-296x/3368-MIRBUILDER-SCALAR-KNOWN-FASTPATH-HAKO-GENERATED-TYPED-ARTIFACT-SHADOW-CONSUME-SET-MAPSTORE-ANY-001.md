# 3368 - MIRBUILDER-SCALAR-KNOWN-FASTPATH-HAKO-GENERATED-TYPED-ARTIFACT-SHADOW-CONSUME-SET-MAPSTORE-ANY-001
...
Connect SetSurfacePolicy / MapStoreAny to the live Rust fast path through a
...
generated artifact:
  src/mir/generic_method_route_plan/generated/
    write_set_mapstore_any_hako_policy.rs

generator / check source:
  tools/rust_lifecycle/generate_write_set_mapstore_any_hako_policy.py
...
```text
tools/checks/
  rust_lifecycle_mirbuilder_scalar_known_fastpath_hako_generated_typed_artifact_shadow_consume_set_mapstore_any_guard.sh
```
