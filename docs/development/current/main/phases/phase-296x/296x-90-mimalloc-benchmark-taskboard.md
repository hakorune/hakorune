...
| 87 | `HAKO-MIR-METHOD-SHAPE-HAKO-MIGRATION-SELECTION-296X-001` | Current | Decide whether the Python MIR method shape contract is stable enough for a minimal .hako migration. |
