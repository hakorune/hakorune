...
| 55 | `HAKO-MIMALLOC-HAKMEM-LDPRELOAD-SHIM-SMOKE-296X-001` | Planned | Build and smoke-test an optional LD_PRELOAD-compatible shim without enabling normal host allocator replacement. |
| 56 | `HAKO-MIMALLOC-PERF-PARITY-SELFHOST-HANDOFF-GATE-296X-001` | Planned | Decide whether the `.hako` mimalloc evidence is strong enough to return focus toward selfhosting. |
...
### Row 51 - First Keeper Optimization
...
### Row 52 - Port Feature Gap Inventory
...
### Row 53 - Real Provider Entrypoint Selection
...
### Row 54 - Hakmem LD_PRELOAD Shim Decision
...
### Row 55 - Hakmem LD_PRELOAD Shim Smoke
