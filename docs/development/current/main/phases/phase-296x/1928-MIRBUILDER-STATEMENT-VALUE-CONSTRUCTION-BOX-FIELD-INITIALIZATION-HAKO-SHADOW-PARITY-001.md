# 1928 - MIRBUILDER-STATEMENT-VALUE-CONSTRUCTION-BOX-FIELD-INITIALIZATION-HAKO-SHADOW-PARITY-001
...
Add a HakoShadow projector for the contracted StatementValueConstruction box
field initialization mutation frame.
...
```text
projector:
  lang/src/compiler/lib/box_field_initialization_projector.hako

tool:
  tools/rust_lifecycle/
    mirbuilder_statement_value_construction_box_field_initialization_hako_shadow_parity.py
...
```text
1. MIRBUILDER-STATEMENT-VALUE-CONSTRUCTION-BOX-FIELD-INITIALIZATION-HAKO-SHADOW-PROMOTION-DECISION-001
