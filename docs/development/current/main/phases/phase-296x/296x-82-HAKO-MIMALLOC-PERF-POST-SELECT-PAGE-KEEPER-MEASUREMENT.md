...
output_contract=hako-mimalloc-perf-post-select-page-keeper-measurement-v0
input_contract=hako-mimalloc-perf-select-page-single-page-fast-path-v0
measurement_scope=object_lifecycle_facade_exact_exe_after_select_page_keeper
operation_repeat=8192
sample_count=3
keeper=select_page_single_page_fast_path
select_page_single_fast_path_count=524288
...
sample_0_hako_external_elapsed_ms=730
sample_1_hako_external_elapsed_ms=700
sample_2_hako_external_elapsed_ms=720
after_hako_elapsed_median_ms=720
after_hako_elapsed_min_ms=700
after_hako_elapsed_max_ms=730
winner_claim=0
replacement_active=0
summary=ok
```
...
```bash
bash tools/checks/k2_wide_phase296x_hako_mimalloc_perf_post_select_page_keeper_measurement_guard.sh
```
