...
### Series B Recursive Projection And Support Evidence - Complete
...
support matrix:
  generated by the Series D full conformance owner
```
...
registry-derived full fixture index = 106 unique fixtures
full Rust/Hako recursive conformance = 106/106 green
generated support matrix = Rust 78 supported + 2 transport-owned; Hako 78 supported + 2 excluded
```
