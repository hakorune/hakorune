# 3142 - MIRBUILDER-PROGRAMJSON-LAYER4-RECIPE-SHAPE-KIND-DTO-EXPANDED-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001

Status: landed

## Scope

Mark the expanded `RecipeShapeKindDtoSnapshotV1` ProgramJSON Layer4 rows from
3141 as a scoped Rust ASTNode projector retire-candidate.
...
```bash
bash tools/checks/rust_lifecycle_mirbuilder_programjson_layer4_recipe_shape_kind_dto_expanded_retire_rust_astnode_projector_candidate_guard.sh
```
