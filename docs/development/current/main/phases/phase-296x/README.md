...
The active lane is the MIM-PORT-FMEM-003 PageMeta TableIndex proof surface row.
...
next implementation row is MIM-PORT-FMEM-004 PageMeta MIR-to-LLVM producer
evidence.
