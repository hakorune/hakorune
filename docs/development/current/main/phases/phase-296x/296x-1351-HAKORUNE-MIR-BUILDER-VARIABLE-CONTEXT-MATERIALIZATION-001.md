...
This follows 296x-1350 selection. The probe shows the generated skeleton for
`variable_context` already reaches MIR emit and is directly relevant to
MirBuilder variable-map / SSA carrier migration.
...
```text
apps/rust-subset-to-hako/examples/hakorune_mir_builder_variable_context_expected/
```
...
NYASH_FILEBOX_MODE=core-ro ./target/release/hakorune --emit-mir-json \
  /tmp/hakorune_mir_builder_variable_context_expected.mir.json \
  apps/rust-subset-to-hako/examples/hakorune_mir_builder_variable_context_expected.hako

NYASH_FILEBOX_MODE=core-ro ./target/release/hakorune --emit-exe \
  /tmp/convert_hakorune_mir_builder_variable_context_crate_file \
  apps/rust-subset-to-hako/convert_hakorune_mir_builder_variable_context_crate_file.hako
```
...
```text
apps/rust-subset-to-hako/examples/hakorune_mir_builder_variable_context_expected/crate-manifest.json
apps/rust-subset-to-hako/examples/hakorune_mir_builder_variable_context_expected/modules/0000.json
apps/rust-subset-to-hako/examples/hakorune_mir_builder_variable_context_expected.hako
apps/rust-subset-to-hako/convert_hakorune_mir_builder_variable_context_crate_file.hako
```
