...
small_alloc_call_count=19
small_alloc_copy_count=91
small_alloc_phi_count=12
small_alloc_record_failure_call_count=0
small_alloc_record_success_call_count=2
small_alloc_page_acquire_call_count=0
release_block_mir_instruction_count=87
release_block_call_count=7
release_block_copy_count=41
release_block_phi_count=3
release_block_record_failure_call_count=0
release_block_release_local_call_count=0
page_acquire_mir_instruction_count=185
page_acquire_call_count=5
page_acquire_copy_count=63
page_acquire_phi_count=15
page_acquire_field_get_count=17
page_acquire_field_set_count=11
page_acquire_array_get_call_count=2
page_acquire_array_set_call_count=2
page_release_local_mir_instruction_count=96
page_release_local_call_count=3
select_single_fast_path_mir_instruction_count=3
select_single_fast_path_call_count=1
source_small_alloc_method_call_count=26
source_small_alloc_result_capsule_churn=0
source_release_block_method_call_count=8
source_release_block_result_capsule_churn=0
