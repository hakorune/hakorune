# 296x-1615 MIRBUILDER-CONVERTER-COVERAGE-HYGIENE-CARRIER-INFO-SNAPSHOT-CONSULTATION-CLOSEOUT-CONTRACT-001
...
Define the consultation closeout contract for the selected CarrierInfo
snapshot harness path. The contract stays consultation-only and names the
...
- the closeout stays CarrierInfo snapshot harnesses only
