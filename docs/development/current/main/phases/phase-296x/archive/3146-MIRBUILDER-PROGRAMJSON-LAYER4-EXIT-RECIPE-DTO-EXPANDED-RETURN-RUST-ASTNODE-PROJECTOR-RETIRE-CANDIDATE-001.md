# 3146 - MIRBUILDER-PROGRAMJSON-LAYER4-EXIT-RECIPE-DTO-EXPANDED-RETURN-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001

Status: landed

## Scope

Mark the expanded Return payload `ExitRecipeDtoSnapshotV1` rows from 3145 as a
...
```bash
bash tools/checks/rust_lifecycle_mirbuilder_programjson_layer4_exit_recipe_dto_expanded_return_retire_rust_astnode_projector_candidate_guard.sh
```
