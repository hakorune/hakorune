...
Status: Landed
Date: 2026-06-26
Card: MIRBUILDER-FUNCTION-REGION-STACK-POP-HAKO-SHADOW-PROJECTOR-001
---

# MIRBUILDER-FUNCTION-REGION-STACK-POP-HAKO-SHADOW-PROJECTOR-001

## Summary

`MirBuilder::finalize_module` FunctionRegionStackPop now has an ordinary Hako
...
- `input_json` records the FunctionRegionStackPop plan JSON
...
MirBuilderFunctionRegionStackPopPlanV1
  -> FunctionRegionStackPopHakoProjector
...
```text
bash tools/bin/hako --backend mir --verify lang/src/compiler/lib/function_region_stack_pop_projector.hako = green
