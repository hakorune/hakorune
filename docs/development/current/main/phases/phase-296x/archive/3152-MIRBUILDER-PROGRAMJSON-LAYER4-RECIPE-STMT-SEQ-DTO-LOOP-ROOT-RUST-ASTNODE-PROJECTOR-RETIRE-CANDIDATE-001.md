# 3152 - MIRBUILDER-PROGRAMJSON-LAYER4-RECIPE-STMT-SEQ-DTO-LOOP-ROOT-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001

Status: landed

## Scope

Mark the covered `RecipeStmtSeqDtoSnapshotV1` loop-root rows from 3151 as a
...
```bash
bash tools/checks/rust_lifecycle_mirbuilder_programjson_layer4_recipe_stmt_seq_dto_loop_root_retire_rust_astnode_projector_candidate_guard.sh
```
