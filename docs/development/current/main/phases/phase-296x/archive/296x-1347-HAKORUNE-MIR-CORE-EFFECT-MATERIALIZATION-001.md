...
converter_core_string_literal_quote_fix=1
generated_program_execution_claim=0
rust_name_resolution_enabled=0
use_resolution_enabled=0
trait_semantics_enabled=0
...
```text
apps/rust-subset-to-hako/examples/hakorune_mir_core_effect_expected/crate-manifest.json
apps/rust-subset-to-hako/examples/hakorune_mir_core_effect_expected/modules/0000.json
apps/rust-subset-to-hako/examples/hakorune_mir_core_effect_expected.hako
apps/rust-subset-to-hako/convert_hakorune_mir_core_effect_crate_file.hako
```
