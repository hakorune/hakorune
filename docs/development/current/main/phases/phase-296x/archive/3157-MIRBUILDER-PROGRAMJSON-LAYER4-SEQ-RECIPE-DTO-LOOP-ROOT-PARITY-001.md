# 3157 - MIRBUILDER-PROGRAMJSON-LAYER4-SEQ-RECIPE-DTO-LOOP-ROOT-PARITY-001

Status: landed

## Scope

Expand `SeqRecipeDtoSnapshotV1` to cover the selected
`ProgramJsonSeqRecipeDtoLoopRootV1` capability.
...
```bash
bash tools/checks/rust_lifecycle_mirbuilder_programjson_layer4_seq_recipe_dto_loop_root_parity_gate.sh
```
