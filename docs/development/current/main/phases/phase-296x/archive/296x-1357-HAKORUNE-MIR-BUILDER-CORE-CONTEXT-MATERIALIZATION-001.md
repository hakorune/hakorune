...
This follows 296x-1356 selection. The probe shows the generated skeleton for
`core_context` already reaches MIR emit and is directly relevant to MirBuilder
...
```text
apps/rust-subset-to-hako/examples/hakorune_mir_builder_core_context_expected/
```
