# 1999 - MIRBUILDER-TYPED-OBJECT-PLAN-REFRESH-HAKO-ADOPTION-DECISION-001
...
Decide the HakoAdopted state for the `typed_object_plan_refresh` native source
seed.

This card adopts the narrow `typed_object_plan_refresh` native source owner. It
...
fixture:
  docs/development/current/main/design/fixtures/rust-lifecycle/
    mirbuilder-typed-object-plan-refresh-hako-adoption-decision-v0.json

guard:
  tools/checks/
    rust_lifecycle_mirbuilder_typed_object_plan_refresh_hako_adoption_decision_guard.sh
```
...
reason_token:
  TypedObjectPlanRefreshNativeSeedPresentAndStrictEmissionBridgeGreen
