# 296x-1597 MIRBUILDER-CONVERTER-COVERAGE-HYGIENE-BOX-COMPILATION-CONTEXT-IMPLEMENTATION-TOUCH-SET-CONTRACT-001
...
Define the implementation touch set for the selected BoxCompilationContext
typed execution harness IR. The contract stays consultation-only and names
the first concrete slice that implementation would touch, without opening
code changes.
...
input: implementation entry contract
...
- the first implementation touch is the selected BoxCompilationContext harness slice
