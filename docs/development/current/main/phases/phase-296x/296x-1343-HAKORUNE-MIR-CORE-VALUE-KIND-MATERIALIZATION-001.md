...
```text
apps/rust-subset-to-hako/examples/hakorune_mir_core_value_kind_expected/crate-manifest.json
apps/rust-subset-to-hako/examples/hakorune_mir_core_value_kind_expected/modules/0000.json
apps/rust-subset-to-hako/examples/hakorune_mir_core_value_kind_expected.hako
apps/rust-subset-to-hako/convert_hakorune_mir_core_value_kind_crate_file.hako
```
