...
Next:
  Use the ret0.exe nyash_kernel_runtime registry create-default-registry rebuild-cache exact-top-symbol
  ...
  symbols inside nyash_kernel_runtime, and PERF-USERBOX-034 now isolates the
  registry create-default-registry rebuild-cache exact top symbols inside
