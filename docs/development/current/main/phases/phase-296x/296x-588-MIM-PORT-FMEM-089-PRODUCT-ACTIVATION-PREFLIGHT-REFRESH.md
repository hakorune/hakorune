...
Refresh the product activation preflight so it consumes the refreshed abandoned
reclaim producer evidence. This row should select product activation while
keeping product activation behavior, hooks, global allocator claim, and winner
claim closed.

## Required Boundaries

```text
product activation behavior remains closed
