...
### Test Fixture
1. legacy fixture pin token `phase263_p0_pattern2_seg_min.hako` - Minimal reproduction test
2. archived smoke stem `phase263_p0_pattern2_seg_vm.sh` - VM smoke test
...
### Test Files
- same fixture/smoke pair as above (`phase263_p0_pattern2_seg_min.hako` / `phase263_p0_pattern2_seg_vm.sh`) - SSOT fixture and VM smoke
...
- legacy fixture pin token `phase263_pattern2_seg_realworld_min.hako` (Stage‑B 実ログ最小化)
- archived smoke stem `phase263_pattern2_seg_realworld_min_vm.sh`
