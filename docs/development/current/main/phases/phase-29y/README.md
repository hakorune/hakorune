...
- Task 1: NyRT handle ABI shim（lifecycle） ✅ done (2026-02-11)
  ...
  - evidence:
    ...
    - `bash tools/smokes/v2/profiles/integration/apps/phase29y_handle_abi_vm.sh` PASS
...
- Task 2b: RC insertion minimal（overwrite release 1-case） ✅ done (2026-02-11)
  ...
  - smoke: `tools/smokes/v2/profiles/integration/apps/phase29y_rc_insertion_overwrite_release_vm.sh`
  - evidence:
    - `bash tools/smokes/v2/profiles/integration/apps/phase29y_rc_insertion_overwrite_release_vm.sh` PASS
  - stability note:
