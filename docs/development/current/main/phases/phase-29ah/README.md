...
- P0: ✅ COMPLETE（loop_break real-world route を回帰パックへ追加。historical filter key: `phase263_pattern2_*`）
...
- 追加対象: `loop_break_realworld_vm`（historical filter key: `phase263_pattern2_*`; archive/inventory用）
