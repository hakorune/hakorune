...
- IfPhiJoin: `phase118_pattern3_if_sum_vm`（legacy fixture pin token; fixture: `apps/tests/phase118_pattern3_if_sum_min.hako`）
...
- `./tools/smokes/v2/profiles/integration/joinir/if_phi_join_planner_required_pack_vm.sh`（compat stem: `phase29bn_planner_required_pattern3_pack_vm.sh`）
