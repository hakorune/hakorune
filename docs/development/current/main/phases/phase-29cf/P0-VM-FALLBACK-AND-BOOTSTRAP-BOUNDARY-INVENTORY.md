...
| `route observability keep` | [tools/smokes/v2/profiles/integration/apps/phase29x_vm_route_observability_vm.sh](/home/tomoaki/git/hakorune-selfhost/tools/smokes/v2/profiles/integration/apps/phase29x_vm_route_observability_vm.sh) | verifies stable route tags for `vm` / `compat-fallback` / `vm-hako` |
| `strict-dev priority keep` | [tools/smokes/v2/profiles/integration/apps/phase29x_vm_route_strict_dev_priority_vm.sh](/home/tomoaki/git/hakorune-selfhost/tools/smokes/v2/profiles/integration/apps/phase29x_vm_route_strict_dev_priority_vm.sh) | verifies strict/dev chooses `vm-hako` and compat fallback remains explicit |
| `non-strict compat boundary keep` | [tools/smokes/v2/profiles/integration/selfhost/phase29x_vm_route_non_strict_compat_boundary_vm.sh](/home/tomoaki/git/hakorune-selfhost/tools/smokes/v2/profiles/integration/selfhost/phase29x_vm_route_non_strict_compat_boundary_vm.sh) | verifies non-strict stage-a rejects compat lane unless fallback env is explicit |
