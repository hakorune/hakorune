...
| 3 | `38xC archive-later queue freeze` | active | pin top-level bootstrap/plugin/deadcode shims as archive-later until doc drain lands |
...
| `38xC1` | active | freeze `tools/bootstrap_selfhost_smoke.sh`, `tools/plugin_v2_smoke.sh`, `tools/hako_check_deadcode_smoke.sh` as archive-later |
