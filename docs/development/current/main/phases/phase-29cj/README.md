...
- consequence after that cut: `MirBuilderBox.hako` is close to a pure route-sequencing owner, with only small compat shims left around func-defs and source-entry checked handoff
