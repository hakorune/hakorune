...
- consequence after that cut: `MirBuilderBox.hako` is close to a pure route-sequencing owner, with only small compat shims left around func-defs while source-entry checked handoff lives in `MirBuilderSourceCompatBox`
