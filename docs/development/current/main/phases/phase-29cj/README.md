...
- immediate next helper-local order after that runner slice:
  1. `tools/selfhost/selfhost_build.sh` isolated consumer helpers
  2. `tools/smokes/v2/lib/test_runner.sh` residual helper-local verify lanes
