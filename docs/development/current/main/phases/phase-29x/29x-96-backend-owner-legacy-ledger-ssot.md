...
| `src/host_providers/llvm_codegen/hako_ll_driver.rs` | compare/debug driver adapter | compare-only bridge | daily transport cut + compare bridge retirement | archive-later | keep template/VM residue out of mainline tool boundary |
