...
Related:
  - docs/development/current/main/phases/phase-295x/295x-196-MIMALLOC-COMPARISON-MALLOC-LARGE-EMPTY-EXE-FOOTPRINT-CLOSEOUT.md
  - tools/checks/k2_wide_phase295x_malloc_large_nyrt_rss_checkpoint_diagnostic_guard.sh
---

# 295x-197 Mimalloc Comparison NyRT RSS Checkpoint Diagnostic
...
```bash
bash tools/checks/k2_wide_phase295x_malloc_large_nyrt_rss_checkpoint_diagnostic_guard.sh
git diff --check
