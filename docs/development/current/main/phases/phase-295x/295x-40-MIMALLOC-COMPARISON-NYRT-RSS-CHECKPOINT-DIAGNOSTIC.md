...
Status: Landed
Date: 2026-05-25
Scope: add env-gated NyRT self-RSS checkpoints.
Blocker: MIMALLOC-COMPARISON-NYRT-RSS-CHECKPOINT-DIAGNOSTIC-295X-001
Related:
  - docs/development/current/main/phases/phase-295x/295x-39-MIMALLOC-COMPARISON-HAKO-EMPTY-EXE-FOOTPRINT-CLOSEOUT.md
  - crates/nyash_kernel/src/rss_observe.rs
  - tools/checks/k2_wide_phase295x_nyrt_rss_checkpoint_diagnostic_guard.sh
---

# 295x-40 Mimalloc Comparison NyRT RSS Checkpoint Diagnostic
...
Add a NyRT entry diagnostic controlled by:
...
```bash
bash tools/checks/k2_wide_phase295x_nyrt_rss_checkpoint_diagnostic_guard.sh
git diff --check
