...
Status: Landed
Date: 2026-05-25
Scope: diagnose empty exact-EXE RSS and static footprint.
Blocker: MIMALLOC-COMPARISON-HAKO-EMPTY-EXE-FOOTPRINT-DIAGNOSTIC-295X-001
Related:
  ...
  - tools/checks/k2_wide_phase295x_hako_empty_exe_footprint_diagnostic_guard.sh
---

# 295x-38 Mimalloc Comparison Hako Empty EXE Footprint Diagnostic
...
```bash
bash tools/checks/k2_wide_phase295x_hako_empty_exe_footprint_diagnostic_guard.sh
git diff --check
