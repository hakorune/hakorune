...
Related:
  - docs/development/current/main/phases/phase-295x/295x-194-MIMALLOC-COMPARISON-MALLOC-LARGE-BASELINE-BREAKDOWN-SELECTION.md
  - tools/allocator/mimalloc_hako_empty_exe_footprint.py
  - tools/checks/k2_wide_phase295x_malloc_large_empty_exe_footprint_diagnostic_guard.sh
---

# 295x-195 Malloc-Large Empty EXE Footprint Diagnostic
...
```bash
bash tools/checks/k2_wide_phase295x_malloc_large_empty_exe_footprint_diagnostic_guard.sh
git diff --check
