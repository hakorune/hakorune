...
Status: Landed
Date: 2026-05-25
Scope: phase-295x plugin load-set RSS diagnostic on the external malloc-large path
Blocker: MIMALLOC-COMPARISON-NYRT-PLUGIN-LOADSET-FOOTPRINT-DIAGNOSTIC-295X-002
Related:
  - docs/development/current/main/phases/phase-295x/295x-201-MIMALLOC-COMPARISON-NYRT-PLUGIN-LOADSET-FOOTPRINT-SELECTION.md
---

# 295x-202 NyRT Plugin Load-Set Footprint Diagnostic
...
```bash
bash tools/checks/k2_wide_phase295x_malloc_large_nyrt_plugin_loadset_footprint_diagnostic_guard.sh
git diff --check
