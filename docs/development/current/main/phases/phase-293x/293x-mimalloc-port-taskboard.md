...
| `MIMAP-110A` | selected current | Post-local-free-candidate-ledger row selection. | after MIMAP-109A |
...
Current row after MIMAP-109A:
`MIMAP-110A` selects exactly one next row using the validation cadence SSOT.
