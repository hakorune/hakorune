...
| `MIMAP-303A` | selected current | Post release/recycle lifecycle-continuation bridge closeout row selection. | after MIMAP-302A |
...
Current row:
`MIMAP-303A` selects the next narrow allocator row after the scalar/model
