...
| `MIMAP-118A` | selected current | Post-local-free-page-apply-closeout row selection. | after MIMAP-117A |
...
Current row after MIMAP-117A:
`MIMAP-118A` selects exactly one next row using the validation cadence SSOT.
