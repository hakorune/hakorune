...
| `MIMAP-083A` | selected current | Segment lifecycle scalar state closeout guard. | after MIMAP-082A |
...
Current row after MIMAP-082A: `MIMAP-083A` closes out the scalar segment
