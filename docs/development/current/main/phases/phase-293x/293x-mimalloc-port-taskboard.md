...
| `MIMAP-116A` | selected current | Post-local-free-page-apply row selection. | after MIMAP-115A |
...
Current row after MIMAP-115A:
`MIMAP-116A` selects exactly one next row using the validation cadence SSOT.
