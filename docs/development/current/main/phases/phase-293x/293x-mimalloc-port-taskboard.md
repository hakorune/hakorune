...
| `MIMAP-253A` | selected current | Segment arena backing modeled residence arena-binding diagnostics. | current diagnostic row |
...
Current row:
`MIMAP-253A` adds observer-only diagnostics for the modeled residence
