...
| `MIMAP-233A` | selected current | Source lifecycle-keyed release apply/recycle continuation diagnostics. | current allocator row |
...
Current row:
`MIMAP-233A` adds diagnostics around lifecycle-keyed source release
