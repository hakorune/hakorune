...
| `MIMAP-232A` | selected current | Source lifecycle-keyed release apply/recycle continuation bridge. | current allocator row |
...
Current row:
`MIMAP-232A` connects lifecycle-keyed source release rows into modeled
