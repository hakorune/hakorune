...
- Status: Active / mimalloc blueprint lane with facade huge-release metadata route active
...
- Current allocator blocker:
  `docs/development/current/main/phases/phase-293x/293x-438-MIMAP-024A-FACADE-HUGE-RELEASE-METADATA-ROUTE.md`
