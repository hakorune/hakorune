...
- Status: Active / mimalloc blueprint lane with facade huge-release fail-fast diagnostics route active
...
- Current allocator blocker:
  `docs/development/current/main/phases/phase-293x/293x-440-MIMAP-025A-FACADE-HUGE-RELEASE-FAILFAST-ROUTE.md`
