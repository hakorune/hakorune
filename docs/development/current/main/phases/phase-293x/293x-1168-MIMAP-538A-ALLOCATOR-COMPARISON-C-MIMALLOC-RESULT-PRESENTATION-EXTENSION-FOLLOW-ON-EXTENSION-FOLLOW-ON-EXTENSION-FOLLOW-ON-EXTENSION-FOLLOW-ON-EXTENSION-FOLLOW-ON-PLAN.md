# 293x-1168 MIMAP-538A Allocator Comparison C Mimalloc Result Presentation Extension Follow-On Extension Follow-On Extension Follow-On Extension Follow-On Extension Follow-On Plan
...
Define the next follow-on boundary over the landed MIMAP-534A presentation
...
- Define the owner boundary for a later presentation extension follow-on
  ...
  follow-on row.
- Record the required input evidence from the landed MIMAP-534A presentation
  extension follow-on extension follow-on extension follow-on extension
...
follow-on extension follow-on extension follow-on owner may consume only the
accepted MIMAP-534A
...
follow-on extension follow-on extension follow-on row may:
...
The later presentation extension follow-on extension follow-on extension
follow-on extension follow-on extension follow-on row must not:
...
1. Define the future presentation extension follow-on extension follow-on
   extension follow-on extension follow-on extension follow-on owner boundary
   over the landed presentation extension follow-on extension follow-on
   extension follow-on extension follow-on extension pilot report.
...
Landed. MIMAP-539A is selected as the next row-selection card.

## Next

MIMAP-539A should choose whether the next row is a presentation extension
