...
- `48xB1` smoke script stale-route cleanup is landed; `48xB2` proof-only smoke gate lock is landed; `48xC1` source helper stale-route cleanup is the active cleanup move, with the current proof/compat scripts and helpers tagged accordingly.
