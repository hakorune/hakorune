...
Status: Active
Date: 2026-04-04
Scope: thin current/design docs that still describe old wrapper/current surfaces too noisily after the latest runner/selfhost recuts.
Related:
  - CURRENT_TASK.md
...
- thin current/design docs that still over-describe old wrapper/current surfaces
