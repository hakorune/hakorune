...
- `phase29cc_wsm/p5` / `phase29cc_wsm/p6` / `phase29cc_wsm/p7` の切り出しは完了し、次の active family は `phase29cc_wsm/p8` を優先して `integration/apps` から切る。ただし portability slice が先に入るなら、`p8` はいったん parked でよい
