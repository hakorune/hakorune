...
| 2 | `49xB guide cleanup` | queued | rewrite guide examples so vm is compat/proof only |
...
| `49xA2` | active | top-level docs compat wording rewrite |
| `49xB1` | queued | current guides compat wording rewrite |
...
| Item | State |
| --- | --- |
| Now | `49xA2 top-level docs compat wording rewrite` |
| Blocker | `none` |
| Next | `49xB1 current guides compat wording rewrite` |
