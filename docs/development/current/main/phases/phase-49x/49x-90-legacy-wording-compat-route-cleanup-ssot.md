...
| --- | --- | --- |
| Proof-only keep | `tools/selfhost/run_stageb_compiler_vm.sh`, `tools/selfhost/bootstrap_selfhost_smoke.sh`, `tools/selfhost/selfhost_smoke.sh`, `tools/selfhost/selfhost_stage3_accept_smoke.sh`, `tools/plugins/plugin_v2_smoke.sh`, `tools/exe_first_smoke.sh`, `tools/exe_first_runner_smoke.sh`, `tools/hako_check.sh`, `tools/engineering/parity.sh`, `tools/test_stageb_using.sh`, `tools/archive/legacy-selfhost/engineering/program_analyze.sh`, `tools/archive/legacy-selfhost/engineering/gen_v1_min.sh`, `tools/phi_trace_bridge_try.sh`, `tools/ny_selfhost_inline.sh` | keep explicit and non-growing |
