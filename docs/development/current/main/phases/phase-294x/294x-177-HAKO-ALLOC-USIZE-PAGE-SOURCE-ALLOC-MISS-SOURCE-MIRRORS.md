...
Status: Landed
Date: 2026-05-24
Scope: object-lifecycle facade page-source alloc-miss source mirror exact `usize` migration.
Blocker: HAKO-ALLOC-USIZE-FIELD-GROUP-176
Related:
  - docs/development/current/main/design/usize-semantic-foundation-ssot.md
  - docs/development/current/main/phases/phase-294x/294x-176-HAKO-ALLOC-USIZE-PAGE-SOURCE-ALLOC-MISS-SOURCE-MIRROR-SELECTION.md
...
# 294x-177 Hako Alloc Usize Page-Source Alloc-Miss Source Mirrors

## Decision

Migrate only the selected alloc-miss report source count mirror fields in
...
The alloc-miss EXE guard now verifies that these fields are exact `usize`
while the status, reason, identity, pointer-like, and byte-length seams stay
signed.
