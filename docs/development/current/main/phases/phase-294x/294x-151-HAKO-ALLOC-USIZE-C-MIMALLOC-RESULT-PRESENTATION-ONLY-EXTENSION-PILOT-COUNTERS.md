...
Status: Landed
Date: 2026-05-24
Scope: C mimalloc result presentation-only extension pilot owner-local counter exact `usize` migration.
Related:
  - docs/development/current/main/design/usize-semantic-foundation-ssot.md
  - docs/development/current/main/phases/phase-294x/294x-150-HAKO-ALLOC-USIZE-C-MIMALLOC-RESULT-PRESENTATION-ONLY-EXTENSION-PILOT-COUNTER-SELECTION.md
...
# 294x-151 Hako Alloc Usize C Mimalloc Result Presentation-Only Extension Pilot Counters
...
The MIMAP-560A presentation-only extension pilot guard now asserts these fields
are exact `usize` in the owner typed-object plan.
