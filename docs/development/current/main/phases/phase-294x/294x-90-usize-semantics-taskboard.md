...
```text
MIMALLOC-COMPARISON-RESULT-SUMMARY-INVENTORY-REFRESH-001:
  selected current after 294x-230. Refresh the existing MIMAP-457A comparison
  result summary inventory over the validated C-vs-Hako result ledger and
  diagnostics. Do not drain report mirrors, identity payloads, status/reason
