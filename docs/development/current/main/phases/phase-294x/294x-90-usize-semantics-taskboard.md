...
- [ ] Preserve method parameter type annotations.
- [ ] Preserve static method parameter type annotations.
- [ ] Preserve `birth` parameter type annotations.
- [ ] Preserve return type annotations or reject them consistently.
