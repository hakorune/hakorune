...
Status: Landed
Date: 2026-05-24
Scope: select the next object-lifecycle facade page-source attach report payload exact `usize` row.
Blocker: HAKO-ALLOC-USIZE-FIELD-GROUP-173
Related:
  - docs/development/current/main/design/usize-semantic-foundation-ssot.md
  - docs/development/current/main/phases/phase-294x/294x-173-HAKO-ALLOC-USIZE-PAGE-SOURCE-ATTACH-REPORT-MIRROR-COUNTERS.md
...
# 294x-174 Hako Alloc Usize Page-Source Attach Report Payload Selection

## Decision

Select the page-source attach report non-negative payload fields in
...
These fields are validated as positive before attach succeeds or are passed
through the reject report as non-negative payloads. They do not carry sentinel
values.
