...
Status: Landed
Date: 2026-05-23
Scope: C mimalloc result presentation-only conclusion pilot owner-local counter exact `usize` migration.
Related:
  - docs/development/current/main/design/usize-semantic-foundation-ssot.md
  - docs/development/current/main/phases/phase-294x/294x-125-HAKO-ALLOC-USIZE-C-MIMALLOC-RESULT-PRESENTATION-ONLY-CONCLUSION-PILOT-COUNTER-SELECTION.md
  ...
  - apps/hako-alloc-allocator-comparison-c-mimalloc-result-presentation-only-conclusion-pilot-proof/main.hako
  - tools/checks/k2_wide_hako_alloc_allocator_comparison_c_mimalloc_result_presentation_only_conclusion_pilot_guard.sh
---

# 294x-126 Hako Alloc Usize C Mimalloc Result Presentation-Only Conclusion Pilot Counters
...
The MIMAP-474A C mimalloc result presentation-only conclusion pilot guard now
...
```bash
bash tools/checks/k2_wide_hako_alloc_allocator_comparison_c_mimalloc_result_presentation_only_conclusion_pilot_guard.sh
