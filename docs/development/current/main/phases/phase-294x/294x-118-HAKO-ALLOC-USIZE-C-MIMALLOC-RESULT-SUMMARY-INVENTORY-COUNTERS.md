...
Status: Landed
Date: 2026-05-23
Scope: C mimalloc result summary inventory owner-local counter exact `usize` migration.
Related:
  - docs/development/current/main/design/usize-semantic-foundation-ssot.md
  - docs/development/current/main/phases/phase-294x/294x-117-HAKO-ALLOC-USIZE-C-MIMALLOC-RESULT-SUMMARY-INVENTORY-COUNTER-SELECTION.md
  - docs/development/current/main/phases/phase-294x/294x-90-usize-semantics-taskboard.md
  - lang/src/hako_alloc/memory/NUMERIC_FIELDS.md
  - lang/src/hako_alloc/memory/allocator_comparison_c_mimalloc_result_summary_inventory_box.hako
  - apps/hako-alloc-allocator-comparison-c-mimalloc-result-summary-inventory-proof/main.hako
  - tools/checks/k2_wide_hako_alloc_allocator_comparison_c_mimalloc_result_summary_inventory_guard.sh
---

# 294x-118 Hako Alloc Usize C Mimalloc Result Summary Inventory Counters
...
The MIMAP-457A C mimalloc result summary inventory guard now asserts these
...
```bash
bash tools/checks/k2_wide_hako_alloc_allocator_comparison_c_mimalloc_result_summary_inventory_guard.sh
