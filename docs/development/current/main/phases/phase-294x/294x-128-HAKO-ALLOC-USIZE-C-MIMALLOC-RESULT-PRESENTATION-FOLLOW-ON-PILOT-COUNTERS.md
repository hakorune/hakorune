...
Status: Landed
Date: 2026-05-23
Scope: C mimalloc result presentation follow-on pilot owner-local counter exact `usize` migration.
Related:
  - docs/development/current/main/design/usize-semantic-foundation-ssot.md
  - docs/development/current/main/phases/phase-294x/294x-127-HAKO-ALLOC-USIZE-C-MIMALLOC-RESULT-PRESENTATION-FOLLOW-ON-PILOT-COUNTER-SELECTION.md
  ...
  - apps/hako-alloc-allocator-comparison-c-mimalloc-result-presentation-follow-on-pilot-proof/main.hako
  - tools/checks/k2_wide_hako_alloc_allocator_comparison_c_mimalloc_result_presentation_follow_on_pilot_guard.sh
---

# 294x-128 Hako Alloc Usize C Mimalloc Result Presentation Follow-On Pilot Counters
...
The MIMAP-480A C mimalloc result presentation follow-on pilot guard now asserts
...
```bash
bash tools/checks/k2_wide_hako_alloc_allocator_comparison_c_mimalloc_result_presentation_follow_on_pilot_guard.sh
