...
Status: Landed
Date: 2026-05-24
Scope: C mimalloc result presentation extension follow-on extension follow-on pilot owner-local counter exact `usize` migration.
Related:
  - docs/development/current/main/design/usize-semantic-foundation-ssot.md
  - docs/development/current/main/phases/phase-294x/294x-136-HAKO-ALLOC-USIZE-C-MIMALLOC-RESULT-PRESENTATION-EXTENSION-FOLLOW-ON-EXTENSION-FOLLOW-ON-PILOT-COUNTER-SELECTION.md
  ...
  - apps/hako-alloc-allocator-comparison-c-mimalloc-result-presentation-extension-follow-on-extension-follow-on-pilot-proof/main.hako
...
# 294x-137 Hako Alloc Usize C Mimalloc Result Presentation Extension Follow-On Extension Follow-On Pilot Counters
...
The MIMAP-504A C mimalloc result presentation extension follow-on extension
follow-on pilot guard now asserts these fields are exact `usize` in the
typed-object plan.
...
```bash
bash tools/checks/k2_wide_hako_alloc_allocator_comparison_c_mimalloc_result_presentation_extension_follow_on_extension_follow_on_pilot_guard.sh
