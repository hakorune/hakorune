...
Status: Landed
Date: 2026-05-23
Scope: C mimalloc result presentation extension follow-on pilot owner-local counter exact `usize` migration.
Related:
  - docs/development/current/main/design/usize-semantic-foundation-ssot.md
  - docs/development/current/main/phases/phase-294x/294x-131-HAKO-ALLOC-USIZE-C-MIMALLOC-RESULT-PRESENTATION-EXTENSION-FOLLOW-ON-PILOT-COUNTER-SELECTION.md
  ...
  - apps/hako-alloc-allocator-comparison-c-mimalloc-result-presentation-extension-follow-on-pilot-proof/main.hako
  - tools/checks/k2_wide_hako_alloc_allocator_comparison_c_mimalloc_result_presentation_extension_follow_on_pilot_guard.sh
---

# 294x-132 Hako Alloc Usize C Mimalloc Result Presentation Extension Follow-On Pilot Counters
...
The MIMAP-492A C mimalloc result presentation extension follow-on pilot guard
now asserts these fields are exact `usize` in the typed-object plan.
...
```bash
bash tools/checks/k2_wide_hako_alloc_allocator_comparison_c_mimalloc_result_presentation_extension_follow_on_pilot_guard.sh
