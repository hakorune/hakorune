...
Status: Landed
Date: 2026-05-24
Scope: pointer-derived lookup execution pilot owner-local accept/reject counter exact `usize` migration.
Blocker: HAKO-ALLOC-USIZE-FIELD-GROUP-220
Related:
  - docs/development/current/main/design/usize-semantic-foundation-ssot.md
  - docs/development/current/main/phases/phase-294x/294x-223-HAKO-ALLOC-USIZE-POINTER-DERIVED-LOOKUP-REJECT-COUNTER-SELECTION.md
...
# 294x-224 Hako Alloc Usize Pointer-Derived Lookup Reject Counters
