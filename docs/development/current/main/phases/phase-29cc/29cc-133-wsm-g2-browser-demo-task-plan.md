---
Status: Active (WSM-G2-min1/min2/min3 done, WSM-G3-min1/min2/min3/min4/min5/min6/min7/min8/min9/min10/min11/min12/min13 done, WSM-P1-min1/min2 done, WSM-P2-min1 done, WSM-P3-min1 done, WSM-P4-min1 done, WSM-P4-min2 next)
Decision: pending
Date: 2026-02-26
...
4. **G3 prep (WSM-G3-min1/min2/min3/min4/min5/min6/min7/min8/min9/min10/min11/min12/min13 done; WSM-P1-min1/min2 done, WSM-P2-min1 done, WSM-P3-min1 done, WSM-P4-min1 done, WSM-P4-min2 active next)**
