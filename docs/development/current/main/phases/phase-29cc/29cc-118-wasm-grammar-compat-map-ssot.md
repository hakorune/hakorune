...
| method call | `MirInstruction::Call { callee: Method }` | partial | supported methods: `toString`, `print`, `equals`, `clone`, `log`, `info`, `debug`, `warn`, `error` in `src/backend/wasm/codegen/builtins.rs` |
