...
| external call | `MirInstruction::Call { callee: Extern }` | partial | supported: `env.console.log`, `env.console.warn`, `env.console.error`, `env.console.info`, `env.canvas.fillRect`, `env.canvas.fillText` in `src/backend/wasm/codegen/instructions.rs` |
