...
| method call | `MirInstruction::Call { callee: Method }` | partial | supported methods: `toString`, `print`, `equals`, `clone`, `log`, `info`, `debug`, `warn` in `src/backend/wasm/codegen/builtins.rs` |
