...
2. `bash tools/smokes/v2/profiles/integration/phase29cc_wsm/p6/phase29cc_wsm_p6_min1_route_policy_default_noop_lock_vm.sh`
3. `bash tools/smokes/v2/profiles/integration/phase29cc_wsm/g4/phase29cc_wsm_g4_min5_headless_two_examples_vm.sh`
