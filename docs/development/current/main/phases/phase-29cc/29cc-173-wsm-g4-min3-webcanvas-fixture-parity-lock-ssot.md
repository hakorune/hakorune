...
Depends:
  ...
  - tools/smokes/v2/profiles/integration/apps/phase29cc_wsm_g4_min3_webcanvas_fixture_parity_vm.sh
---
...
`nyash_playground.html` の `webcanvas` ルートについて、source marker と fixture compile parity を同時に固定する。
