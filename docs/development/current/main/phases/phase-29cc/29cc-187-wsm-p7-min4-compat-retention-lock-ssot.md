...
Related:
  ...
  - tools/smokes/v2/profiles/integration/apps/phase29cc_wsm_p7_min4_compat_retention_lock_vm.sh
  - CURRENT_TASK.md
...
## Acceptance
1. `bash tools/smokes/v2/profiles/integration/apps/phase29cc_wsm_p7_min4_compat_retention_lock_vm.sh`
