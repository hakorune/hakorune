...
Related:
  ...
  - tools/smokes/v2/profiles/integration/apps/phase29cc_wsm_p10_min8_error_native_promotion_lock_vm.sh
...
## Acceptance
1. `bash tools/smokes/v2/profiles/integration/apps/phase29cc_wsm_p10_min8_error_native_promotion_lock_vm.sh`
