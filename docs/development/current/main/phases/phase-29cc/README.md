...
- post-wave1 route lock（accepted）:
  ...
  - wasm lane P10 locks（min1 accepted-but-blocked, min2/min3/min4 accepted）:
  ...
  - wasm lane active next: `WSM-P10-min5`（loop/extern native promotion expansion inventory lock）
