---
Status: Active (M0-M4 done, RNR-05 done, non-plugin done declared, PLG-03 done, PLG-04-min1..min6 done, PLG-04 wave-1 complete, PLG-05-min1..min4 done)
...
- plugin lane `PLG-04-min6` は done（wave-1 FileBox rollout）:
  - `docs/development/current/main/phases/phase-29cc/29cc-104-plg04-filebox-wave1-min6-ssot.md`
  - active next: `PLG-05-min5`（wave-2 rollout）
