...
- LoopContinueOnly multidelta gate: `./tools/smokes/v2/profiles/integration/joinir/loop_continue_only_multidelta_planner_required_vm.sh`（compat wrapper: `phase29bq_pattern4continue_multidelta_planner_required_vm.sh`）
