...
- LoopContinueOnly multidelta gate: `./tools/smokes/v2/profiles/integration/joinir/loop_continue_only_multidelta_planner_required_vm.sh`（exact compat wrapper is tracked in `joinir-smoke-legacy-stem-retirement-ssot.md`）
