...
| R4 | Array generic load/encode | `array_handle_cache.rs`, `array_slot_load.rs` | 2 sites | medium | `289x-3f` | next |
...
| `289x-3f` | Rust array generic load/encode demand tags | next; behavior unchanged |
