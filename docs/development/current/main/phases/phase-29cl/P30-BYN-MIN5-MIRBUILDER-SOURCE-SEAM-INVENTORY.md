...
5. current judgment: `emit_from_source_v0` remains a live compat owner, not frozen residue yet
6. this slice must not reopen `build_surrogate.rs`, `llvm_backend_surrogate.rs`, or `resolve_for_source`
