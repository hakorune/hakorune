...
- remaining explicit proof-only VM pressure now sits in:
...
- stage0 capture helper stays route-neutral
...
4. demote `run_stageb_compiler_vm.sh` to explicit proof-only keep
5. prove and close out
