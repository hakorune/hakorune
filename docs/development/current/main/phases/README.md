...
- **Current (ACTIVE)**: Phase 79x launcher emit_mir residual blocker follow-up
...
- **Phase 79x（ACTIVE）**: launcher emit_mir residual blocker follow-up（focused launcher probe red を source 側で詰める）
