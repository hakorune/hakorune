...
Status: satisfied. 137x-B may reopen owner-first optimization, but `publish.any`
and runtime-wide `Value Lane Architecture` implementation remain blocked here.
