...
| `InlinePlan` (MIR-owned metadata) | live for `Hint(inline/noinline/hot/cold)` preserve | n/a | todo for required inline | n/a | soft same-module leaf inline | live-narrow |
