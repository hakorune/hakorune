...
- **Next ordered task:** `LOOP-COMMON-V2-PHYSICAL-ENTRY-EFFECTS-D0` must name
  the first post-layout effect carrier and its rollback boundary. The landed
  layout transport remains caller-zero and effect-free. Loop CFG/block
  effects, reads, PHI, Completion claims, and DraftSeal remain closed.
...
| 25b-f-I0 | `LOOP-COMMON-V2-PHYSICAL-LAYOUT-INPUT-I0` | lend typed loop/block/item topology and JoinSig transfer bindings through the same common-V2 cohort | landed 2026-08-17; no Builder/block allocation, operation/read/Const, CFG/PHI, Completion claim, DraftSeal, lifecycle, Text, route, fallback, retry, or production caller |
| 25b-g | `LOOP-COMMON-V2-PHYSICAL-ENTRY-EFFECTS-D0` | after layout input is sealed, name the first post-entry effect carrier and rollback boundary | next design stop after 25b-f-I0; no effect emission, Loop CFG/PHI, Completion claim, DraftSeal, lifecycle, Text, route, fallback, retry, or production caller |
