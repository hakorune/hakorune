...
current implementation task:
  ...
  The supported_value_expr_classifier owner is HakoAdopted as the
  one-hundred-twenty-eighth narrow Rust-oracle parity pilot after the green
  4-row `.hako` EXE parity gate; next is rerun 131.
