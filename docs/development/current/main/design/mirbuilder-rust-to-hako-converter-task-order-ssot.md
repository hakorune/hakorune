...
current implementation task:
  ...
  The direct_step_placement_classifier owner is HakoAdopted as the
  one-hundred-thirty-ninth narrow Rust-oracle parity pilot after the green
  4-row `.hako` EXE parity gate; next is rerun 142.
