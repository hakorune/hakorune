...
next active:
  MIRBUILDER-DOMAIN-OBJECT-ID-TRANSPORT-POLICY-INVENTORY-RERUN-002; status=landed; output_contract=rust-lifecycle-mirbuilder-domain-object-id-transport-policy-inventory-rerun-002; selected_next_card=MIRBUILDER-DOMAIN-OBJECT-ID-UNRESOLVED-SUBAXIS-PRIORITY-RESOLUTION-001; domain_object_id_input_count = 116; closed_id_scalar_row_count = 31; new_id_scalar_source_id_count = 0; unresolved_non_id_domain_row_count = 85; manual_subaxis_selection = 0; source_selfhost_claim = 0
  MIRBUILDER-DOMAIN-OBJECT-ID-UNRESOLVED-SUBAXIS-PRIORITY-RESOLUTION-001; status=design-stop-consulted; output_contract=rust-lifecycle-mirbuilder-domain-object-id-unresolved-subaxis-priority-resolution; consultation_selected_next=MIRBUILDER-DOMAIN-OBJECT-ID-EXPLICIT-SEMANTIC-RESOURCE-DOMAIN-DECLARATION-BASIS-001; decision=KeepStopped; reason=NoMachineDerivedDomainObjectIdUnresolvedSubaxisPriority; recovery=DesignConsultationRequired; selection_eligible_subaxis_count = 0; manual_subaxis_selection = 0; source_selfhost_claim = 0
  MIRBUILDER-DOMAIN-OBJECT-ID-EXPLICIT-SEMANTIC-RESOURCE-DOMAIN-DECLARATION-BASIS-001; status=landed; output_contract=rust-lifecycle-mirbuilder-domain-object-id-lane-guard; guard_profile=explicit_semantic_resource_domain_declaration_basis; candidate_registry_row_count = 42; resource_domain_declaration_ready_count = 0; registry_ready_row_count = 0; accepted_typed_dependency_edge_count = 0; selected_next_card=MIRBUILDER-DOMAIN-OBJECT-ID-SEMANTIC-RESOURCE-DOMAIN-DECLARATION-INVENTORY-001; manual_subaxis_selection = 0; dependency_root_authority_proven = 0; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-DOMAIN-OBJECT-ID-SEMANTIC-RESOURCE-DOMAIN-DECLARATION-INVENTORY-001 -> SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-BASIS-008
