...
next active:
  ...
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-TRANSPORT-CLOSEOUT-BASIS-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-transport-closeout-basis; scalar_known_transport_closeout_basis = 1; scalar_known_closeout_authority_root_consumed = 1; basis_only = 1; scalar_known_transport_axis_closeout = 0; concrete_carrier_type_axis_selection = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-TRANSPORT-CLOSEOUT-RERUN-001; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-TRANSPORT-CLOSEOUT-RERUN-001; status=next; expected_input=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-TRANSPORT-CLOSEOUT-BASIS-001; axis_closeout_allowed_only_after_rerun = 1; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-TRANSPORT-CLOSEOUT-RERUN-001 -> AXIS-CLOSEOUT-OR-KEEP-SCOPED
