...
latest design decision:
  3026 lands the covered ExprLogicalShapeSnapshotV1 ProgramJSON traversal rows
  as a scoped Rust ASTNode projector retire-candidate. 3027 is active to
  implement real `.hako` ProgramJsonLocalArrayLiteralShapeScanV1 traversal for
  covered Local.expr ArrayLiteral ProgramJSON structure.
...
## Active Next 3
```text
1. MIRBUILDER-PROGRAMJSON-LOCAL-ARRAY-LITERAL-SHAPE-SCAN-CAPABILITY-001
...
2. MIRBUILDER-PROGRAMJSON-LOCAL-ARRAY-LITERAL-SHAPE-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001
   status=pending; boundary=covered LocalArrayLiteralShapeSnapshotV1 rows only
