...
## Active Next 3
```text
landed summary: 3264..3290 cond_recipe/compare chain includes MIRBUILDER-BOOL-RECIPE-COMPARE-LOWERING-OBSERVE-ONLY-PILOT-001, MIRBUILDER-PROGRAMJSON-IF-COND-RECIPE-RELATIONAL-ROW-BATCH-001, MIRBUILDER-PROGRAMJSON-LOOP-NESTED-IF-COND-RECIPE-RELATIONAL-ROW-BATCH-001, MIRBUILDER-BOOL-RECIPE-COMPARE-LOWERING-EMISSION-CONSULTATION-001, MIRBUILDER-PROGRAMJSON-IF-LOOP-COMPARE-ROW-BATCH-CLOSEOUT-001, and compare-reader follow-on selection.

next active:
  MIRBUILDER-PROGRAMJSON-COMPARE-READER-FOLLOWON-SELECTION-001; status=landed; selected Var rhs bound parity; next=MIRBUILDER-PROGRAMJSON-COMPARE-READER-VAR-RHS-BOUND-PARITY-001; status=next; unit=implementation+parity gate; SymbolRef rhs for Compare(lhs=Var, op=< <= > >= == !=, rhs=Var); reversed Var/Var context inference=0; length bounds=0; lowering=0; route_selection=0; runtime_authority=rust_astnode
