...
next active:
  ...
  MIRBUILDER-DOMAIN-OBJECT-ID-UNRESOLVED-SUBAXIS-PRIORITY-RESOLUTION-001; status=design-stop; output_contract=rust-lifecycle-mirbuilder-domain-object-id-unresolved-subaxis-priority-resolution; selected_next_card=SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001; decision=KeepStopped; reason=NoMachineDerivedDomainObjectIdUnresolvedSubaxisPriority; recovery=DesignConsultationRequired; selection_eligible_subaxis_count = 0; manual_subaxis_selection = 0; source_selfhost_claim = 0
