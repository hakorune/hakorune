...
current implementation task:
  MIRBUILDER-FASTMEM-LLVM-VALUE-MEMOP-KIND-CLASSIFIER-HAKO-ADOPTION-DECISION-001.
  The fastmem_llvm_value_memop_kind_classifier owner is HakoAdopted as the
  one-hundred-forty-eighth narrow Rust-oracle parity pilot after the green
  6-row `.hako` EXE parity gate; next is rerun 152.
