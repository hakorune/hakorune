...
next active:
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-RUST-TYPED-DIRECT-CLOSEOUT-CONTRACT-BOUNDARY-REFACTOR-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-rust-typed-direct-closeout-contract-boundary-refactor-v0; rust_contract_boundary_refactor = 1; accepted_scoped_closeout_contract_count = 2; remaining_candidate_surface_count = 2; behavior_preserved = 1; direct_contract_selection = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-REMAINING-SURFACE-BOUNDARY-INVENTORY-RERUN-001; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-REMAINING-SURFACE-BOUNDARY-INVENTORY-RERUN-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-remaining-surface-boundary-inventory-rerun; selection_eligible_surface_count = 1; selected_surface_id=CollectionScalarI64Routes; selected_contract_id=CollectionLenScalarI64TypedDirectCloseoutContract; direct_contract_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-COLLECTION-LEN-SCALAR-I64-CONTRACT-BASIS-001; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-COLLECTION-LEN-SCALAR-I64-CONTRACT-BASIS-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-collection-len-scalar-i64-contract-basis; collection_len_scalar_i64_contract_basis = 1; collection_len_route_count = 4; direct_contract_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-COLLECTION-LEN-SCALAR-I64-CONTRACT-RERUN-001; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-COLLECTION-LEN-SCALAR-I64-CONTRACT-RERUN-001 -> SCOPED-CONTRACT-OR-WRITE-POLICY-OR-KEEP-STOPPED
