...
next active:
  ...
  MIRBUILDER-COMPARE-BOOLRECIPE-TO-MIR-COMPARE-BRANCH-CLOSEOUT-001; status=landed; output_contract=rust-lifecycle-mirbuilder-compare-boolrecipe-to-mir-compare-branch-closeout-v0; selected_next_card=MIRBUILDER-COMPARE-RUNTIME-ROUTE-AUTHORITY-DESIGN-STOP-001; compare_branch_lowering_bridge_chain_green = 1; route_selection = 0; runtime_route_switch = 0; programjson_runtime_authority = 0; runtime_fallback = 0; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-COMPARE-RUNTIME-ROUTE-AUTHORITY-DESIGN-STOP-001 -> MIRBUILDER-PROGRAMJSON-RECIPEMATCHER-RUNTIME-ROUTE-ADJACENT-SHADOW-GUARD-001
