...
next active:
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-SUBSURFACE-PRIORITY-RERUN-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-subsurface-priority-rerun; decision=KeepStopped; selection_eligible_subsurface_count = 0; selected_next_card=SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001; recommended_consultation_topic=WriteSubsurfacePriorityProofAxis; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-PARITY-GATE-001 -> WRITE-PUSH-SURFACE-ADOPTION-DECISION-OR-RERUN
