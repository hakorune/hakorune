...
next active:
  MIRBUILDER-CARRIER-TYPE-TRANSPORT-REMAINING-AXIS-PRIORITY-RERUN-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-transport-remaining-axis-priority-rerun; candidate_axis_count = 5; scope_eligible_axis_count = 5; guard_clean_axis_count = 5; proof_tuple_complete_axis_count = 0; selection_eligible_axis_count = 0; decision=KeepStopped; selected_next_card=MIRBUILDER-CARRIER-TYPE-TRANSPORT-REMAINING-AXIS-COMPONENT-REQUIREMENT-BASIS-001; manual_axis_selection = 0; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-TRANSPORT-REMAINING-AXIS-COMPONENT-REQUIREMENT-BASIS-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-transport-remaining-axis-component-requirement-basis; component_requirement_count = 7; root_component_requirement_count = 0; component_specific_card_selection_eligible_count = 0; concrete_carrier_type_axis_selection = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-TRANSPORT-REMAINING-AXIS-COMPONENT-REQUIREMENT-INVENTORY-001; manual_axis_selection = 0; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-TRANSPORT-REMAINING-AXIS-COMPONENT-REQUIREMENT-RERUN-001 -> CONSULTATION-REQUIRED
