...
latest design decision:
  3080 lands the covered ExprIndexShapeSnapshotV1 ProgramJSON traversal slice
  as a scoped Rust ASTNode projector retire-candidate. Next work returns to
  ProgramJSON capability-batch continuation. Selection-only ProgramJSON cards
  remain forbidden.
...
## Active Next 3
```text
1. MIRBUILDER-PROGRAMJSON-EXPR-INDEX-SHAPE-SCAN-CAPABILITY-001
   status=landed; boundary=real `.hako` ProgramJSON Expr.expr Index traversal

2. MIRBUILDER-PROGRAMJSON-EXPR-INDEX-SHAPE-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001
