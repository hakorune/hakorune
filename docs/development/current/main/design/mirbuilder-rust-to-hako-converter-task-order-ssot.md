...
next active:
  ...
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-SUBSURFACE-PRIORITY-BASIS-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-subsurface-priority-basis; write_subsurface_priority_basis = 1; candidate_write_subsurface_count = 3; basis_selects_write_subsurface = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-SUBSURFACE-PRIORITY-RERUN-001; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-SUBSURFACE-PRIORITY-RERUN-001 -> WRITE-SUBSURFACE-CONTRACT-BASIS-OR-DESIGN-STOP
