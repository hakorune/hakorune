...
latest design decision:
  3068 lands the covered NewFieldInitializerShapeSnapshotV1 ProgramJSON
  traversal slice as a scoped Rust ASTNode projector retire-candidate. Next work
  returns to ProgramJSON capability-batch continuation.
...
2. MIRBUILDER-PROGRAMJSON-NEW-FIELD-INITIALIZER-SHAPE-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001
   status=landed; boundary=covered NewFieldInitializerShapeSnapshotV1 rows only
