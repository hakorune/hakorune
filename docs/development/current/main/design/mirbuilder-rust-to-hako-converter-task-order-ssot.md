...
next active:
  ...
  SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-BASIS-008; status=landed; output_contract=rust-lifecycle-mirbuilder-domain-object-id-lane-guard; guard_profile=post_domain_object_id_exhaustion_wider_selection; domain_object_id_lane_parked = 1; selection_eligible_lane_count = 1; selected_next_card=MIRBUILDER-CARRIER-TYPE-TRANSPORT-REMAINING-AXIS-PRIORITY-BASIS-001; manual_axis_selection = 0; source_selfhost_claim = 0
