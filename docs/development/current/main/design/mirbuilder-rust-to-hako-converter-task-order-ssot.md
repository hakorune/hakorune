...
latest design decision:
  3019 lands the covered ExprRecordFieldShapeSnapshotV1 ProgramJSON traversal
  rows as a scoped Rust ASTNode projector retire-candidate. 3020 is active to
  implement real `.hako` ProgramJsonExprBinaryShapeScanV1 traversal for covered
