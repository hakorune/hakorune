...
next active:
  ...
  MIRBUILDER-BOOL-RECIPE-COMPARE-PUBLICATION-FIRST-PARITY-ROW-GATE-001; status=landed; output_contract=rust-lifecycle-mirbuilder-bool-recipe-compare-publication-first-parity-row-gate; bool_recipe_compare_publication_first_parity_row_gate = 1; selected_row_id=var_le_literal; publication_rows = 1; read_only_bool_recipe_compare_publication = 1; selected_next_card=MIRBUILDER-RECIPEITEM-CONDITION-SLOT-BOOL-RECIPE-BRIDGE-SELECTION-001; source_selfhost_claim = 0
