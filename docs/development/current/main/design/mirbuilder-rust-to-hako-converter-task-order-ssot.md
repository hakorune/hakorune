...
next active:
  ...
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-HAKO-PARITY-PILOT-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-delete-surface-hako-parity-pilot; hako_implementation_landed = 1; hako_source_verifies = 1; parity_gate_required = 1; write_direct_closeout_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-PARITY-GATE-001; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-PARITY-GATE-001 -> WRITE-DELETE-SURFACE-HAKO-ADOPTION-DECISION
