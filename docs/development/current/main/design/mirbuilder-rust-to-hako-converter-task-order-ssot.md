...
latest design decision:
  LoopCondContinueBreakPresentRejectV1 /
  LoopCondContinueBreakPresentRejectTokenSnapshotV1 is now a one-shape Rust
  ...
  shape only if it reduces a Rust ASTNode projection slice or exposes a concrete
  missing HHako traversal capability.
