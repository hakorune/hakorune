...
next active:
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-SURFACE-POST-PUSH-ADOPTION-RERUN-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-surface-post-push-adoption-rerun; hako_adopted_write_subsurface_count = 1; selected_write_subsurface=PushSurfacePolicy; write_direct_closeout_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-TYPED-DIRECT-CLOSEOUT-CONTRACT-BASIS-001; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-TYPED-DIRECT-CLOSEOUT-CONTRACT-BASIS-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-push-surface-typed-direct-closeout-contract-basis; write_push_surface_typed_direct_closeout_contract_basis = 1; direct_contract_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-DIRECT-CLOSEOUT-RERUN-001; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-REMAINING-SUBSURFACE-POST-PUSH-CLOSEOUT-RERUN-001 -> DELETE-OR-SET-HAKO-PILOT-OR-DESIGN-STOP
