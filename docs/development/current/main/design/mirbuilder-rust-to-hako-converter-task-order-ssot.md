...
next active:
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-SET-MAPSTORE-ANY-HAKO-PARITY-PILOT-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-set-mapstore-any-hako-parity-pilot; hako_implementation_landed = 1; any_write_boundary_declared = 1; any_write_boundary_opened = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-SET-MAPSTORE-ANY-PARITY-GATE-001; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-SET-MAPSTORE-ANY-POST-ADOPTION-RERUN-001 -> WRITE-SET-MAPSTORE-ANY-DIRECT-CLOSEOUT-BASIS
