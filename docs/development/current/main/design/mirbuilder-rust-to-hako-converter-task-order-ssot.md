...
latest design decision:
  3008 lands real `.hako` ProgramJsonLocalBindingShapeScanV1 traversal for
  covered Local.expr ProgramJSON structure, producing LocalBindingShapeSnapshotV1
  with an 8-row AOT parity gate. 3009 is active to mark only those covered rows
