...
next active:
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-RUST-ORACLE-PARITY-FIXTURE-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-push-surface-rust-oracle; write_push_surface_hako_implementation_candidate = 1; rust_oracle_fixture_defined = 1; next_hako_parity_pilot_selected = 1; write_direct_closeout_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-HAKO-PARITY-PILOT-001; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-HAKO-PARITY-PILOT-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-push-surface-hako-parity-pilot; hako_implementation_landed = 1; hako_source_verifies = 1; parity_gate_required = 1; write_direct_closeout_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-PARITY-GATE-001; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-PARITY-GATE-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-push-surface-parity-gate-v0; parity_rows = 1; parity_status = green; write_direct_closeout_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-HAKO-ADOPTION-DECISION-001; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-HAKO-ADOPTION-DECISION-001 -> WRITE-PUSH-SURFACE-DIRECT-CLOSEOUT-OR-WRITE-SURFACE-RERUN
