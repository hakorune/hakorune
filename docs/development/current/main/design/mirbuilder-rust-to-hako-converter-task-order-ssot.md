...
next active:
  ...
  MIRBUILDER-SCALAR-KNOWN-FASTPATH-HAKO-GENERATED-TYPED-ARTIFACT-SHADOW-CONSUME-SET-MAPSTORE-I64-001; status=active-next; scope=replace include_str/split shadow parsing with checked-in generated typed `.hako` artifact for SetSurfacePolicy/MapStoreI64; rust_authority_retained = 1; hako_runtime_route_authority = 0; source_selfhost_claim = 0
...
next_documented_task = MIRBUILDER-SCALAR-KNOWN-FASTPATH-HAKO-GENERATED-TYPED-ARTIFACT-SHADOW-CONSUME-SET-MAPSTORE-I64-001
next_after_active_3 = MIRBUILDER-SCALAR-KNOWN-FASTPATH-HAKO-GENERATED-TYPED-ARTIFACT-SHADOW-CONSUME-SET-MAPSTORE-I64-001
