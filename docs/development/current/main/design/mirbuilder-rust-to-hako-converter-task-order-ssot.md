...
current implementation task:
  MIRBUILDER-ARRAY-TEXT-OBSERVER-KIND-FORMATTER-HAKO-ADOPTION-DECISION-001.
  The array_text_observer_kind_formatter owner is HakoAdopted as the
  eighty-fourth narrow Rust-oracle parity pilot; next is rerun 085.
...
latest design decision:
  array_text_observer_kind_formatter is now HakoAdopted as a narrow
