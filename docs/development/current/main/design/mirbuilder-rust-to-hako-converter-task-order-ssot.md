...
next active:
  MIRBUILDER-COMPARE-RUNTIME-ROUTE-AUTHORITY-DESIGN-STOP-001; status=design-stop; output_contract=rust-lifecycle-mirbuilder-compare-runtime-route-authority-design-stop-v0; selected_next_card=MIRBUILDER-PROGRAMJSON-RECIPEMATCHER-RUNTIME-ROUTE-ADJACENT-SHADOW-GUARD-001; compare_runtime_route_authority_design_stop = 1; runtime_adjacent_shadow_guard_selected = 1; direct_runtime_route_authority_switch = 0; route_selection = 0; runtime_route_switch = 0; programjson_runtime_route_authority = 0; source_selfhost_claim = 0
  MIRBUILDER-PROGRAMJSON-RECIPEMATCHER-RUNTIME-ROUTE-ADJACENT-SHADOW-GUARD-REFRESH-001; status=landed; output_contract=rust-lifecycle-mirbuilder-programjson-recipematcher-runtime-route-adjacent-shadow-guard-refresh-v0; selected_next_card=SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001; runtime_route_adjacent_shadow_guard_green = 1; runtime_authority=rust_astnode; programjson_runtime_route_authority = 0; runtime_route_switch = 0; route_selection = 0; source_selfhost_claim = 0
  SOURCE-SELFHOST-POST-RERUN004-CURRENT-REENTRY-INVENTORY-001; status=landed; output_contract=rust-lifecycle-source-selfhost-post-rerun004-current-reentry-inventory-v0; selected_next_card=SOURCE-SELFHOST-NATIVE-OWNER-CHECKPOINT-RERUN-002; basis_007_consumed_by_rerun_004 = 1; machine_derived_route_repair_replay = 0; route_selection = 0; runtime_route_switch = 0; programjson_runtime_route_authority = 0; source_selfhost_claim = 0
...
next_after_active_3 =
  SOURCE-SELFHOST-NATIVE-OWNER-CHECKPOINT-RERUN-002 -> MIRBUILDER-MISSING-PROJECTION-POLICY-CLUSTER-RESOLUTION-V4
