...
next active:
  ...
  MIRBUILDER-SCALAR-KNOWN-WRITE-DELETE-SURFACE-MIRROR-RETIRE-001; status=landed; output_contract=rust-lifecycle-mirbuilder-scalar-known-write-delete-surface-mirror-retire; delete_surface_hako_mirror_retired = 1; delete_surface_lifecycle_artifacts_deleted = 1; delete_surface_manifest_rows_removed = 1; rust_map_delete_route_preserved = 1; selected_next_card=MIRBUILDER-RECIPEITEM-CONDITION-SLOT-BOOL-RECIPE-SIDECAR-BRIDGE-CURRENT-GATE-001; source_selfhost_claim = 0
  MIRBUILDER-RECIPEITEM-CONDITION-SLOT-BOOL-RECIPE-SIDECAR-BRIDGE-CURRENT-GATE-001; status=landed; output_contract=rust-lifecycle-mirbuilder-recipeitem-condition-slot-bool-recipe-sidecar-bridge-current-gate; recipeitem_cond_recipe_sidecar_bridge_current_gate = 1; optional_cond_recipe_sidecar = 1; legacy_cond_facts_required = 1; recipe_item_attachment = 1; selected_next_card=MIRBUILDER-PROGRAMJSON-RECIPEITEM-COND-RECIPE-PRODUCER-WIRING-SELECTION-001; source_selfhost_claim = 0
