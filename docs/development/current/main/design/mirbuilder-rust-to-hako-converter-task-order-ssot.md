...
current implementation task:
  MIRBUILDER-ARRAY-TEXT-OBSERVER-EXECUTOR-PROOF-REGION-FORMATTER-HAKO-ADOPTION-DECISION-001.
  The array_text_observer_executor_proof_region_formatter owner is HakoAdopted
  as the eighty-fifth narrow Rust-oracle parity pilot; next is rerun 086.
...
latest design decision:
  array_text_observer_executor_proof_region_formatter is now HakoAdopted as a
