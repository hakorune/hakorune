...
next active:
  MIRBUILDER-MISSING-PROJECTION-POLICY-CLUSTER-RESOLUTION-V4; status=landed; output_contract=rust-lifecycle-mirbuilder-missing-projection-policy-cluster-resolution-v4; selected_next_card=MIRBUILDER-CARRIER-TYPE-TRANSPORT-POLICY-INVENTORY-RERUN-003; input_candidate_count = 1004; cluster_count = 78; selection_eligible_cluster_count = 0; type_transport_missing_cluster_count = 76; new_projection_policy_selected = 0; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-TRANSPORT-POLICY-INVENTORY-RERUN-003; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-transport-policy-inventory-rerun-003; selected_next_card=MIRBUILDER-CARRIER-TYPE-TRANSPORT-EVIDENCE-INVENTORY-RERUN-003; type_transport_missing_cluster_count = 76; type_transport_missing_item_count = 944; eligible_policy_lane_count = 4; manual_carrier_selection = 0; return_type_count_as_proof = 0; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-TRANSPORT-EVIDENCE-INVENTORY-RERUN-003; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-transport-evidence-inventory-rerun-003; selected_next_card=MIRBUILDER-CARRIER-TYPE-TRANSPORT-UNCLASSIFIED-EVIDENCE-RESOLUTION-002; input_candidate_count = 944; evidence_inventory_complete_count = 814; unclassified_evidence_count = 130; manual_carrier_selection = 0; return_type_count_as_proof = 0; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-TRANSPORT-UNCLASSIFIED-EVIDENCE-RESOLUTION-002 -> MIRBUILDER-DOMAIN-OBJECT-ID-TRANSPORT-POLICY-INVENTORY-RERUN-002
