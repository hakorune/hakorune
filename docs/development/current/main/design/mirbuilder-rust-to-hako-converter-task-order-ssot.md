...
latest design decision:
  3009 lands the covered LocalBindingShapeSnapshotV1 ProgramJSON traversal rows
  as a scoped Rust ASTNode projector retire-candidate. 3010 is active as the
