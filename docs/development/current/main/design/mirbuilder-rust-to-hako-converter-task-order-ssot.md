...
next active:
  MIRBUILDER-COMPARE-LOCALSSA-FINALIZE-COMPARE-BRIDGE-001; status=landed; output_contract=rust-lifecycle-mirbuilder-compare-localssa-finalize-compare-bridge-v0; prior=MIRBUILDER-COMPARE-LOCALSSA-FINALIZE-COMPARE-DESIGN-STOP-001 / rust-lifecycle-mirbuilder-compare-localssa-finalize-compare-design-stop-v0; selected_next_card=MIRBUILDER-COMPARE-MIR-COMPARE-EMISSION-BRIDGE-001; compare_localssa_finalize_compare_bridge = 1; localssa_finalize_compare_execution = 1; lhs_rhs_valueids_finalized = 1; same_block_literal_operands_finalize = 1; mir_cmp_emission = 0; branch_emission = 0; bool_result_type_publication = 0; source_selfhost_claim = 0; current_design_stop=SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001; output_contract=rust-lifecycle-source-selfhost-wider-route-selection-design-stop-v0; decision=KeepSourceSelfhostStopped; reason_token=NoEligibleNativeAdoptionCandidate; next_action=DesignConsultationRequired / MIRBUILDER-COMPARE-MIR-COMPARE-EMISSION-BRIDGE-001; resume_condition=ConsultationGatedWiderRouteSelectionOrMachineDerivedRouteRepair; machine_derived_route_repair_allowed = 1; manual_family_selection = 0; route_membership_alone_as_proof = 0; coverage_percentage_as_proof = 0; support_lane_projector_as_adoption_candidate = 0; runtime_fallback = 0; runtime_route_switch = 0; programjson_runtime_route_authority = 0; new_backend_route = 0; new_abi = 0; next=MIRBUILDER-COMPARE-MIR-COMPARE-EMISSION-BRIDGE-001; status=next; unit=mir-compare-emission-bridge; route/runtime authority=0
  MIRBUILDER-COMPARE-MIR-COMPARE-EMISSION-BRIDGE-001; status=landed; output_contract=rust-lifecycle-mirbuilder-compare-mir-compare-emission-bridge-v0; selected_next_card=MIRBUILDER-COMPARE-BRANCH-EMISSION-DESIGN-STOP-001; compare_mir_compare_emission_bridge = 1; mir_compare_emission = 1; compare_result_valueid_allocated = 1; bool_result_type_publication = 1; branch_emission = 0; branch_condition_consumption = 0; source_selfhost_claim = 0; route/runtime authority=0
  MIRBUILDER-COMPARE-BRANCH-EMISSION-DESIGN-STOP-001; status=design-stop; output_contract=rust-lifecycle-mirbuilder-compare-branch-emission-design-stop-v0; selected_next_card=MIRBUILDER-COMPARE-BRANCH-EMISSION-BRIDGE-001; compare_branch_emission_design_stop = 1; branch_emission_bridge_selected = 1; branch_emission_execution = 0; branch_condition_consumption = 0; source_selfhost_claim = 0; route/runtime authority=0
