...
next active:
  ...
  MIRBUILDER-CARRIER-TYPE-TRANSPORT-REMAINING-AXIS-COMPONENT-REQUIREMENT-RERUN-003; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-transport-remaining-axis-component-requirement-rerun-003; accepted_component_evidence_source_count = 1; root_component_requirement_count = 1; selected_component_requirement=ScalarKnownCloseoutAuthority; component_specific_card_selection = 1; concrete_carrier_type_axis_selection = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-TRANSPORT-CLOSEOUT-BASIS-001; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-TRANSPORT-CLOSEOUT-BASIS-001; status=next; expected_input=MIRBUILDER-CARRIER-TYPE-TRANSPORT-REMAINING-AXIS-COMPONENT-REQUIREMENT-RERUN-003; concrete_carrier_type_axis_selection = 0; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-TRANSPORT-CLOSEOUT-BASIS-001 -> CLOSEOUT-BASIS-ONLY
