...
next active:
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-PARITY-GATE-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-delete-surface-parity-gate-v0; parity_rows = 1; parity_status = green; hako_adopted_decision = 0; write_direct_closeout_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-HAKO-ADOPTION-DECISION-001; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-TYPED-DIRECT-CLOSEOUT-CONTRACT-BASIS-001 -> WRITE-DELETE-SURFACE-DIRECT-CLOSEOUT-RERUN
