...
latest design decision:
  3082 lands the covered ContextScopeShapeSnapshotV1 ProgramJSON traversal
  slice as a scoped Rust ASTNode projector retire-candidate. Next work returns
  to ProgramJSON capability-batch continuation. Selection-only ProgramJSON
  cards remain forbidden.
...
## Active Next 3
```text
1. MIRBUILDER-PROGRAMJSON-CONTEXT-SCOPE-SHAPE-SCAN-CAPABILITY-001
   status=landed; boundary=real `.hako` ProgramJSON ContextScope traversal

2. MIRBUILDER-PROGRAMJSON-CONTEXT-SCOPE-SHAPE-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001
