...
next active:
  ...
  MIRBUILDER-CARRIER-TYPE-TRANSPORT-COMPONENT-EVIDENCE-SOURCE-DISCOVERY-INVENTORY-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-transport-component-evidence-source-discovery-inventory; accepted_component_evidence_source_count = 0; component_authority_source_count = 0; component_specific_card_selection = 0; concrete_carrier_type_axis_selection = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-TRANSPORT-REMAINING-AXIS-COMPONENT-REQUIREMENT-RERUN-002; manual_axis_selection = 0; source_selfhost_claim = 0
