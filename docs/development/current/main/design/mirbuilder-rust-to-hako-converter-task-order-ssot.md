...
next active:
  ...
  MIRBUILDER-CARRIER-TYPE-TRANSPORT-UNCLASSIFIED-EVIDENCE-RESOLUTION-002; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-transport-unclassified-evidence-resolution-002; selected_next_card=MIRBUILDER-DOMAIN-OBJECT-ID-TRANSPORT-POLICY-INVENTORY-RERUN-002; unclassified_input_count = 130; resolved_axis_count = 6; DomainObjectOrIdTransportAxis = 116; manual_axis_selection = 0; return_type_count_as_proof = 0; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-DOMAIN-OBJECT-ID-UNRESOLVED-SUBAXIS-PRIORITY-RESOLUTION-001 -> SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001
