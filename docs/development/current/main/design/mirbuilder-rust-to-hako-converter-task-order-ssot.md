...
next active:
  ...
  MIRBUILDER-ARTIFACT-REACHABILITY-CLASSIFICATION-INVENTORY-001; status=landed; output_contract=rust-lifecycle-mirbuilder-artifact-reachability-classification-inventory; compare_proof_bridge_file_count = 6; compare_proof_bridge_production_connected = 0; hako_lib_compiler_reachable_count = 0; run_all_rust_lifecycle_guards_by_default = 0; selected_next_card=MIRBUILDER-CURRENT-ACTIVE-RUST-LIFECYCLE-GUARD-RESOLVER-001; source_selfhost_claim = 0
  ...
  MIRBUILDER-COMPARE-PROOF-BRIDGE-PARK-OR-CONNECT-DESIGN-STOP-001; status=design-stop; compare_proof_bridge_file_count = 6; compare_proof_bridge_total_lines = 974; compare_proof_bridge_production_connected = 0; options=delete|park_proof_only|connect_minimal_subset; selected_next_card=CONSULTATION_REQUIRED; source_selfhost_claim = 0
...
next_documented_task =
  CONSULTATION_REQUIRED_FOR_COMPARE_PROOF_BRIDGE_PARK_OR_CONNECT
