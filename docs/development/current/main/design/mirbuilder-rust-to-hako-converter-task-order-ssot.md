...
latest design decision:
  3092 lands the covered ExprUnaryShapeSnapshotV1 ProgramJSON traversal slice as
...
## Active Next 3
```text
1. MIRBUILDER-PROGRAMJSON-BOX-DECLARATION-SHAPE-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001
   status=landed; boundary=only the covered BoxDeclarationShapeSnapshotV1 rows

2. MIRBUILDER-PROGRAMJSON-EXPR-UNARY-SHAPE-SCAN-CAPABILITY-001
   status=landed; boundary=real `.hako` ProgramJSON Expr.expr Unary traversal

3. MIRBUILDER-PROGRAMJSON-EXPR-UNARY-SHAPE-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001
