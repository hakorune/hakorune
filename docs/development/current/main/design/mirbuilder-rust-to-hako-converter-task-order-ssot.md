...
## Active Next 3
```text
1. MIRBUILDER-PROGRAMJSON-RECIPEMATCHER-NESTED-LOOP-REJECT-BOUNDARY-001; status=landed; nested_loop_reject_boundary_green=1
2. MIRBUILDER-PROGRAMJSON-RECIPEMATCHER-REJECT-FLOOR-EXPANSION-SELECTION-001; status=landed; selected_next_axis=unsupported_condition_operator
3. MIRBUILDER-PROGRAMJSON-RECIPEMATCHER-UNSUPPORTED-CONDITION-OPERATOR-REJECT-ROW-001; status=landed; snapshot_reason=unsupported_loop_cond; matcher_reason=snapshot_not_ok

next active:
  MIRBUILDER-PROGRAMJSON-RECIPEMATCHER-REJECT-FLOOR-UPDATE-AXIS-SELECTION-001; status=next; unit=reject floor update-axis selection; runtime_authority=rust_astnode; programjson_runtime_route_authority=0; runtime_route_switch=0
