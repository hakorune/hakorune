...
current implementation task:
  MIRBUILDER-HAKO-NATIVE-OWNER-PARITY-PILOT-SELECTION-RERUN-154.
  The fastmem_llvm_open_memop_kind_classifier owner is selected as the
  one-hundred-fifty-first narrow Rust-oracle parity pilot after the green
  6-row `.hako` EXE parity gate; next is its Rust-oracle fixture.
...
latest design decision:
  fastmem_free_list_memop_kind_classifier is now HakoAdopted as a narrow
