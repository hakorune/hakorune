...
latest design decision:
  3025 lands real `.hako` ProgramJsonExprLogicalShapeScanV1 traversal for
  covered Expr statement Logical ProgramJSON structure with a 9-row AOT parity
  gate. 3026 is active to mark only the covered ExprLogicalShapeSnapshotV1 rows
...
## Active Next 3
```text
1. MIRBUILDER-PROGRAMJSON-EXPR-LOGICAL-SHAPE-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001
   status=active; boundary=covered ExprLogicalShapeSnapshotV1 rows only
