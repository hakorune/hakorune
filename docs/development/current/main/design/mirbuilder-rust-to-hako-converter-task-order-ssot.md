...
latest design decision:
  3014 lands real `.hako` ProgramJsonExprNewShapeScanV1 traversal for covered
  Expr statement New ProgramJSON structure, producing ExprNewShapeSnapshotV1
  with a 9-row AOT parity gate. 3015 is active to mark only those covered rows
...
## Active Next 3
```text
1. MIRBUILDER-PROGRAMJSON-EXPR-NEW-SHAPE-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001
   status=active; boundary=covered ProgramJSON Expr.expr New shape rows only
