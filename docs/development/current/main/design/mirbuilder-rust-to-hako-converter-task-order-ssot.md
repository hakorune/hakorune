...
current implementation task:
  ...
  The basic_block_empty_classifier owner is HakoAdopted as the one-hundred-
  seventh narrow Rust-oracle parity pilot after the green 4-row `.hako` EXE
  parity gate; next is rerun 109.
...
latest design decision:
  basic_block_empty_classifier is now HakoAdopted as a narrow Rust-oracle
  ...
  selected next card is `MIRBUILDER-HAKO-NATIVE-OWNER-PARITY-PILOT-SELECTION-RERUN-109`.
