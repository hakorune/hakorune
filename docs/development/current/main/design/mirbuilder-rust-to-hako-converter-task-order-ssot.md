...
next active:
  ...
  MIRBUILDER-RECIPEITEM-CONDITION-SLOT-BOOL-RECIPE-BRIDGE-SELECTION-CURRENT-001; status=landed; output_contract=rust-lifecycle-mirbuilder-recipeitem-condition-slot-bool-recipe-bridge-selection-current; selected_bridge=OptionalCondRecipeSidecar; legacy_cond_facts_required = 1; cond_recipe_optional = 1; current_wrapper = 1; selected_next_card=MIRBUILDER-RECIPEITEM-CONDITION-SLOT-BOOL-RECIPE-SIDECAR-BRIDGE-CURRENT-GATE-001; source_selfhost_claim = 0
