...
next active:
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-HAKO-ADOPTION-DECISION-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-delete-surface-hako-adoption-decision; decision=Adopt; write_delete_surface_hako_adopted = 1; write_direct_closeout_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-REMAINING-SUBSURFACE-POST-DELETE-ADOPTION-RERUN-001; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-DIRECT-CLOSEOUT-RERUN-001 -> WRITE-REMAINING-SUBSURFACE-POST-DELETE-CLOSEOUT-RERUN
