...
next active:
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-TRANSPORT-CLOSEOUT-RERUN-001; status=design-stop; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-transport-closeout-rerun; scoped_map_load_scalar_i64_closeout = 1; scalar_known_transport_axis_closeout = 0; uncovered_scalar_known_surface_count = 3; decision=KeepScopedCloseout; selected_next_card=SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001; consultation_required = 1; source_selfhost_claim = 0
  ...
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-UNCOVERED-SURFACE-CLASSIFICATION-RERUN-001; status=next; expected_input=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-UNCOVERED-SURFACE-CLASSIFICATION-BASIS-001; choose exactly-one narrow typed direct closeout contract or keep stopped
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-UNCOVERED-SURFACE-CLASSIFICATION-RERUN-001 -> EXACTLY-ONE-CONTRACT-OR-KEEP-STOPPED
