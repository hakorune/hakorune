...
next active:
  ...
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-REMAINING-SUBSURFACE-POST-DELETE-CLOSEOUT-RERUN-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-remaining-subsurface-post-delete-closeout-rerun; decision=KeepStopped; remaining_write_subsurface_count = 1; remaining_subsurfaces=SetSurfacePolicy; recommended_consultation_topic=WriteSetSurfacePolicyPilotOrSplitSelection; selected_next_card=SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001; source_selfhost_claim = 0
...
next_after_active_3 =
  SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001 -> consultation topic WriteSetSurfacePolicyPilotOrSplitSelection
