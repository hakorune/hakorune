...
next active:
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-HAKO-ADOPTION-DECISION-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-push-surface-hako-adoption-decision; decision=Adopt; write_push_surface_hako_adopted = 1; write_direct_closeout_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-SURFACE-POST-PUSH-ADOPTION-RERUN-001; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-DIRECT-CLOSEOUT-RERUN-001 -> WRITE-REMAINING-SUBSURFACE-RERUN-OR-DESIGN-STOP
