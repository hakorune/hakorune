...
next active:
  ...
  MIRBUILDER-DOMAIN-OBJECT-ID-SEMANTIC-RESOURCE-DOMAIN-DECLARATION-INVENTORY-001; status=landed; output_contract=rust-lifecycle-mirbuilder-domain-object-id-lane-guard; guard_profile=semantic_resource_domain_declaration_inventory; explicit_semantic_resource_domain_declaration_source_count = 0; stable_closed_resource_manifest_count = 0; registry_ready_row_count = 0; accepted_typed_dependency_edge_count = 0; selected_next_card=SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-BASIS-008; manual_subaxis_selection = 0; source_selfhost_claim = 0
...
next_after_active_3 =
  SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-BASIS-008 -> MIRBUILDER-CARRIER-TYPE-TRANSPORT-REMAINING-AXIS-PRIORITY-BASIS-001
