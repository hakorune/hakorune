...
next active:
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-PUSH-SURFACE-DIRECT-CLOSEOUT-RERUN-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-push-surface-direct-closeout-rerun; write_push_surface_direct_closeout_materialized = 1; accepted_scoped_closeout_count = 4; write_scalar_i64_routes_closeout = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-REMAINING-SUBSURFACE-POST-PUSH-CLOSEOUT-RERUN-001; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-REMAINING-SUBSURFACE-POST-PUSH-CLOSEOUT-RERUN-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-remaining-subsurface-post-push-closeout-rerun; decision=KeepStopped; remaining_write_subsurface_count = 2; hako_adopted_remaining_write_subsurface_count = 0; selected_next_card=SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001; recommended_consultation_topic=WriteRemainingSubsurfaceHakoPilotSelection; source_selfhost_claim = 0
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-RUST-ORACLE-PARITY-FIXTURE-001; status=landed; output_contract=rust-lifecycle-mirbuilder-carrier-type-scalar-known-write-delete-surface-rust-oracle; prior_hako_adopted_write_subsurface_minimal_semantic_delta = 1; none_publication_metadata_declared = 1; write_direct_closeout_materialized = 0; selected_next_card=MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-HAKO-PARITY-PILOT-001; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-CARRIER-TYPE-SCALAR-KNOWN-WRITE-DELETE-SURFACE-HAKO-PARITY-PILOT-001 -> WRITE-DELETE-SURFACE-PARITY-GATE
