...
next active:
  ...
  SOURCE-SELFHOST-NATIVE-OWNER-CHECKPOINT-RERUN-002; status=landed; output_contract=rust-lifecycle-source-selfhost-native-owner-checkpoint-rerun-002-v0; selected_next_card=MIRBUILDER-MISSING-PROJECTION-POLICY-CLUSTER-RESOLUTION-V4; native_owner_count = 12; selected_blocker_class=MissingProjectionPolicy; missing_projection_evidence_quality_count = 819; candidate_count_as_proof = 0; coverage_percentage_as_proof = 0; source_selfhost_claim = 0
...
next_after_active_3 =
  MIRBUILDER-MISSING-PROJECTION-POLICY-CLUSTER-RESOLUTION-V4 -> MIRBUILDER-CARRIER-TYPE-TRANSPORT-POLICY-INVENTORY-RERUN-003
