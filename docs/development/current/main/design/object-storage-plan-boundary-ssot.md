...
ObjectStoragePlan:
  ...
  decides generic Box / HostHandle / ArcDynBox / exact native struct /
  scalarized fields / flattened nested fields
...
Backend / exact-AOT lowering:
  emits direct calls, direct fields, native structs, scalar fields, or runtime
