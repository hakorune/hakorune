...
| `MIM-FMEM-018 thread-exit / abandoned owner lifecycle` | next | Define thread-exit flush, abandoned owner mark, reclaim, and generation bump state machine. | Arena reuse cannot silently reuse stale owner identity. |
