...
| `LLVM-PIPE-002 LLVM runner pipeline report fields` | next | Add explicit pipeline report fields for future rewrite route, JoinIR experiment, method-id mutation count, backend executor, and fallback reason. | Report-only; no route change. |
