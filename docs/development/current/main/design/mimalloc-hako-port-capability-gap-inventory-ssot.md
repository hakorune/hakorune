...
| `MIR-FMEM-006 producer-neutral parity against python_template_c_bridge` | next | Compare MIR-to-LLVM evidence with the current temporary bridge using the same report.kv / hako_check contract. | Parity is evidence-only; Python-template C remains bridge until this passes. |
