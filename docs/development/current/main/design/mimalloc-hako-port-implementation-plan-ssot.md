...
landed; after `MIMAP-061A` the active row is `MIMAP-062A`, a
post-reclaim-scalar-closeout row selection. It must not reopen
allocator-provider M104+, host replacement behavior, secure entropy execution,
thread scheduling, OSVM release, or page-source behavior.
