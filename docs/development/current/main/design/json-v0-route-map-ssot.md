...
| `tools/selfhost_exe_stageb.sh` with explicit `HAKORUNE_STAGE1_EMIT_ROUTE=stageb-delegate` | bridge compat capsule | keep until bridge replacement/archive coverage is complete |
