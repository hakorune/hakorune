...
| 311 | Hakorune language / allocator cleanup | `HAKO-ALLOC-USIZE-FIELD-GROUP-048 local-free reuse ledger release-apply shape/lookup reject counter closeout` | selected current |
