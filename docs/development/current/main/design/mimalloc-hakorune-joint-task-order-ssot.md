...
`MIMAP-246A` is current after MIMAP-245A landed the segment arena backing
no-escape address capability diagnostics.
...
```text
close out the no-escape address capability family with representative exact-MIR L3 evidence
...
| 224 | closeout | `MIMAP-246A segment arena backing no-escape address capability closeout pack` | selected current |
