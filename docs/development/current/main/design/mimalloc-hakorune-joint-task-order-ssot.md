...
| 316 | Hakorune compiler acceptance | `RECORD-VALUE-HELPER-001 local ReportFields helper argument scalarization` | landed; selected HAKO-ALLOC-REPORT-RECORD-008 |
| 317 | Hakorune language / allocator cleanup | `HAKO-ALLOC-REPORT-RECORD-008 post helper scalarization row selection` | selected current |
