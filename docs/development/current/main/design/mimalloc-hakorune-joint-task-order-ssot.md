...
`MIMAP-065A` landed the reclaim scheduler marker closeout guard and selected a
post-scheduler-marker row selection.
...
| 23 | planning | `MIMAP-066A post-scheduler-marker row selection` | current; choose one next row |
