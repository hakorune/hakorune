...
Remapper value discovery is now its child owner (189 lines); main601, unchanged
public owner/test paths. Touched Rust max757. Initial unavailable-cleanup test
stopped at unaccepted FINI syntax; replaced by real-source-row physical-state test, not source/EXE proof.
