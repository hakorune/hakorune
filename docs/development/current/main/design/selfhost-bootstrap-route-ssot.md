...
| --- | --- | --- | --- | --- | --- |
| `SH-GATE-STAGEB` | selfhost gate の Stage-B コンパイル | `tools/selfhost/proof/run_stageb_compiler_vm.sh --source-file <fixture>` | fixture source (`HAKO_SRC`) | Program(JSON v0) line on stdout | `tools/selfhost/run.sh --gate --planner-required 1` |
