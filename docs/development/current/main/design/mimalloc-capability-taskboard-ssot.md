...
| `M34 pointer atomic vocabulary docs lock` | `next-card` | capability substrate + docs | waits for M33; reserves pointer atomic vocabulary without lowering production remote-free policy |
