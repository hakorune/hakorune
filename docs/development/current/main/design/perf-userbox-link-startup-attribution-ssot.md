...
| `PERF-USERBOX-049` | startup executable ret0 nyash_kernel_runtime registry rebuild-cache/create-default-registry presence probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_nyash_kernel_runtime_registry_rebuild_cache_create_default_registry_presence_guard.sh` | the startup report now packages repeated nyash_kernel_runtime registry rebuild-cache/create-default-registry evidence so the probe can keep rebuild-cache dominant while recording the create-default-registry presence signals | default link mode, exact-AOT runtime surface, exact helper lowering |
| `PERF-USERBOX-050` | startup executable ret0 nyash_kernel_runtime registry rebuild-cache/ring0 presence probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_nyash_kernel_runtime_registry_rebuild_cache_ring0_presence_guard.sh` | the startup report now packages repeated nyash_kernel_runtime registry rebuild-cache/ring0 evidence so the probe can keep rebuild-cache dominant while recording the ring0 presence signals | default link mode, exact-AOT runtime surface, exact helper lowering |
| `PERF-USERBOX-051` | startup executable ret0 nyash_kernel_runtime registry rebuild-cache/global_hooks presence probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_nyash_kernel_runtime_registry_rebuild_cache_global_hooks_presence_guard.sh` | the startup report now packages repeated nyash_kernel_runtime registry rebuild-cache/global_hooks evidence so the probe can keep rebuild-cache dominant while recording the global_hooks presence signals | default link mode, exact-AOT runtime surface, exact helper lowering |
| `PERF-USERBOX-052` | startup executable ret0 nyash_kernel_runtime registry rebuild-cache/global_hooks set_from_runtime exact-top-symbol presence probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_nyash_kernel_runtime_registry_rebuild_cache_global_hooks_set_from_runtime_exact_top_symbol_presence_guard.sh` | the startup report now packages repeated nyash_kernel_runtime registry rebuild-cache/global_hooks exact top symbols so the probe can keep rebuild-cache dominant while confirming the exact `global_hooks::set_from_runtime` signal | default link mode, exact-AOT runtime surface, exact helper lowering |
| `PERF-USERBOX-053` | startup executable ret0 nyash_kernel_runtime registry rebuild-cache/ring0 build_with_fs exact-top-symbol presence probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_nyash_kernel_runtime_registry_rebuild_cache_ring0_build_with_fs_exact_top_symbol_presence_guard.sh` | the startup report now packages repeated nyash_kernel_runtime registry rebuild-cache/ring0 exact top symbols so the probe can keep rebuild-cache dominant while confirming the exact `Ring0Registry::build_with_fs` signal | default link mode, exact-AOT runtime surface, exact helper lowering |
| `PERF-USERBOX-054` | startup executable ret0 nyash_kernel_runtime registry rebuild-cache/get_factory_order_by_policy exact-top-symbol absence probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_nyash_kernel_runtime_registry_rebuild_cache_get_factory_order_by_policy_exact_top_symbol_absence_guard.sh` | the startup report now packages repeated nyash_kernel_runtime registry rebuild-cache exact top symbols so the probe can keep rebuild-cache dominant while confirming that `get_factory_order_by_policy` stays absent as an exact top symbol | default link mode, exact-AOT runtime surface, exact helper lowering |
| `PERF-USERBOX-056` | startup executable ret0 libc_process exact-top-symbol variability probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_libc_process_exact_top_symbol_variability_guard.sh` | the startup report now packages repeated libc_process exact top symbols so the libc_process owner family can be read as a variability distribution instead of a single snapshot | default link mode, exact-AOT runtime surface, exact helper lowering |
| `PERF-USERBOX-057` | startup executable ret0 libc_process malloc/getenv exact-top-symbol split probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_libc_process_malloc_getenv_exact_top_symbol_dominance_guard.sh` | the startup report now packages repeated libc_process malloc/getenv exact top symbols so the libc_process owner family can be split into malloc versus getenv evidence before choosing the next owner | default link mode, exact-AOT runtime surface, exact helper lowering |
...
| `PERF-USERBOX-062` | startup executable ret0 libc_process env-string scan distribution probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_libc_process_env_string_scan_distribution_guard.sh` | the startup report now packages getenv, strlen/strncmp, and allocator buckets so env-string scanning can be read beside allocator cost before choosing the next owner | default link mode, exact-AOT runtime surface, exact helper lowering |
| `PERF-USERBOX-063` | startup executable ret0 libc_process env ladder probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_libc_process_env_ladder_guard.sh` | the startup report now compares inherited, required-only, and many-dummy env variants so env sensitivity can be read before choosing the next owner | default link mode, exact-AOT runtime surface, exact helper lowering |
| `PERF-USERBOX-064` | startup executable ret0 libc_process callgraph attribution probe | `k2_wide_phase296x_perf_userbox_startup_executable_ret0_bucket_libc_process_callgraph_attribution_guard.sh` | the startup report now classifies getenv, string-scan, memmove, and malloc caller owners as NyRT entry, C-ABI shim, loader/libc, or unknown before choosing the next owner | default link mode, exact-AOT runtime surface, exact helper lowering |
...
rebuild-cache-dominant report before choosing the next registry sub-owner.
`PERF-USERBOX-049` then records whether create-default-registry remains present
under the rebuild-cache-dominant report before choosing the next registry
sub-owner.
`PERF-USERBOX-050` then records whether ring0 remains present under the
rebuild-cache-dominant report before choosing the next registry sub-owner.
`PERF-USERBOX-051` then records whether `global_hooks::set_from_runtime` remains
present under the rebuild-cache-dominant report before choosing the next
registry sub-owner.
`PERF-USERBOX-052` then records whether `global_hooks::set_from_runtime`
remains present as its own exact top-symbol signal under the rebuild-cache-
dominant report before choosing the next registry sub-owner.
`PERF-USERBOX-053` then records whether `Ring0Registry::build_with_fs`
remains present as its own exact top-symbol signal under the rebuild-cache-
dominant report before choosing the next registry sub-owner.
`PERF-USERBOX-054` then records whether `get_factory_order_by_policy` remains
absent as its own exact top-symbol signal under the rebuild-cache-dominant
report before choosing the next registry sub-owner.
`PERF-USERBOX-056` then records the libc_process exact-top-symbol variability
distribution under the exact-AOT startup report before choosing the next
owner. `PERF-USERBOX-057` then records the libc_process malloc/getenv split
