...
The next owner is the ret0.exe env top-symbol family distribution inside the
startup executable contribution as one owner, not separate stdio / registry
work.

`PERF-USERBOX-022` is the required next probe:
...
bucket_env_exact_symbol_mode=...
bucket_env_exact_symbol_mode_count=...
bucket_env_family_mode=...
bucket_env_family_mode_count=...
bucket_env_family_var_os_count=...
bucket_env_family_getenv_count=...
bucket_env_family_current_exe_count=...
bucket_env_family_current_dir_count=...
bucket_env_family_other_count=...
...
If the env top-symbol family distribution still carries meaningful executable
contribution, keep splitting inside the startup executable owner. If it goes
flat, stay on the loader/libc floor and do not reopen stdio / registry work.
