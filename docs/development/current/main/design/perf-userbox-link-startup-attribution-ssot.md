...
The next owner is the ret0.exe bucket top-symbol variability distribution
inside the startup executable contribution as one owner, not separate env /
stdio / registry work.

`PERF-USERBOX-021` is the required next probe:
...
ret0_top_count_min=...
ret0_top_count_max=...
bucket_env_top_symbol_present_count=...
bucket_once_top_symbol_present_count=...
bucket_path_top_symbol_present_count=...
bucket_minimal_main_top_symbol_present_count=...
bucket_nyash_kernel_runtime_top_symbol_present_count=...
bucket_env_top_symbol_mode=...
bucket_env_top_symbol_mode_count=...
bucket_once_top_symbol_mode=...
bucket_once_top_symbol_mode_count=...
bucket_path_top_symbol_mode=...
bucket_path_top_symbol_mode_count=...
bucket_minimal_main_top_symbol_mode=...
bucket_minimal_main_top_symbol_mode_count=...
bucket_nyash_kernel_runtime_top_symbol_mode=...
bucket_nyash_kernel_runtime_top_symbol_mode_count=...
...
If the ret0.exe bucket top-symbol distribution still carries meaningful
executable contribution, keep splitting inside the startup executable owner.
If it goes flat, stay on the loader/libc floor and do not reopen env / stdio /
registry work.
