...
exact top symbols inside that owner, and `PERF-USERBOX-040` now captures the
registry rebuild-cache scheduler exact top symbols inside that owner. Keep the
