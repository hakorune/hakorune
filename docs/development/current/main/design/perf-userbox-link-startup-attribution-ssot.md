...
The next owner is the ret0.exe bucket subkind variability distribution inside
the startup executable contribution as one owner, not separate env / stdio /
registry work.

`PERF-USERBOX-020` is the required next probe:
...
ret0_top_count_min=...
ret0_top_count_max=...
bucket_env_present_count=...
bucket_once_present_count=...
bucket_path_present_count=...
bucket_minimal_main_present_count=...
bucket_nyash_kernel_runtime_present_count=...
bucket_env_subkind_mode=...
bucket_env_subkind_mode_count=...
bucket_once_subkind_mode=...
bucket_once_subkind_mode_count=...
bucket_path_subkind_mode=...
bucket_path_subkind_mode_count=...
bucket_minimal_main_subkind_mode=...
bucket_minimal_main_subkind_mode_count=...
bucket_nyash_kernel_runtime_subkind_mode=...
bucket_nyash_kernel_runtime_subkind_mode_count=...
...
If the ret0.exe bucket subkind distribution still carries meaningful
