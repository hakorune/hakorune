...
- Kernel replacement axis（`K0 / K1 / K2(core|wide)` replacement progress / `stage` build-distribution axis とは別管理）: `docs/development/current/main/design/kernel-replacement-axis-ssot.md`
