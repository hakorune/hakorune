...
- B′ Box lifecycle / ObjectCell / adaptive ownership（explicit eager fini、Ownership SSA token、generation identity、atomic SharedRc baseline、family/global retirementの最終境界SSOT）: `docs/development/current/main/design/box-lifecycle-bprime-tombstone-adaptive-ownership-ssot.md`
