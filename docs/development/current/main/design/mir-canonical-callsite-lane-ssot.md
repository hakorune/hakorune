...
is the current fast row: one Store/FieldSet publication writer delegates its
existing PublicationWriteBoundaryPlan to `MirInstruction::call`; only its
focused proof and shared guard may change in this cell.
