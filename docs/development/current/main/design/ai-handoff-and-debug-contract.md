...
- Program(JSON v0) import-bundle trace (dev/diagnostic only, `NYASH_JSON_V0_IMPORT_TRACE=1`): `[json_v0/import_bundle] phase=<enter|skip|guard.set|restore|merge.begin|merge.done|fail> ...`
