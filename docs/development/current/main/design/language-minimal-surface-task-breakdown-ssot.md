...
| Language v1 convergence | Constitution and Semantic Kernel complete through 3459 | `LANGV1-GRAMMAR-DESIGN-STOP-001` |
...
`LANGV1-GRAMMAR-DESIGN-STOP-001`; the accepted kernel decision and completed
evaluated-Place slice are normative in `docs/reference/language/semantic-kernel.md`.
