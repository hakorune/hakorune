...
1. mainline:
  ...
  - recipe seam close-sync, `W2a..W2c`, `W3a..W3c`, and `W4a..W4c` are now landed; the pre-perf runway is closed and `P8-PERF-REOPEN-JUDGMENT.md` has landed `no reopen now`
  - the next adjacent front is `P9-METHOD-CALL-ONLY-PERF-ENTRY-INVENTORY.md`, not further recipe widening and not immediate `kilo` retune
