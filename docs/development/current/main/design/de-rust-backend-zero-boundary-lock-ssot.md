...
1. mainline:
   ...
   - recipe seam close-sync, `W2a..W2c`, and `W3a..W3c` are now landed; the current exact backend-zero front is `W4` `llvmlite` demotion completion, not further recipe widening
