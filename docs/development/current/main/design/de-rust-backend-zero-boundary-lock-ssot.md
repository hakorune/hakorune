...
1. mainline:
  ...
  - `P9-METHOD-CALL-ONLY-PERF-ENTRY-INVENTORY.md` is closed, `P10-SMALL-PERF-REENTRY-TASK-PACK.md` is now closed as pure-loop small-entry evidence, and the next adjacent front is `P11-SMALL-ENTRY-STARTUP-INVENTORY.md`
