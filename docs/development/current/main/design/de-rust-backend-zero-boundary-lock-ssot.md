...
1. mainline:
   ...
   - recipe seam close-sync, `W2a..W2c`, `W3a..W3c`, and `W4a..W4c` are now landed; the pre-perf runway is closed and the next adjacent front is `perf/kilo` reopen judgment, not further recipe widening
