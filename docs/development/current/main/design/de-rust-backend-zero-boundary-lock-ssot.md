...
1. mainline:
   ...
   - recipe seam close-sync, `W2a..W2c`, and `W3a` are now landed; the current exact backend-zero front is `W3b` `boundary_driver*.rs` thin-floor, not further recipe widening
