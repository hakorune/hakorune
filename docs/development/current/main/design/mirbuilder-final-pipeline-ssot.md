...
- **Next ordered task:** land `CORE-DIRECT-SUBSTRING-PRODUCT-AOT-S0`, then close
  the amended one-state CoreDirect R0, force-hv1 caller migration, and strict
  Value seams before opening the shared-runner Wpre-I0.
