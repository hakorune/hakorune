...
|---|---|---|---|---|
| Route判定 | ループ形を分類し、どの recipe/composer 経路に渡すか決める | [`src/mir/builder/control_flow/joinir/patterns/router.rs`](../../../../../src/mir/builder/control_flow/joinir/patterns/router.rs)（legacy physical path / active role: route-entry router）, [`src/mir/builder/control_flow/joinir/patterns/registry/mod.rs`](../../../../../src/mir/builder/control_flow/joinir/patterns/registry/mod.rs)（legacy physical path / active role: route-entry registry）, [`src/mir/builder/control_flow/plan/ast_feature_extractor.rs`](../../../../../src/mir/builder/control_flow/plan/ast_feature_extractor.rs), [`src/mir/builder/control_flow/plan/policies/`](../../../../../src/mir/builder/control_flow/plan/policies/), [`src/mir/loop_pattern_detection/mod.rs`](../../../../../src/mir/loop_pattern_detection/mod.rs) | `LoopRouteKind` / route hint / recipe entry | 「分類不能」→ 明示的に Err（サイレントな非JoinIR退避は禁止） |
| route contract / verifier | 「この route なら lower/merge 契約が成立する」を保証する | [`src/mir/builder/control_flow/plan/verifier/mod.rs`](../../../../../src/mir/builder/control_flow/plan/verifier/mod.rs), [`src/mir/builder/control_flow/plan/composer/coreloop_gates.rs`](../../../../../src/mir/builder/control_flow/plan/composer/coreloop_gates.rs), [`src/mir/builder/control_flow/joinir/patterns/registry/predicates.rs`](../../../../../src/mir/builder/control_flow/joinir/patterns/registry/predicates.rs)（legacy physical path / active role: route predicate registry） | verified route contract / 詳細診断 | 契約不一致を握りつぶさず Err |
...
- Route router（テーブル駆動 / legacy physical path）: [`src/mir/builder/control_flow/joinir/patterns/router.rs`](../../../../../src/mir/builder/control_flow/joinir/patterns/router.rs)
- registry（recipe-first entry / legacy physical path）: [`src/mir/builder/control_flow/joinir/patterns/registry/mod.rs`](../../../../../src/mir/builder/control_flow/joinir/patterns/registry/mod.rs)
