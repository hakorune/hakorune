...
|---|---|---|---|---|
| Route判定 | ループ形を分類し、どの recipe/composer 経路に渡すか決める | active module surface `crate::mir::builder::control_flow::joinir::route_entry::router`（legacy physical path: [`src/mir/builder/control_flow/joinir/patterns/router.rs`](../../../../../src/mir/builder/control_flow/joinir/patterns/router.rs)）, active module surface `crate::mir::builder::control_flow::joinir::route_entry::registry`（legacy physical path: [`src/mir/builder/control_flow/joinir/patterns/registry/mod.rs`](../../../../../src/mir/builder/control_flow/joinir/patterns/registry/mod.rs)）, [`src/mir/builder/control_flow/plan/ast_feature_extractor.rs`](../../../../../src/mir/builder/control_flow/plan/ast_feature_extractor.rs), [`src/mir/builder/control_flow/plan/policies/`](../../../../../src/mir/builder/control_flow/plan/policies/), active module surface `crate::mir::loop_route_detection`（legacy physical path: [`src/mir/loop_pattern_detection/mod.rs`](../../../../../src/mir/loop_pattern_detection/mod.rs)） | `LoopRouteKind` / route hint / recipe entry | 「分類不能」→ 明示的に Err（サイレントな非JoinIR退避は禁止） |
| route contract / verifier | 「この route なら lower/merge 契約が成立する」を保証する | [`src/mir/builder/control_flow/plan/verifier/mod.rs`](../../../../../src/mir/builder/control_flow/plan/verifier/mod.rs), [`src/mir/builder/control_flow/plan/composer/coreloop_gates.rs`](../../../../../src/mir/builder/control_flow/plan/composer/coreloop_gates.rs), active module surface `crate::mir::builder::control_flow::joinir::route_entry::registry::predicates`（legacy physical path: [`src/mir/builder/control_flow/joinir/patterns/registry/predicates.rs`](../../../../../src/mir/builder/control_flow/joinir/patterns/registry/predicates.rs)） | verified route contract / 詳細診断 | 契約不一致を握りつぶさず Err |
...
- Route router（active module surface `joinir::route_entry::router`, legacy physical path）: [`src/mir/builder/control_flow/joinir/patterns/router.rs`](../../../../../src/mir/builder/control_flow/joinir/patterns/router.rs)
- registry（active module surface `joinir::route_entry::registry`, legacy physical path）: [`src/mir/builder/control_flow/joinir/patterns/registry/mod.rs`](../../../../../src/mir/builder/control_flow/joinir/patterns/registry/mod.rs)
...
2. Route/feature を追加（検出）
   ...
   - active module surface `crate::mir::loop_route_detection`（legacy physical path: `src/mir/loop_pattern_detection/`。分類/補助解析が必要ならここに追加）
