...
Acceptance target: natural three-owner source with distinct actuals reaches direct EXE and linked OBJ exit30, while per-owner Fault probes show later calls are skipped and owner/site/duplicate/finishing drift rejects before artifact. The repeated-target fourth-Call negative and grouped duplicate/order/foreign/omission mutation tests are closed; three-owner Fault-order observation remains open.
