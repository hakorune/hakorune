...
- exact-front optimization and representation rows remain governed by
  ...
  `LOCALFIRSTOBJECTPLAN-ALIAS-RETIRE-PREFLIGHT-001`, and the next blocker is
...
2. `docs/development/current/main/phases/phase-296x/296x-992-LOCALFIRSTOBJECTPLAN-ALIAS-RETIRE-PREFLIGHT-001.md`
