...
- priority: read the exact row from `current_blocker_token`. CAT0 through G0,
  ...
  `DX0a -> DX0b -> S0 -> V0 -> census evidence -> I1`; DX0a is closed with
  generalized production callers zero. DX0b is the exact current blocker and
  moves capability installation to once per calling function without widening
