...
- current lane:
  ...
  - current implementation focus: MapBox bad-key normalization decision
  - current phase goal:
    ...
    - next row decides MapBox bad-key normalization as a separate contract card
  ...
  - current blocker token: `MapBox bad-key normalization decision`
  - execution mode:
