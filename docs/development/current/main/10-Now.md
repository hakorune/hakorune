...
- exact-front optimization and representation rows remain governed by
  ...
  `OBJECT-SITE-LOCATION-VOCABULARY-001`, and the next blocker is
  `OBJECT-SITE-LOCATION-FIELD-MIGRATION-PREFLIGHT-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-996-OBJECT-SITE-LOCATION-VOCABULARY-001.md`
