...
- exact-front optimization and representation rows remain governed by
  ...
  `MIMALLOC-ARRAY-TEXT-LOOP-SESSION-BORROWED-TEXT-ACCESS-OWNER-INVENTORY-001`, and the next
  blocker is `MIMALLOC-ARRAY-TEXT-LOOP-SESSION-LENGTH-TABLE-IMPLEMENTATION-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-961-MIMALLOC-ARRAY-TEXT-LOOP-SESSION-BORROWED-TEXT-ACCESS-OWNER-INVENTORY-001.md`
