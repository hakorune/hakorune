...
- exact-front optimization and representation rows remain governed by
  ...
  `LOCAL-PUBLICATION-INVENTORY-LOCATION-FIELD-MIGRATION-001`, and the next blocker is
  `OBJECT-SITE-LOCATION-CLOSEOUT-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-1001-LOCAL-PUBLICATION-INVENTORY-LOCATION-FIELD-MIGRATION-001.md`
