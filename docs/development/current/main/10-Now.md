...
- current lane:
  ...
  - current implementation focus: MapBox write-return implementation
  - current phase goal:
    ...
    - MapBox write-return receipt contract is decided; next row implements it
      without mixing bad-key normalization
  ...
  - current blocker token: `MapBox write-return implementation`
  - execution mode:
