...
- current blocker token: `MIMAP-177A post-segment-map-local-free-apply-plan-bridge row selection`
- update policy:
  `docs/development/current/main/design/current-docs-update-policy-ssot.md`

## Next

- continue phase-293x with `MIMAP-177A`; current blocker is
  post-segment-map-local-free-apply-plan-bridge row selection
- latest allocator row: `MIMAP-176A` landed and selected MIMAP-177A
