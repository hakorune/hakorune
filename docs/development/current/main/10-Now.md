...
- exact-front optimization and representation rows remain governed by
  ...
  `LOCALFIRSTOBJECTPLAN-ALIAS-RETIRE-IMPLEMENTATION-001`, and the next blocker is
  `OBJECT-STORAGE-PLAN-NEXT-VOCAB-CANDIDATE-SELECTION-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-994-LOCALFIRSTOBJECTPLAN-ALIAS-RETIRE-IMPLEMENTATION-001.md`
