...
- exact-front optimization and representation rows remain governed by
  ...
  `FASTPATH-UNREACHABLE-CONSUMER-GUARD-001`, and the next blocker is
...
2. `docs/development/current/main/phases/phase-296x/296x-982-FASTPATH-UNREACHABLE-CONSUMER-GUARD-001.md`
