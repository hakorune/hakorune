...
- current implementation lane: `phase268x numeric loop / SIMD compare-select widening`
...
- top queued cut: `numeric loop / SIMD`
...
- `phase268x` is active:
  - compare/select widening is the current actual widening cut
