...
- next frontier: `ENTRY-RESULT-PROJECTION0-S2-FAULT-STATUS0`
  (S2 selected one disconnected VM-reference carrier; normalize the
  projection-owned fault status before issuing that carrier)
