...
- current lane:
  ...
  - current implementation focus: `successor cleanup card selection` (after 291x-112)
  - current phase goal:
  ...
  - current app gap read:
    - ArrayBox surface SSOT is landed for `length/size/len/get/set/push/pop/clear/slice/remove/insert`
