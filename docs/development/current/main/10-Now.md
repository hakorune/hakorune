...
- exact-front optimization and representation rows remain governed by
  ...
  `MIMALLOC-SUBSTRING-CONCAT-DEAD-TEXT-REGION-BACKEND-READER-SURFACE-001`, and
  the next blocker is
...
2. `docs/development/current/main/phases/phase-296x/296x-977-MIMALLOC-SUBSTRING-CONCAT-DEAD-TEXT-REGION-BACKEND-READER-SURFACE-001.md`
