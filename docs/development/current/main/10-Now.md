...
- exact-front optimization and representation rows remain governed by
  ...
  `FASTPATH-ROUTE-PRIORITY-TABLE-001`, and the next blocker is
...
2. `docs/development/current/main/phases/phase-296x/296x-983-FASTPATH-ROUTE-PRIORITY-TABLE-001.md`
