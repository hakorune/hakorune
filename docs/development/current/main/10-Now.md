...
- exact-front optimization and representation rows remain governed by
  ...
  `FASTPATH-REACHABILITY-LEDGER-001`, and the next blocker is
...
2. `docs/development/current/main/phases/phase-296x/296x-981-FASTPATH-REACHABILITY-LEDGER-001.md`
