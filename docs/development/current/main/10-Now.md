...
- exact-front optimization and representation rows remain governed by
  ...
  `MIMALLOC-MAP-MISSING-EMPTY-ROUTE-TRIGGER-PROBE-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-838-MIMALLOC-MAP-MISSING-EMPTY-ROUTE-TRIGGER-PROBE-001.md`
