...
- current loop frontier: common admission assembler S1 and the caller-zero
  ...
  caller-zero I0/R0 receipt are closed; the current design stop is
  `GENERIC-RAW-STRUCTURED-STATIC-CALL-RESULT-PUBLICATION-I1-D0` for
  whole-source activation and route-transaction rollback authority.
