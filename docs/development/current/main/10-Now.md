...
- prune `carrier_update_emitter/legacy.rs` by routing the remaining caller
  through `emit_carrier_update_with_env`
- cleanup checkpoint: latest known landed card `291x-393`; detailed closed
