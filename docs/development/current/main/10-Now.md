...
- Repo cleanup lane: `phase-29cr`（P0/P1 landed; P2 first slice landed: box arithmetic / box operators / runner plugin init relocation; fixed order は `root hygiene -> CURRENT_TASK slim -> src top-level cleanup -> src/mir navigation-first cleanup`）
