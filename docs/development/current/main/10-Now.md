...
- current blocker token: `MIMAP-040B post-selectPage-loop row selection`
- update policy:
  `docs/development/current/main/design/current-docs-update-policy-ssot.md`

## Next

- continue phase-293x after `MIMAP-040A`; current blocker is `MIMAP-040B`, a
  post-selectPage-loop row selection
- planned order: selected row after `MIMAP-040B`
