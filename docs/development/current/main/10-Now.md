...
- inventory convenience re-exports that remain inside `legacy/mod.rs`; check
  legacy-internal callers before pruning
- cleanup checkpoint: latest known landed card `291x-363`; detailed closed
