...
- exact-front optimization and representation rows remain governed by
  ...
  `OBJECT-SITE-LOCATION-REMAINING-FIELD-MIGRATION-SELECTION-001`, and the next blocker is
  `LOCAL-FASTPATH-FACT-LOCATION-FIELD-MIGRATION-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-999-OBJECT-SITE-LOCATION-REMAINING-FIELD-MIGRATION-SELECTION-001.md`
