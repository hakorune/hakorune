...
- next frontier: `ENTRY-RESULT-PROJECTION0-S1-DESIGN-STOP`
  (S0 is closed through PARITY-G0; the first physical-carrier consumer needs
  an accepted design before implementation)
