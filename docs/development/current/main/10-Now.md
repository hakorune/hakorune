...
- physically move shared expression helper implementation from legacy storage
  into the support facade
- cleanup checkpoint: latest known landed card `291x-396`; detailed closed
