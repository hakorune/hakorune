...
- exact-front optimization and representation rows remain governed by
  ...
  `MIMALLOC-ARRAY-TEXT-INDEXOF-CONST-CLOSEOUT-001`, and the next
  blocker is `MIMALLOC-FRESH-FRONT-SELECTION-AFTER-ARRAY-TEXT-INDEXOF-CLOSEOUT-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-972-MIMALLOC-ARRAY-TEXT-INDEXOF-CONST-CLOSEOUT-001.md`
