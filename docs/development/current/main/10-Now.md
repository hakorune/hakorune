...
- next executable sub-row: `ENTRY-RESULT-PROJECTION0-PHYSICAL-THUNK0`
  (`CONTRACT0`, `ENTRY-SELECTION0`, and `SOURCE-ENTRY0` are closed;
  physical handoff remains disconnected)
