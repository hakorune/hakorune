...
- exact-front optimization and representation rows remain governed by
  ...
  `OBJECT-PUBLICATION-SITE-LOCATION-FIELD-MIGRATION-001`, and the next blocker is
  `OBJECT-SITE-LOCATION-REMAINING-FIELD-MIGRATION-SELECTION-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-998-OBJECT-PUBLICATION-SITE-LOCATION-FIELD-MIGRATION-001.md`
