...
- current blocker token: `MIMAP-038B post-known-page-loop row selection`
- update policy:
  `docs/development/current/main/design/current-docs-update-policy-ssot.md`

## Next

- continue phase-293x after `MIMAP-038A`; current blocker is `MIMAP-038B`, a
  post-known-page-loop row selection
- planned order: selected next row after `MIMAP-038B`
