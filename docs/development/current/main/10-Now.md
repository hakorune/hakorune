...
- current blocker token: `MIMAP-021A post-020 allocator row selection`
- update policy:
  `docs/development/current/main/design/current-docs-update-policy-ssot.md`

## Next

- continue phase-293x after METADATA-CATALOG-004 post-promotion reconcile; next blocker is MIMAP-021A post-020 allocator row selection; VM-LIM-001 is parked
