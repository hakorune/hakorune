...
- current blocker token: `MIMAP-007 size-class / bin map executable pilot`
- update policy:
  `docs/development/current/main/design/current-docs-update-policy-ssot.md`

## Next

- continue phase-293x after MIMAP-006; next blocker is MIMAP-007 size-class / bin map executable pilot
