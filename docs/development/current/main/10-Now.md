...
- exact-front optimization and representation rows remain governed by
  ...
  `MIMALLOC-SUBSTRING-CONCAT-DEAD-TEXT-REGION-BACKEND-LOWERING-GUARD-SURFACE-001`,
  and the next blocker is
  `MIMALLOC-SUBSTRING-CONCAT-DEAD-TEXT-REGION-BACKEND-LOWERING-IMPLEMENTATION-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-978-MIMALLOC-SUBSTRING-CONCAT-DEAD-TEXT-REGION-BACKEND-LOWERING-GUARD-SURFACE-001.md`
