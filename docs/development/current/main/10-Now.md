...
- current step is implementing only the dominance-aware field_get alias keeper
  selected by 296x-671; arbitrary copy coalescing stays closed and body timing
  must be remeasured before any winner claim;
