...
- exact-front optimization and representation rows remain governed by
  ...
  `MIMALLOC-SUBSTRING-CONCAT-DEAD-TEXT-REGION-DESIGN-001`, and the next
  blocker is `MIMALLOC-SUBSTRING-CONCAT-DEAD-TEXT-REGION-PLAN-SURFACE-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-975-MIMALLOC-SUBSTRING-CONCAT-DEAD-TEXT-REGION-DESIGN-001.md`
