...
- De-rust orchestration lane（phase-29cc）:
  - `plugin-wave-rollout`（RNR-05 complete; PLG-03 done; PLG-04-min1..min6 done; wave-1 complete; PLG-05-min1 done）
  ...
  - plugin lane active next: `PLG-05-min2`（wave-2 rollout）
