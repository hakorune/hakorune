...
- current lane:
  ...
  - current implementation focus: retry pure compile minimal paths #1/#2 deletion after Hako LL/provider predelete fix
  - current phase goal:
  ...
  - current blocker token: `retry pure_compile_minimal_paths #1/#2 deletion`
  - execution mode:
