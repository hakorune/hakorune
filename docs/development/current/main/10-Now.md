...
- priority: read `active_lane` and `current_blocker_token`; owner-forest
  ...
  B0-L0/B0-L1/B0-L2a/B0-L2b are closed; B0-L2c closure-scoped
  behavior-preserving function transaction is active with production resolved
  callers, source-view Builder consumers, and semantic activation zero;
