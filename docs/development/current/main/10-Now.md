...
- exact-front optimization and representation rows remain governed by
  ...
  `OBJECT-STORAGE-PLAN-GUARD-PATH-COMPAT-001`, and the next blocker is
...
2. `docs/development/current/main/phases/phase-296x/296x-990-OBJECT-STORAGE-PLAN-GUARD-PATH-COMPAT-001.md`
