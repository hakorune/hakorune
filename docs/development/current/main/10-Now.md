...
- exact-front optimization and representation rows remain governed by
  ...
  `MIMALLOC-ARRAY-TEXT-LOOP-SESSION-REGION-PAYLOAD-SURFACE-001`, and the next
  blocker is `MIMALLOC-ARRAY-TEXT-LOOP-SESSION-BACKEND-PAYLOAD-READER-SURFACE-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-954-MIMALLOC-ARRAY-TEXT-LOOP-SESSION-REGION-PAYLOAD-SURFACE-001.md`
