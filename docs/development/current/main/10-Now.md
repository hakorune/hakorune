...
- exact-front optimization and representation rows remain governed by
  ...
  `LOCALFIRSTOBJECTPLAN-ALIAS-RETIRE-GUARD-COMPAT-001`, and the next blocker is
  `LOCALFIRSTOBJECTPLAN-ALIAS-RETIRE-IMPLEMENTATION-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-993-LOCALFIRSTOBJECTPLAN-ALIAS-RETIRE-GUARD-COMPAT-001.md`
