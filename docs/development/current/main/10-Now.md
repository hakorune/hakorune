...
- exact-front optimization and representation rows remain governed by
  ...
  `MIMALLOC-ARRAY-TEXT-INDEXOF-CONST-OWNER-INVENTORY-001`, and the next
  blocker is `MIMALLOC-ARRAY-TEXT-INDEXOF-CONST-REGION-PAYLOAD-DESIGN-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-965-MIMALLOC-ARRAY-TEXT-INDEXOF-CONST-OWNER-INVENTORY-001.md`
