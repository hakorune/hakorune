...
- exact-front optimization and representation rows remain governed by
  ...
  `MIMALLOC-ARRAY-TEXT-LOOP-SESSION-HELPER-CONTRACT-DESIGN-001`, and the next
  blocker is `MIMALLOC-ARRAY-TEXT-LOOP-SESSION-HELPER-SURFACE-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-956-MIMALLOC-ARRAY-TEXT-LOOP-SESSION-HELPER-CONTRACT-DESIGN-001.md`
