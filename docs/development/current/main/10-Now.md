...
- current blocker token: `MIMAP-037B post-backing-set-helper row selection`
- update policy:
  `docs/development/current/main/design/current-docs-update-policy-ssot.md`

## Next

- continue phase-293x after `MIMAP-037A`; current blocker is `MIMAP-037B`, a
  post-backing-set-helper row selection
- planned order: selected next row after `MIMAP-037B`
