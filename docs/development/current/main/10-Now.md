...
- current blocker token: `MIMAP-035A facade huge unreserve fail-fast diagnostics`
- update policy:
  `docs/development/current/main/design/current-docs-update-policy-ssot.md`

## Next

- continue phase-293x after `MIMAP-034B`; current blocker is `MIMAP-035A`, a
  facade huge unreserve duplicate/stale fail-fast diagnostics row
- planned order: selected allocator behavior after `MIMAP-035A`
