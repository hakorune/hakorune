...
- exact-front optimization and representation rows remain governed by
  ...
  `LOCAL-FASTPATH-FACT-LOCATION-FIELD-MIGRATION-001`, and the next blocker is
  `LOCAL-PUBLICATION-INVENTORY-LOCATION-FIELD-MIGRATION-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-1000-LOCAL-FASTPATH-FACT-LOCATION-FIELD-MIGRATION-001.md`
