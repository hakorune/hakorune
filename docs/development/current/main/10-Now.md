...
- exact-front optimization and representation rows remain governed by
  ...
  `MIMALLOC-FRESH-FRONT-SELECTION-AFTER-ARRAY-TEXT-CLOSEOUT-001`, and the next
  blocker is `MIMALLOC-ARRAY-TEXT-INDEXOF-CONST-OWNER-INVENTORY-001`
...
2. `docs/development/current/main/phases/phase-296x/296x-964-MIMALLOC-FRESH-FRONT-SELECTION-AFTER-ARRAY-TEXT-CLOSEOUT-001.md`
