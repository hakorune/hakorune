...
if [[ "${RUST_SUBSET_RUN_ADAPTER:-0}" == "1" ]]; then
  ...
  ADAPTER_FIXTURES=(
    ...
    "generic impl target skeleton fixture|generic_impl_target|generic_impl_target"
    "reference type spelling fixture|reference_type|reference_type"
...
CONVERTER_FIXTURES=(
  ...
  "generic impl target fixture converter|$APP_DIR/convert_generic_impl_target_fixture.hako|$EXAMPLES_DIR/generic_impl_target_expected.hako|convert_generic_impl_target_fixture"
  "reference type fixture converter|$APP_DIR/convert_reference_type_fixture.hako|$EXAMPLES_DIR/reference_type_expected.hako|convert_reference_type_fixture"
  ...
  "associated const/value fixture converter|$APP_DIR/convert_associated_const_value_fixture.hako|$EXAMPLES_DIR/associated_const_value_expected.hako|convert_associated_const_value_fixture"
  ...
  "hakorune_mir_builder crate-root fixture converter|$APP_DIR/convert_hakorune_mir_builder_crate_root_crate_file.hako|$EXAMPLES_DIR/hakorune_mir_builder_crate_root_expected.hako|convert_hakorune_mir_builder_crate_root_crate_file"
...
run_generated_hako_mir_acceptance \
  "hakorune_mir_builder crate-root generated skeleton" \
  "$APP_DIR/convert_hakorune_mir_builder_crate_root_crate_file.hako" \
  "hakorune_mir_builder_crate_root_handoff"
...
run_generated_hako_mir_acceptance \
  "hakorune_mir_builder metadata_context generated skeleton" \
  "$APP_DIR/convert_hakorune_mir_builder_metadata_context_crate_file.hako" \
  "hakorune_mir_builder_metadata_context_handoff"

run_generated_hako_mir_acceptance \
  "hakorune_mir_builder core_context generated skeleton" \
  "$APP_DIR/convert_hakorune_mir_builder_core_context_crate_file.hako" \
  "hakorune_mir_builder_core_context_handoff"
