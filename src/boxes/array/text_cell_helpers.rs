use super::{
    ArrayTextCell, MID_GAP_INITIAL_HEADROOM, MID_GAP_LEFT_OVERSHOOT_LIMIT,
    MID_GAP_RIGHT_COMPACT_MIN,
};

#[inline(always)]
pub(super) fn active_mid_gap_right(right: &str, right_start: usize) -> &str {
...
#[inline(always)]
pub(super) fn mid_gap_right_range(right: &str, start: usize, end: usize) -> &str {
...
#[inline(always)]
pub(super) fn mid_gap_right_range_byte_boundary_safe(
    right: &str,
    start: usize,
    end: usize,
) -> &str {
...
#[inline(always)]
pub(super) fn materialize_mid_gap(left: &str, right: &str, right_start: usize) -> String {
...
#[inline(always)]
pub(super) fn build_mid_gap_from_flat_lenhalf(
    value: &str,
    middle: &str,
...
#[inline(always)]
pub(super) fn build_mid_gap_from_flat_lenhalf_byte_boundary_safe(
    value: &str,
    middle: &str,
) -> Option<(ArrayTextCell, i64)> {
    if value.is_empty() || middle.is_empty() {
...
#[inline(always)]
pub(super) fn insert_const_mid_lenhalf_mid_gap(
    left: &mut String,
    right: &mut String,
...
#[inline(always)]
pub(super) fn insert_const_mid_lenhalf_mid_gap_byte_boundary_safe(
    left: &mut String,
    right: &mut String,
    right_start: &mut usize,
    middle: &str,
...
#[inline(always)]
pub(super) fn compact_mid_gap_right(right: &mut String, right_start: &mut usize) {
...
#[inline(always)]
pub(super) fn rebalance_mid_gap_left_overshoot(
    left: &mut String,
    right: &mut String,
    right_start: &mut usize,
) {
...
#[inline(always)]
pub(super) fn rebalance_mid_gap_left_overshoot_byte_boundary_safe(
    left: &mut String,
    right: &mut String,
    right_start: &mut usize,
) {
...
#[inline(always)]
pub(super) fn insert_str_byte_boundary_unchecked(value: &mut String, split: usize, middle: &str) {
    if value.is_empty() {
...
#[inline(always)]
pub(super) fn mid_gap_contains_literal(left: &str, right: &str, needle: &str) -> bool {
...
#[inline(always)]
pub(super) fn text_contains_four_byte_literal(value: &str, needle: u32) -> bool {
    contains_four_byte_word(value.as_bytes(), needle)
}

#[inline(always)]
pub(super) fn mid_gap_contains_four_byte_literal(left: &str, right: &str, needle: u32) -> bool {
...
#[inline(always)]
pub(super) fn mid_gap_boundary_contains(left: &[u8], right: &[u8], needle: &[u8]) -> bool {
...
#[inline(always)]
pub(super) fn mid_gap_boundary_contains_four_byte(left: &[u8], right: &[u8], needle: u32) -> bool {
...
#[inline(always)]
pub(super) fn insert_const_mid_flat(value: &mut String, middle: &str, split: i64) {
    if value.is_empty() {
        value.push_str(middle);
        return;
    }
...
#[inline(always)]
pub(super) fn materialize_insert_const_mid_flat(source: &str, middle: &str, split: i64) -> String {
    if source.is_empty() {
...
#[inline(always)]
pub(super) fn text_contains_literal(value: &str, needle: &str) -> bool {
...
#[inline(always)]
pub(super) fn append_text_suffix(value: &mut String, suffix: &str) {
    match suffix.len() {
        0 => {}
...
#[inline(always)]
pub(super) fn append_short_text_suffix(value: &mut String, suffix: &str) {
...
#[inline(always)]
pub(super) fn short_literal_prefix_eq(haystack: &[u8], needle: &[u8]) -> bool {
    if needle.len() > haystack.len() {
        return false;
    }
    match needle.len() {
...
#[inline(always)]
pub(super) fn read_u16_unaligned(src: *const u8) -> u16 {
    unsafe { core::ptr::read_unaligned(src.cast::<u16>()) }
}

#[inline(always)]
pub(super) fn read_u32_unaligned(src: *const u8) -> u32 {
    unsafe { core::ptr::read_unaligned(src.cast::<u32>()) }
}

#[inline(always)]
pub(super) fn read_u64_unaligned(src: *const u8) -> u64 {
    unsafe { core::ptr::read_unaligned(src.cast::<u64>()) }
}

#[inline(always)]
pub(super) fn write_u16_unaligned(dst: *mut u8, value: u16) {
    unsafe { core::ptr::write_unaligned(dst.cast::<u16>(), value) }
}

#[inline(always)]
pub(super) fn write_u32_unaligned(dst: *mut u8, value: u32) {
    unsafe { core::ptr::write_unaligned(dst.cast::<u32>(), value) }
}

#[inline(always)]
pub(super) fn write_u64_unaligned(dst: *mut u8, value: u64) {
    unsafe { core::ptr::write_unaligned(dst.cast::<u64>(), value) }
}

#[inline(always)]
pub(super) fn contains_short_literal_from(haystack: &[u8], needle: &[u8], start: usize) -> bool {
...
#[inline(always)]
pub(super) fn contains_one_byte_from(
    haystack: &[u8],
    b0: u8,
    mut index: usize,
    limit: usize,
...
#[inline(always)]
pub(super) fn contains_two_bytes_from(
    haystack: &[u8],
    b0: u8,
    b1: u8,
    mut index: usize,
...
#[inline(always)]
pub(super) fn contains_three_bytes_from(
    haystack: &[u8],
    b0: u8,
    b1: u8,
    b2: u8,
...
#[inline(always)]
pub(super) fn contains_four_bytes_from(
    haystack: &[u8],
    b0: u8,
    b1: u8,
    b2: u8,
...
#[inline(always)]
pub(super) fn contains_four_byte_word(haystack: &[u8], needle: u32) -> bool {
    if haystack.len() < 4 {
        return false;
    }
...
#[inline(always)]
pub(super) fn contains_short_slice_from(
    haystack: &[u8],
    needle: &[u8],
    mut index: usize,
    limit: usize,
