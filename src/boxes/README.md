...
stores I64/Bool inline, owned inline Text/EmptyArray payloads, a
non-consuming BorrowedHandle snapshot (never owned; a scalar read records
the non-scalar Fault), or a non-Clone Residence; Trivial values allocate no
