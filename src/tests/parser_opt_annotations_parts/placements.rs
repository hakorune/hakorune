...
"#;
        ...
        assert!(
            msg.contains(
                "[freeze:contract][parser/rune] supported: Public|Internal|FfiSafe|Symbol|CallConv|ReturnsOwned|FreeWith|Ownership|Hint|Inline|Contract|IntrinsicCandidate|Lowering|Profile"
            ),
...
"#;
        ...
        assert!(
            msg.contains(
                "[freeze:contract][parser/rune] instance method target supports only Public|Internal|Ownership|Hint|Inline|Contract|IntrinsicCandidate|Lowering|Profile"
            ),
            "unexpected error: {msg}"
        );
    });
...
"#;
        ...
        assert!(
            msg.contains(
                "[freeze:contract][parser/rune] constructor target supports only Public|Internal|Ownership|Hint|Inline|Contract|IntrinsicCandidate|Lowering|Profile"
            ),
            "unexpected error: {msg}"
        );
    });
...
"#;
        ...
        assert!(
            msg.contains(
                "[freeze:contract][parser/rune] interface method target supports only Public|Internal|Ownership|Hint|Inline|Contract|IntrinsicCandidate|Lowering|Profile"
            ),
            "unexpected error: {msg}"
        );
    });
