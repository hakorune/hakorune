...
def lower_closure_creation(builder, module, params, captures, me_capture, dst_vid, vmap, resolver, owner):
    """Lower closure creation via the shared modular route."""
    from instructions.mir_call.closure_call import lower_closure_creation as lower_modern_closure_creation

    lower_modern_closure_creation(
        builder,
        module,
        params,
        captures,
