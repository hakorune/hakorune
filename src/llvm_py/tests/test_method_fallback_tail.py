...
class TestMethodFallbackTail(unittest.TestCase):
    ...
    def test_filebox_read_prefers_direct_kernel_route(self):
        ...
        result = lower_direct_or_plugin_method_call(
            ...
            resolve_arg=lambda vid: ir.Constant(i64, vid),
            ensure_handle=lambda value: value,
            direct_call_name="known_box_file_read",
            plugin_call_name="unified_plugin_invoke",
        )
        builder.ret(result)
    ...
    def test_filebox_close_prefers_direct_kernel_route(self):
        i64, module, builder = _new_builder()
        ...
        result = lower_direct_or_plugin_method_call(
            ...
            resolve_arg=lambda vid: ir.Constant(i64, vid),
            ensure_handle=lambda value: value,
            direct_call_name="known_box_file_close",
            plugin_call_name="unified_plugin_invoke",
        )
        builder.ret(result)
    ...
    def test_filebox_write_bytes_fails_fast_without_by_name_tail(self):
        i64, module, builder = _new_builder()
        ...
        with self.assertRaisesRegex(NotImplementedError, "Unsupported MIR method call"):
            lower_direct_or_plugin_method_call(
                ...
                module=module,
                box_name="FileBox",
                method_name="writeBytes",
                recv_h=ir.Constant(i64, 7),
                args=[2],
                resolve_arg=lambda vid: ir.Constant(i64, vid),
                ensure_handle=lambda value: value,
                direct_call_name="known_box_file_write_bytes",
                plugin_call_name="unified_plugin_invoke",
            )
