...
class TestBoxcallPluginInvokeArgs(unittest.TestCase):
    ...
    def test_stage1_mir_builder_module_box_type_prefers_direct_call(self):
        module = ir.Module(name="test_boxcall_stage1_mir_builder_direct")
        i64 = ir.IntType(64)
        i8p = ir.IntType(8).as_pointer()
        fn = ir.Function(module, ir.FunctionType(i64, []), name="main")
        bb = fn.append_basic_block("entry")
        ...
        vmap = {1: recv_ptr, 2: arg_ptr, 3: ir.Constant(i64, 0)}
        resolver = _ResolverStub()
        resolver.value_types[1] = {
            "kind": "handle",
            "box_type": "lang.mir.builder.MirBuilderBox",
        }
    ...
    def test_stage1_mir_builder_source_box_type_prefers_direct_call(self):
        module = ir.Module(name="test_boxcall_stage1_mir_builder_source_direct")
        i64 = ir.IntType(64)
        i8p = ir.IntType(8).as_pointer()
        fn = ir.Function(module, ir.FunctionType(i64, []), name="main")
        bb = fn.append_basic_block("entry")
    ...
    def test_filebox_boxcall_close_prefers_direct_export(self):
        module = ir.Module(name="test_boxcall_filebox_close_direct")
        i64 = ir.IntType(64)
        fn = ir.Function(module, ir.FunctionType(i64, []), name="main")
        bb = fn.append_basic_block("entry")
        builder = ir.IRBuilder(bb)
    ...
    def test_filebox_boxcall_read_bytes_prefers_direct_export(self):
        module = ir.Module(name="test_boxcall_filebox_read_bytes_direct")
        i64 = ir.IntType(64)
        fn = ir.Function(module, ir.FunctionType(i64, []), name="main")
        bb = fn.append_basic_block("entry")
        builder = ir.IRBuilder(bb)
