...
class TestBoxcallCollectionPolicy(unittest.TestCase):
    ...
    def test_map_delete_uses_delete_hh(self):
        i64, module, builder = _new_builder()
        resolver = _DummyResolver(value_types={1: {"kind": "handle", "box_type": "MapBox"}})
    ...
    def test_runtime_data_delete_stays_unrouted(self):
        i64, module, builder = _new_builder()
        resolver = _DummyResolver(value_types={1: {"kind": "handle", "box_type": "RuntimeDataBox"}})
