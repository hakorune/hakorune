...
pub fn build_command() -> Command {
    ...
    Command::new("hakorune")
        ...
        .arg(Arg::new("provider-package-hako-semantic-codegen").long("provider-package-hako-semantic-codegen").value_name("MODE").help("[Provider package] .hako semantic provider codegen mode (none|ping-literal-v0|alloc-free-owns-literal-v0)"))
