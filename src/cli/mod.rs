...
mod allocator_provider_proof_bundle_consumption;
...
mod provider_package_hako_derived_build;
...
pub use provider_package_hako_derived_build::maybe_run_provider_package_hako_derived_build;
...
pub struct CliConfig {
    ...
    pub provider_package_hako_derived_build_fixture: Option<String>,
    ...
    pub fn as_groups(&self) -> CliGroups {
        CliGroups {
            ...
            emit: EmitConfig {
                ...
                emit_parser_evidence_ast_json: self.emit_parser_evidence_ast_json.clone(),
...
impl Default for CliConfig {
    fn default() -> Self {
        Self {
            ...
            emit_wat: None,
            emit_ast_json: None,
            emit_parser_evidence_ast_json: None,
            ...
            provider_package_hako_derived_build_fixture: None,
...
fn allocator_diagnostic_modes(config: &CliConfig) -> Vec<&'static str> {
    ...
    if config.allocator_provider_proof_bundle_consumption.is_some() {
        modes.push("allocator_provider_proof_bundle_consumption");
    }
    modes
}
...
mod tests {
    ...
    #[test]
    fn allocator_registry_snapshot_conflicts_with_other_diagnostics() {
        let config = CliConfig {
    ...
    #[test]
    fn allocator_proof_bundle_consumption_conflicts_with_other_diagnostics() {
        let config = CliConfig {
            allocator_provider_proof_bundle_consumption: Some("proof-bundle.toml".to_string()),
            allocator_provider_selection_decision: Some("selection.toml".to_string()),
            ..CliConfig::default()
        };
