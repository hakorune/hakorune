...
pub use span::Span;
pub use syntax::{BinaryOperator, BuildPredicate, LiteralValue, UnaryOperator};
mod nodes;
mod utils;
pub use nodes::*;
...
pub enum ASTNode {
    ...
    Local {
        ...
        /// Source type annotations for each local binding.
        ///
        /// Stage0 owns parse/transport only. Type meaning and expected-type
        /// propagation are Stage1 responsibilities.
