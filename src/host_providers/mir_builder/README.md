...
- `mir_builder/lowering.rs`
  ...
  - the extra `lower_program_json_to_module(...)` helper is retired; the live plain lowering path now inlines the exact bridge call inside `program_json_to_mir_json(...)`
