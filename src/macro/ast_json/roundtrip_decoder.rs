use nyash_rust::ast::{
    ...
    BoxMethodInventoryV1, DelegateDecl, DelegateExposeDecl, EnumVariantDecl, FieldDecl,
    LiteralValue, Span,
};
use serde_json::Value;
use std::collections::HashMap;

use super::box_inventory_v2;
                ...
                let methods = match self.mode {
                    ...
                    DecodeMode::RoundtripV2 => {
                        let rows = v
                            ...
                            .iter()
                            .map(|method| {
                                box_inventory_v2::decode_method_entry_v2(method, |decl| {
                                    self.decode(decl)
                                })
                            })
