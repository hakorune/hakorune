...
pub fn env_vars() -> Vec<EnvVarMeta> {
    vec![
        ...
        EnvVarMeta {
            name: "NYASH_NYRT_SILENT_RESULT",
            description: "NyRT exact-EXE Result line suppression toggle",
            applies_to: AppliesTo::Runtime,
            default: None,
        },
        EnvVarMeta {
            name: "NYASH_GC_METRICS_JSON",
            description: "NyRT exact-EXE GC metrics JSON toggle",
            applies_to: AppliesTo::Runtime,
            default: None,
        },
        EnvVarMeta {
            name: "NYASH_GC_METRICS",
            description: "NyRT exact-EXE GC metrics text toggle",
            applies_to: AppliesTo::Runtime,
            default: None,
        },
        EnvVarMeta {
            name: "NYASH_GC_COLLECT_SP",
            description: "NyRT exact-EXE GC safepoint collection interval",
            applies_to: AppliesTo::Runtime,
            default: None,
        },
        EnvVarMeta {
            name: "NYASH_GC_COLLECT_ALLOC",
            description: "NyRT exact-EXE GC allocation-based collection threshold",
            applies_to: AppliesTo::Runtime,
            default: None,
        },
        EnvVarMeta {
            name: "NYASH_LLVM_AUTO_SAFEPOINT",
            description: "NyRT exact-EXE LLVM auto-safepoint toggle",
            applies_to: AppliesTo::Runtime,
            default: None,
        },
        EnvVarMeta {
            name: "NYASH_GC_ALLOC_THRESHOLD",
            description: "NyRT exact-EXE GC allocation warning threshold",
            applies_to: AppliesTo::Runtime,
            default: None,
        },
        EnvVarMeta {
            name: "NYASH_NYRT_MINIMAL_STARTUP",
            description: "NyRT exact-EXE minimal startup toggle",
            applies_to: AppliesTo::Runtime,
            default: None,
        },
        EnvVarMeta {
            name: "HAKO_NYRT_PLUGIN_HOST",
            description: "NyRT exact-EXE plugin-host startup gate",
            applies_to: AppliesTo::Runtime,
            default: Some("auto"),
        },
        EnvVarMeta {
            name: "NYASH_NYRT_RUNTIME_HOOKS",
            description: "NyRT exact-EXE runtime-hooks startup gate",
            applies_to: AppliesTo::Runtime,
            default: Some("auto"),
        },
        EnvVarMeta {
            name: "NYASH_NYRT_RUNTIME_BUILD",
            description: "NyRT exact-EXE runtime builder startup gate",
            applies_to: AppliesTo::Runtime,
            default: Some("auto"),
        },
        EnvVarMeta {
            name: "NYASH_NYRT_ENTRY_PATH_PREP",
            description: "NyRT exact-EXE executable-path preparation gate",
            applies_to: AppliesTo::Runtime,
            default: Some("auto"),
        },
        EnvVarMeta {
            name: "NYASH_NYRT_RING0_INIT",
            description: "NyRT exact-EXE ring0 bootstrap gate",
            applies_to: AppliesTo::Runtime,
            default: Some("auto"),
        },
        // Selfhost (Phase 286B)
