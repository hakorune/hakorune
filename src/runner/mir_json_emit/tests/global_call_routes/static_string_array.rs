...
#[test]
fn build_mir_json_root_emits_direct_plan_for_static_string_array_body() {
    let mut module =
    ...
    assert_eq!(route["target_shape"], "static_string_array_body");
    ...
    assert_eq!(plan["target_shape"], "static_string_array_body");
