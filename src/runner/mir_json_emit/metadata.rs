...
use super::dynamic_v2_aot_admission::insert_dynamic_v2_aot_call_admission_json;
...
pub(super) fn build_function_metadata_json(f: &MirFunction) -> Result<serde_json::Value, String> {
    ...
    let mut metadata_json = json!({
        ...
        "string_dead_text_region_plans": metadata.string_dead_text_region_plans.iter().map(|plan| {
            json!({
                ...
                "text_phi_value": plan.text_phi_value.as_u32(),
                "text_initial_value": plan.text_initial_value.as_u32(),
                "loop_index_phi_value": plan.loop_index_phi_value.as_u32(),
                "loop_index_initial_value": plan.loop_index_initial_value.as_u32(),
                "loop_index_initial_const": plan.loop_index_initial_const,
                "loop_index_next_value": plan.loop_index_next_value.as_u32(),
                "loop_bound_value": plan.loop_bound_value.as_u32(),
                "loop_bound_const": plan.loop_bound_const,
                "base_len_value": plan.base_len_value.as_u32(),
                "base_len_const": plan.base_len_const,
                "inserted_text_value": plan.inserted_text_value.as_u32(),
                "inserted_text": plan.inserted_text,
                "inserted_len_const": plan.inserted_len_const,
                "accumulator_phi_value": plan.accumulator_phi_value.as_u32(),
                "accumulator_initial_value": plan.accumulator_initial_value.as_u32(),
                "accumulator_initial_const": plan.accumulator_initial_const,
                "accumulator_next_value": plan.accumulator_next_value.as_u32(),
                "accumulator_delta_value": plan.accumulator_delta_value.as_u32(),
                "accumulator_delta_const": plan.accumulator_delta_const,
                "exit_accumulator_value": plan.exit_accumulator_value.as_u32(),
                "final_len_value": plan.final_len_value.as_u32(),
                "final_return_value": plan.final_return_value,
                "substring_left_value": plan.substring_left_value.as_u32(),
                "substring_right_value": plan.substring_right_value.as_u32(),
                "concat_result_value": plan.concat_result_value.as_u32(),
                "rotation_start_value": plan.rotation_start_value.as_u32(),
                "rotation_end_value": plan.rotation_end_value.as_u32(),
                "split_value": plan.split_value.as_u32(),
                "publication_boundary": plan.publication_boundary,
                "final_text_content_observed": plan.final_text_content_observed,
                "mir_json_export_only": true,
                "backend_consumer_enabled": plan.lowering_consumer_enabled,
            })
        }).collect::<Vec<_>>(),
