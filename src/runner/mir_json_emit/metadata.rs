...
pub(super) fn build_function_metadata_json(f: &MirFunction) -> serde_json::Value {
    ...
    let mut metadata_json = json!({
        ...
        "array_string_len_window_routes": metadata.array_string_len_window_routes.iter().map(|route| {
            json!({
        ...
        "array_text_loopcarry_len_store_routes": metadata.array_text_loopcarry_len_store_routes.iter().map(|route| {
            json!({
                "block": route.block().as_u32(),
                "instruction_index": route.instruction_index(),
                "array_value": route.array_value().as_u32(),
        ...
        "array_text_edit_routes": metadata.array_text_edit_routes.iter().map(|route| {
            json!({
                "block": route.block().as_u32(),
        ...
        "array_text_residence_sessions": metadata.array_text_residence_sessions.iter().map(|route| {
            let mut obj = json!({
        ...
        "array_text_observer_routes": metadata.array_text_observer_routes.iter().map(|route| {
            let mut obj = json!({
                "block": route.block().as_u32(),
        ...
        "array_text_combined_regions": metadata.array_text_combined_regions.iter().map(|route| {
            let mut obj = json!({});
        ...
        "array_string_store_micro_seed_route": metadata.array_string_store_micro_seed_route.as_ref().map(|route| {
            json!({
                "seed": route.seed(),
        ...
        "array_rmw_add1_leaf_seed_route": metadata.array_rmw_add1_leaf_seed_route.as_ref().map(|route| {
            json!({
                "size": route.size(),
                "ops": route.ops(),
        ...
        "concat_const_suffix_micro_seed_route": metadata.concat_const_suffix_micro_seed_route.as_ref().map(|route| {
            json!({
                "seed": route.seed(),
                "seed_len": route.seed_len(),
                "suffix": route.suffix(),
        ...
        "substring_views_micro_seed_route": metadata.substring_views_micro_seed_route.as_ref().map(|route| {
            json!({
                "source": route.source(),
        ...
        "sum_variant_tag_seed_route": metadata.sum_variant_tag_seed_route.as_ref().map(|route| {
            json!({
        ...
        "sum_variant_project_seed_route": metadata.sum_variant_project_seed_route.as_ref().map(|route| {
        ...
        "userbox_local_scalar_seed_route": metadata.userbox_local_scalar_seed_route.as_ref().map(|route| {
            let mut obj = serde_json::Map::new();
            obj.insert("kind".to_string(), json!(route.kind().to_string()));
        ...
        "exact_seed_backend_route": metadata.exact_seed_backend_route.as_ref().map(|route| {
            json!({
                "tag": route.tag(),
        ...
        "array_text_state_residence_route": metadata.array_text_state_residence_route.as_ref().map(|route| {
