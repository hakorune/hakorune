...
pub fn format_freeze_compat_rust_json_v0_bridge(source: &str) -> String {
    format!(
        ...
        FREEZE_COMPAT_RUST_JSON_V0_BRIDGE, ROUTE_STAGE_A, source, LANE_COMPAT_RUST_JSON_V0_BRIDGE
    )
}
...
pub fn format_freeze_direct_v0_bridge_disabled(source: &str) -> String {
    format!(
        ...
        FREEZE_DIRECT_V0_BRIDGE_DISABLED, ROUTE_STAGE_A, source, LANE_DIRECT_V0_BRIDGE
    )
}
