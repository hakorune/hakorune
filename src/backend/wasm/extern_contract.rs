...
mod tests {
    ...
    fn extern_contract_unsupported_name_is_none() {
        ...
        assert_eq!(extern_import_name("env.canvas.moveTo"), None);
    }
    ...
    #[test]
    fn extern_contract_canvas_fill_supported() {
        assert_eq!(extern_import_name("env.canvas.fill"), Some("canvas_fill"));
    }
    ...
    #[test]
    fn extern_contract_canvas_set_fill_style_supported() {
        assert_eq!(
            extern_import_name("env.canvas.setFillStyle"),
            Some("canvas_setFillStyle")
        );
    ...
    #[test]
    fn extern_contract_canvas_fill_circle_supported() {
        assert_eq!(
            extern_import_name("env.canvas.fillCircle"),
            Some("canvas_fillCircle")
        );
