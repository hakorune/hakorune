...
//! - ✅ ReturnCleanup (Return terminator + jump-chain + multi-pred intersection)
//! - ✅ BreakCleanup (minimal: empty Jump block -> immediate multi-pred Return edge)
//! - ✅ ContinueCleanup (minimal: empty Jump block -> multi-pred Branch header edge)
//! - ❌ PHI handling (out of scope)
//! - ❌ Complex early-exit cleanup (out of scope)
