 ...
 * placement/effect lane. In this cut it only delegates to the landed string
 * corridor sink, but it centralizes where pre/post-DCE transform widening
 * should happen so family-specific passes stop being called directly from the
 * optimizer pipeline.
 */
