...
use super::schema_v2::{
    LoopConditionV2, LoopExitKindV2, LoopRecipeArtifactV2, LoopRecipeItemV2, LoopRecipeV2,
    LoopValueClassV2, LOOP_RECIPE_SCHEMA_VERSION_V2,
};

#[path = "typed_schema_v2_operations.rs"]
mod typed_schema_v2_operations;
use typed_schema_v2_operations::check_operation;
...
pub(super) fn expect_defined_value(
    item: LoopItemKeyV1,
    key: LoopValueKeyV1,
    values: &BTreeMap<LoopValueKeyV1, LoopValueClassV2>,
    definitions: &BTreeMap<LoopValueKeyV1, Option<LoopItemKeyV1>>,
