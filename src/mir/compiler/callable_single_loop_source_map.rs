...
use super::callable_single_loop_syntax_facts::{
    InitialCarrierSyntaxFactV1, PrefixBoundarySyntaxFactV1, StepSyntaxFactsV1,
    TailReturnSyntaxFactV1, VerifiedSourceSyntaxFactsV1,
};
...
#[cfg(test)]
#[path = "callable_single_loop_source_map_tests.rs"]
mod tests;
