...
use crate::mir::loop_route_policy::{
    VerifiedDirectAccumPolicyHandoffV1, VerifiedDirectAccumPolicyReceiptV1,
};
...
/// the winner-based helper retired with the synthetic schedule ceremony.
pub(crate) fn issue_direct_accum_plan_from_handoff_v1<'source>(
    ...
    let (demand, policy_receipt) = issue_selected_loop_recipe_demand_v1(admission, facts, source)
