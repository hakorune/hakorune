...
// Caller-zero third bounded Main0 profile; same canonical-root handoff.
#[allow(dead_code)]
mod normal_main0_derived_predicate_prepared_operation; // Builder-free Main0 full-demand ingress
