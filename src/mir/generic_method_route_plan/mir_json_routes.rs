...
mod array_item_routes;

use array_item_routes::{
    match_mir_json_block_inst_array_item_get_route, match_mir_json_effects_array_item_get_route,
    match_mir_json_flags_rec_access_get_route, match_mir_json_function_block_array_item_get_route,
    match_mir_json_module_function_array_item_get_route,
    match_mir_json_params_array_item_get_route, match_mir_json_vid_array_item_get_route,
};
