...
fn direct_expression_roots_keep_full_legacy_outcomes_and_spans() {
    ...
    let fastmem = ASTNode::FastMemRegion {
        ...
        body: vec![integer(1, 170)],
        span: Span::new(169, 171, 169, 1),
    };
...
fn direct_expression_failure_discards_candidate_and_reuses_compiler() {
    ...
    let request =
        NormalCompileRequestV1::for_mir_mode(failing, Some("direct-failure.hako"), HashMap::new())
    ...
    compiler
        .compile_normal(
            NormalCompileRequestV1::for_mir_mode(fresh, Some("direct-reuse.hako"), HashMap::new())
...
include!("../normal_script_direct_statement_owner_fastmem_failure_test.rs");
