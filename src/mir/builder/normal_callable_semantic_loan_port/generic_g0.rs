...
use super::canonical_route::{try_classify_generic_g0_route_v1, CanonicalCallableRouteV1};
...
pub(super) fn lower_normal_top_level_function(
    ...
    let lineage =
        super::super::raw_invocation_source_transport::RawInvocationRootLineageV1::TopLevel(
...
pub(super) fn try_select_top_level_generic_g0_plan_v1<'source>(
    ...
    match try_classify_generic_g0_route_v1(input, mode)? {
        ...
        None => Ok(None),
        Some(_) => {
            Err("[freeze:contract][mir/callable-generic-g0-preflight/unexpected-route]".to_owned())
        }
    }
}
