//! Selected Main0 canonical-root handoff for the bounded profiles.
//!
...
pub(super) fn lower_app_main0_derived_predicate_root_v1(
    adapter: &mut NormalCallableSemanticPackagePortAdapterV1<'_, '_, '_, '_, '_>,
    builder: &mut MirBuilder,
    expected_identity: &CallableDeclarationIdentityV1,
