...
use crate::mir::builder::control_flow::facts::scan_common_predicates::extract_step_var_from_tail;

pub(in crate::mir::builder) fn try_match_loop_collect_using_entries_v0_shape(
    body: &[ASTNode],
    loop_var: &str,
) -> Result<(), String> {
    if body.len() < 4 {
