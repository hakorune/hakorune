//! Shared recipe-first adoption bridge for nested-loop lowering.
...
use crate::mir::builder::control_flow::plan::nested_loop_plan_recipe_adoption::try_compose_nested_loop_recipe_adoption;
...
pub(in crate::mir::builder) fn lower_nested_loop_plan_with_recipe_first_bridge(
    ...
    if let Some(recipe) = try_compose_nested_loop_recipe_adoption(
        builder,
        &outcome,
        &nested_ctx,
        stage,
