...
use crate::mir::builder::control_flow::facts::canon::cond_block_view;
...
fn lower_general_if_stmt(
    ...
    if let Some(plans) = crate::mir::builder::control_flow::plan::parts::conditional_update::try_lower_general_if_recipe_authority(
        builder,
        current_bindings,
        carrier_phis,
        carrier_step_phis,
