...
impl RecipeComposer {
    ...
    pub fn compose_generic_loop_v0_recipe(
        ...
        generic_loop_pipeline::apply_generic_loop_v0_pipeline(builder, generic_loop_v0, ctx, &mut skeleton)
    ...
    pub fn compose_generic_loop_v1_recipe(
        ...
        generic_loop_pipeline::apply_generic_loop_v1_pipeline(builder, generic_loop_v1, ctx, &mut skeleton)
