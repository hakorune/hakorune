//! Continue-with-return recipe bridge for nested-loop fallback.
...
mod tests {
    ...
    #[test]
    fn nested_loop_plan_cwr_bridge_skips_when_not_required() {
    ...
    #[test]
    fn nested_loop_plan_cwr_bridge_skips_without_facts() {
        let mut builder = MirBuilder::new();
        let condition = less_cond();
        let body = vec![ASTNode::Assignment {
            target: Box::new(var("x")),
