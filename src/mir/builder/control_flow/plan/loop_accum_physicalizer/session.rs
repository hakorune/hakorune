//! Private DirectAccum physicalization session.

use super::*;

pub(super) struct DirectAccumPhysicalizerV1<'builder, 'owners, P> {
    ...
    #[cfg(test)]
    pub(super) failure: Option<DirectAccumPhysicalizerTestFailurePointV1>,
}
    ...
    P: DirectAccumBindingPortV1,
{
    ...
    pub(super) fn emit(&mut self) -> Result<LoopPhysicalSuccessReceiptV1, LoopPhysicalizeErrorV1> {
