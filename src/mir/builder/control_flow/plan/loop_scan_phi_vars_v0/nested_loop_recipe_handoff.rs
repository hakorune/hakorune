...
mod tests {
    ...
    #[test]
    fn loop_scan_phi_vars_nested_recipe_handoff_rejects_when_no_stmt_only_or_fastpath() {
        ...
        let err = lower_loop_scan_phi_vars_nested_loop_recipe(
            &mut builder,
        ...
        .expect_err("unsupported nested loop should reject");
