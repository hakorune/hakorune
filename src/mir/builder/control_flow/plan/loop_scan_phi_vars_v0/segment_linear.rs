...
pub(super) fn verify_loop_scan_phi_vars_linear_segment<'a>(
...
pub(super) fn lower_loop_scan_phi_vars_linear_segment_verified(
...
pub(in crate::mir::builder) fn lower_loop_scan_phi_vars_linear_segment(
    ...
    lower_loop_scan_phi_vars_linear_segment_verified(
        builder,
        current_bindings,
        carrier_step_phis,
        break_phi_dsts,
...
mod tests {
    ...
    #[test]
    fn loop_scan_phi_vars_linear_segment_verifies_simple_no_exit_slice() {
