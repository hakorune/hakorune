...
pub(in crate::mir::builder) fn body_is_generic_v0(
    ...
    super::validation_v0::body_is_generic_v0(body, loop_var, loop_increment)
}
...
pub(in crate::mir::builder) fn body_is_generic_v1(
    ...
    super::validation_v1::body_is_generic_v1(body, loop_var, loop_increment, condition)
}
...
pub fn resolve_v1_shape_matches(
    ...
    super::shape_detection::resolve_v1_shape_matches(matches)
}
