...
SSOT:
- Condition canon (analysis-only view): `control_flow/generic_loop_canon/condition/`
- Update canon (analysis-only view): `control_flow/generic_loop_canon/update/`
- Step canon (extract + placement): `control_flow/generic_loop_canon/step_extract/` and `step_placement/`
- Facts: `facts.rs`
...
- `facts/canon/generic_loop/step/placement/*`: compatibility facade only; the plan-side shelf is retired
...
- `control_flow/generic_loop_canon/types.rs`: Condition/Update/Step の観測型定義
