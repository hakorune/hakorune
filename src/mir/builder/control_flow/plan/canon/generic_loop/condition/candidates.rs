...
pub(super) fn collect_candidates_from_top_level_comparison(
    condition: &ASTNode,
) -> Option<Vec<String>> {
...
pub(super) fn collect_candidates_from_condition(
    expr: &ASTNode,
...
pub(super) fn extract_var_candidate(expr: &ASTNode) -> Option<String> {
    match expr {
...
pub(super) fn is_supported_comparison_operator(operator: &BinaryOperator) -> bool {
    matches!(
        operator,
        BinaryOperator::Less
