...
pub(in crate::mir::builder) fn lower_loop_scan_methods_block_nested_segment(
    builder: &mut MirBuilder,
    current_bindings: &mut BTreeMap<String, crate::mir::ValueId>,
...
mod tests {
    ...
    #[test]
    fn loop_scan_methods_block_nested_segment_rejects_when_stmt_only_and_fallback_miss() {
        ...
        let err = lower_loop_scan_methods_block_nested_segment(
            &mut builder,
