...
pub(in crate::mir::builder) fn try_lower_loop_scan_methods_block_nested_stmt_only(
    builder: &mut MirBuilder,
    current_bindings: &mut BTreeMap<String, crate::mir::ValueId>,
...
mod tests {
    ...
    #[test]
    fn loop_scan_methods_block_nested_stmt_only_returns_none_without_stmt_only_recipe() {
        ...
        let result = try_lower_loop_scan_methods_block_nested_stmt_only(
            &mut builder,
