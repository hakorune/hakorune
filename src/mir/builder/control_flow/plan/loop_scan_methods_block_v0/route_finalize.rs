...
pub(in crate::mir::builder) struct LoopScanMethodsBlockRouteFinalize {
    pub phis: Vec<CorePhiInfo>,
    pub final_values: Vec<(String, ValueId)>,
}

pub(in crate::mir::builder) fn finalize_loop_scan_methods_block_route(
...
) -> Result<LoopScanMethodsBlockRouteFinalize, String> {
    ...
    Ok(LoopScanMethodsBlockRouteFinalize { phis, final_values })
}
