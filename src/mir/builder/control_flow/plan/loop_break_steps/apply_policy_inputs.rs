use crate::mir::builder::control_flow::plan::loop_break_policy_router::LoopBreakPolicyRouting;
...
pub(super) fn build_loop_break_prep_inputs(
    facts: LoopBreakPrepFacts,
    policy: LoopBreakPolicyRouting,
) -> LoopBreakPrepInputs {
    LoopBreakPrepInputs {
