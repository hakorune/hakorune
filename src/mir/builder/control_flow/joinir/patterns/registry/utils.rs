...
pub(crate) fn emit_planner_first(mode: PlannerFirstMode, env: &RouterEnv, rule: PlanRuleId) {
    ...
    if emit {
        let msg = crate::mir::builder::control_flow::plan::planner::tags::planner_first_tag_with_label(rule);
...
pub(crate) fn pattern2_break_needs_flowbox_adopt_tag_in_strict(
    facts: &crate::mir::builder::control_flow::plan::facts::pattern2_break_types::Pattern2BreakFacts,
) -> bool {
