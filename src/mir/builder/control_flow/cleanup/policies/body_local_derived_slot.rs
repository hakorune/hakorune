//! Body-local derived-slot detection helper.
//!
//! Detects the minimal per-iteration Select-style slot shape for a single
//! body-local variable used in loop conditions.
