...
use crate::mir::resolved_semantics::{
    ...
    ScriptRootSemanticDispositionV1, ScriptTransferredBoundaryV1, SourceBindingSiteV1,
...
pub(super) struct VerifiedScriptOutboxMaterializationV1 {
    pub(super) site: SourceStmtSiteV1,
    pub(super) bindings: Box<[BindingRefV1]>,
}
...
pub(super) struct VerifiedScriptExistingDiagnosticBoundaryV1 {
    pub(super) site: SourceStmtSiteV1,
    pub(super) boundary: ScriptDiagnosticBoundaryV1,
}
...
impl ScriptBoundaryReceiptPackV1 {
    ...
    pub(super) fn existing_diagnostic_boundaries(
        &self,
    ) -> &[VerifiedScriptExistingDiagnosticBoundaryV1] {
