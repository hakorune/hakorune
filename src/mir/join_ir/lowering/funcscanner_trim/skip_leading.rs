//! Route-local `skip_leading` JoinIR function builder for trim lowering.

use crate::mir::join_ir::lowering::common::string_whitespace::{
    append_string_whitespace_predicate, WhitespacePredicateIds,
};
use crate::mir::join_ir::{
    BinOpKind, CompareOp, ConstValue, JoinFuncId, JoinFunction, JoinInst, MirLikeInst,
};
use crate::mir::ValueId;

pub(super) fn build_skip_leading_function(
    skip_leading_id: JoinFuncId,
