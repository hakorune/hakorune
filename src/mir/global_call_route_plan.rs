...
mod same_module_static_helper_contract;
mod shape_blocker;
...
use same_module_static_helper_contract::{
    infer_same_module_static_helper_return_contract, same_module_static_helper_contract_allowed,
};
