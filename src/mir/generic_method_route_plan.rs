...
fn match_generic_get_route(
    ...
    if let Some(result) = *dst {
        ...
        if let Some(route) = match_mir_json_const_value_field_get_route(
            function,
            def_map,
            block,
            instruction_index,
        ...
        if let Some(route) = match_mir_json_vid_array_item_get_route(
            function,
            def_map,
            block,
            instruction_index,
        ...
        if let Some(route) = match_mir_json_block_inst_array_item_get_route(
            function,
            def_map,
            block,
            instruction_index,
        ...
        if let Some(route) = match_mir_json_function_block_array_item_get_route(
            function,
            def_map,
            block,
            instruction_index,
        ...
        if let Some(route) = match_mir_json_module_function_array_item_get_route(
            function,
            def_map,
            block,
            instruction_index,
        ...
        if let Some(route) = match_mir_json_params_array_item_get_route(
            function,
            def_map,
            block,
            instruction_index,
        ...
        if let Some(route) = match_mir_json_flags_rec_access_get_route(
            function,
            def_map,
            block,
            instruction_index,
        ...
        if let Some(route) = match_mir_json_function_field_get_route(
            function,
            def_map,
            block,
            instruction_index,
        ...
        if let Some(route) = match_mir_json_module_field_get_route(
            function,
            def_map,
            block,
            instruction_index,
