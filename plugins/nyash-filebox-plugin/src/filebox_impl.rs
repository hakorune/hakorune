...
pub extern "C" fn filebox_resolve(name: *const c_char) -> u32 {
    ...
    match s.as_ref() {
        ...
        "open" => METHOD_OPEN,
        "read" => METHOD_READ,
        "readBytes" => METHOD_READ_BYTES,
        "write" => METHOD_WRITE,
        "writeBytes" => METHOD_WRITE_BYTES,
        "close" => METHOD_CLOSE,
...
pub extern "C" fn filebox_invoke_id(
    ...
    unsafe {
        match method_id {
            ...
            METHOD_READ_BYTES => handle_read(instance_id, args, args_len, result, result_len),
            METHOD_WRITE => handle_write(instance_id, args, args_len, result, result_len),
            METHOD_WRITE_BYTES => handle_write(instance_id, args, args_len, result, result_len),
