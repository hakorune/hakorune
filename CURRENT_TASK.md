...
2. `docs/development/current/main/phases/phase-296x/296x-699-MIMALLOC-BODY-TIMING-CFG-STABLE-RECEIVER-REWRITE-CLOSEOUT-001.md`
...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `MIMALLOC-BODY-TIMING-CFG-STABLE-RECEIVER-REWRITE-CLOSEOUT-001`; exact resident kernels no
  ...
  the next step closes this receiver operand copy-chain owner
