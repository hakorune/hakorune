...
- resume point: continue Phase 293x with `MIMAP-257A`,
  the segment arena backing modeled arena slot diagnostics selected by MIMAP-256A.
...
- next 293x order:
  1. `MIMAP-257A`: add observer-only diagnostics for modeled arena-slot
     inventory
