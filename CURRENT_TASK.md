...
- resume point: continue Phase 293x with `MIMAP-169A`,
  the post-segment-map-modeled-consume-ledger-released-span-observation
  planning row selected by MIMAP-168A.
...
- next 293x order:
  1. `MIMAP-169A`: choose the next narrow row after segment-map modeled
