...
- resume point: continue Phase 293x after `MIMAP-076A`; the next selected
  blocker is `MIMAP-077A`, the reclaim scheduler scalar lane closeout guard.
...
- next 293x order:
  1. `MIMAP-077A`: close out the scheduler scalar lane with a guard
