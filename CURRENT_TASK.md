...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `PAGE-HOTPATH-HELPER-RESULT-COPY-CHAIN-NARROWING-GUARD-SURFACE-001`; exact resident kernels no
  ...
  terminal consumer rewrite, and the next step is the guard surface before
  implementation
