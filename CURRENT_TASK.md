...
`CURRENT_STATE.toml`. D0, CONTRACT0, ENTRY-SELECTION0, and SOURCE-ENTRY0 are closed; the next exact task is
the disconnected `ENTRY-RESULT-PROJECTION0-PHYSICAL-THUNK0` slice. Do not infer implementation authority from Legacy
