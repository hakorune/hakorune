...
- resume point: continue Phase 293x after MIMAP-006; next blocker is
  MIMAP-007 size-class / bin map executable pilot. Keep LoopRange on the Stage1 route; do not source-desugar range loops.
