...
2. `docs/development/current/main/phases/phase-296x/296x-1100-BUILD-MIR-JSON-EMIT-BOUNDARY-SSOT-001.md`
3. `docs/development/current/main/phases/phase-296x/296x-1099-BUILD-MIR-JSON-EMIT-CRATE-PREFLIGHT-001.md`
4. `docs/development/current/main/phases/phase-296x/296x-1098-BUILD-BACKEND-CRATE-PREFLIGHT-001.md`
...
- active work has moved from exact-AOT fastpath optimization pause into
  ...
  is `BUILD-MIR-JSON-EXPORT-MODEL-SCAFFOLD-001`.
