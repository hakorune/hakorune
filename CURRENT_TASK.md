...
2. `docs/development/current/main/phases/phase-296x/296x-1300-COREPLAN-SCAN-METHODS-NESTED-LOOP-DEPTH1-NO-BREAK-OR-CONTINUE-PURE-OWNER-SELECTION-001.md`
...
- active work has moved from exact-AOT fastpath optimization pause into
  ...
  implementation moves require a new design row. The post-split cold release
  build measured real=157.63s with no build-time winner claim. The next
  blocker is `BUILD-CRATE-SPLIT-NEXT-BOUNDARY-SELECTION-001`.
