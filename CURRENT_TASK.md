...
- resume point: clean loop-if-exit route-decline wording without changing
...
- next: normalized-shadow loop-if-exit route-decline wording cleanup
...
- latest cleanup card: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- latest checkpoint: `291x-430`; detailed landed history lives in phase card
