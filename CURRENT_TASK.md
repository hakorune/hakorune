...
- Exact focus: `array_core_box.hako` / `array_state_core_box.hako` を authority owner として実装側に寄せ、`array_runtime_facade.rs` を forwarding core に固定し、historical alias は `array_runtime_aliases.rs` に隔離する
