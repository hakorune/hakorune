...
`CURRENT_STATE.toml`. D0, CONTRACT0, ENTRY-SELECTION0, SOURCE-ENTRY0, PHYSICAL-THUNK0, VM-REFERENCE0, EXE-AOT0, S1 projection consume, S2 VM-reference consume, S3 ENTRY-CARRY0, S3-EXECUTION0, and S3-OWNER0 are closed; the next exact frontier is
`ENTRY-RESULT-PROJECTION0-S3-PARITY0`. Do not infer implementation authority from Legacy
