...
22. `phase-100 Pinned Read-Only Captures` (active)

## Current Front

- Active lane: `phase-100 Pinned Read-Only Captures`
- Active micro: `loop outer read-only locals を pinned capture として loop body receiver 解決に通す`
- Current blocker: `none`
- Exact focus: `Pinned local capture を explicit/pinned に切り分け、receiver search order を固定する`
