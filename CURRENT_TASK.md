...
- current allocator/provider ladder:
  `docs/development/current/main/design/allocator-provider-current-task-breakdown-ssot.md`
  (closed through M96; next safe row is M97 selection decision CLI surface)
- detailed landed history: phase-291x card files and
  `docs/development/current/main/CURRENT_STATE.toml`
- next: continue after M96 selection decision diagnostic report; M92 names
  ...
  adds the inactive selection decision runtime report, and active registry
