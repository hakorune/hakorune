...
- current blocker token:
  `M193 purge/decommit dry-run observer`
...
- resume point: continue Phase 293x from M193. C207 emits
  ...
  and M192 adds a read-only purge/decommit policy inventory with OSVM
  execution inactive.
