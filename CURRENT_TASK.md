...
- resume point: continue Phase 293x after MIMAP-002; next blocker is
  MIMAP-003 lifecycle rewrite blueprint. Keep LoopRange on the Stage1 route; do not source-desugar range loops.
