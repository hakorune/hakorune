...
27. `phase-110x selfhost execution vocabulary SSOT` (active)

## Current Front

- Active lane: `phase-110x selfhost execution vocabulary SSOT`
- Active micro: `stage / route / backend override / lane / kernel を 1 枚 SSOT で固定する`
- Current blocker: `none`
- Exact focus: `run.sh --runtime --runtime-mode exe` と `hakorune --backend vm` の層差を route map で固定する`
