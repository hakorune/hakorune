...
11. 次の主戦場は de-rust residue（plugin kernel + plugin_loader_v2）とし、`29cc-221` の順序で `1 commit = 1 boundary` で route cutover を進める（A1-min1/A1-min2/A2-min1/A2-min2/A3-min1/A3-min2/A3-min3 done / next A3-min4: metadata/type route-aware縮退）。
