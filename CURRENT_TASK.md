...
- resume point: inventory stale loop-update docs/comments after helper split;
...
- next: JoinIR loop-update stale docs/comments inventory; do not mix with
  behavior changes
...
- latest cleanup card: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- latest checkpoint: `291x-332`; detailed landed history lives in phase card
