...
`CURRENT_STATE.toml`. D0, CONTRACT0, ENTRY-SELECTION0, SOURCE-ENTRY0, PHYSICAL-THUNK0, VM-REFERENCE0, EXE-AOT0, and S1 projection consume are closed; S2 selected one disconnected VM-reference carrier and the next exact subrow is
`ENTRY-RESULT-PROJECTION0-S2-FAULT-STATUS0`. Do not infer implementation authority from Legacy
