...
- latest known checkpoint: `291x-466` closes the `GenericMethodRoute`
  constructor SSOT lane
...
- latest cleanup card: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- latest checkpoint: `291x-466`; detailed landed history lives in phase card
