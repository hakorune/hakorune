...
- current BoxShape sidecar:
  ...
  `SELFHOST-PROGRESS-001`, and `MIR-EMIT-SSOT-002` landed; `MIMAP-036A`
  landed the post-huge-unreserve closeout guard;
...
- resume point: continue Phase 293x after `MIMAP-036A`; current blocker is
  `MIMAP-036B`, a post-huge-unreserve-closeout row selection. It must choose
...
- next 293x order:
  1. `MIMAP-036B`: post-huge-unreserve-closeout row selection
  2. selected next row after `MIMAP-036B`
