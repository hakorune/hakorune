...
21. `docs/development/current/main/phases/phase-292x/292x-118-generic-pure-walker-view-extraction-card.md`
22. `docs/development/current/main/phases/phase-292x/292x-117-generic-pure-walker-residual-debt-card.md`
23. `docs/development/current/main/phases/phase-292x/292x-116-pure-compile-minimal-string-const-eval-card.md`
24. `docs/development/current/main/phases/phase-292x/292x-115-pure-compile-minimal-map-array-deletion-card.md`
25. `docs/development/current/main/phases/phase-292x/292x-112-pure-compile-minimal-ret-branch-deletion-card.md`
26. `docs/development/current/main/phases/phase-292x/292x-114-hako-ll-stack-overflow-predelete-card.md`
27. `docs/development/current/main/phases/phase-292x/292x-113-mapbox-duplicate-receiver-unified-dispatch-card.md`
28. `docs/development/current/main/phases/phase-292x/292x-111-pure-compile-minimal-paths-inventory-card.md`
29. `docs/development/current/main/phases/phase-292x/292x-110-array-getset-micro-seed-route-card.md`
...
31. `docs/development/current/main/phases/phase-292x/292x-95-array-string-len-keep-live-route-card.md`
32. `docs/development/current/main/phases/phase-292x/292x-96-array-string-len-source-only-route-card.md`
33. `docs/development/current/main/phases/phase-292x/292x-97-array-string-len-c-analyzer-deletion-card.md`
34. `docs/development/current/main/phases/phase-292x/292x-98-array-rmw-c-analyzer-deletion-card.md`
35. `docs/development/current/main/phases/phase-292x/292x-99-string-direct-set-window-metadata-card.md`
36. `docs/development/current/main/phases/phase-292x/292x-100-generic-method-route-policy-metadata-card.md`
...
43. `docs/development/current/main/phases/phase-291x/291x-99-mapbox-write-return-contract-card.md`
44. `docs/development/current/main/phases/phase-291x/291x-100-mapbox-bad-key-contract-card.md`
45. `docs/development/current/main/phases/phase-291x/291x-104-mapbox-delete-remove-router-card.md`
46. `docs/development/current/main/phases/phase-291x/291x-105-mapbox-clear-router-card.md`
47. `docs/development/current/main/phases/phase-291x/291x-106-arraybox-element-result-publication-card.md`
48. `docs/development/current/main/phases/phase-291x/291x-113-arraybox-contains-router-card.md`
49. `docs/development/current/main/phases/phase-291x/291x-114-arraybox-indexof-router-card.md`
50. `docs/development/current/main/phases/phase-291x/291x-115-arraybox-join-router-card.md`
51. `docs/development/current/main/phases/phase-291x/291x-116-arraybox-reverse-router-card.md`
52. `docs/development/current/main/phases/phase-291x/291x-117-arraybox-sort-router-card.md`
53. `docs/development/current/main/phases/phase-291x/291x-118-arraybox-slice-result-receiver-card.md`
54. `docs/development/current/main/phases/phase-291x/291x-119-docs-status-closeout-card.md`
55. `docs/development/current/main/phases/phase-291x/291x-120-mapbox-taskboard-closeout-card.md`
...
44. `docs/development/current/main/design/kernel-observability-and-two-stage-pilot-ssot.md`
45. `docs/development/current/main/design/runtime-hot-lane-optimization-patterns-ssot.md`
46. `docs/development/current/main/design/perf-owner-first-optimization-ssot.md` (`137x-H` owner-first optimization に戻るとき)
47. `docs/development/current/main/design/string-hot-corridor-runtime-carrier-ssot.md`
48. `docs/development/current/main/design/string-value-model-phased-rollout-ssot.md`
49. `docs/development/current/main/phases/phase-137x/phase137x-text-lane-rollout-checklist.md`
50. `docs/development/current/main/design/string-canonical-mir-corridor-and-placement-pass-ssot.md`
51. `docs/development/current/main/design/string-birth-sink-ssot.md`
52. `docs/development/current/main/15-Workstream-Map.md`
53. `git status -sb`
54. `tools/checks/dev_gate.sh quick`
55. `docs/development/current/main/phases/phase-29bq/29bq-90-selfhost-checklist.md` (`phase-29bq` に戻るときだけ)
...
- expected worktree:
  ...
  - current app slice:
    ...
    - phase-291x CoreBox surface catalog is the active implementation lane
  ...
  - current phase goal:
    ...
    - `StringBox.lastIndexOf(needle, start_pos)` is landed through the
      ...
      smoke
    - `MapBox.delete(key)` / `remove(key)` router promotion is landed through
      the catalog-backed Unified value path and pinned by the 291x-104
      acceptance tests
    - `MapBox.clear()` router promotion is landed through the catalog-backed
      Unified value path and pinned by the 291x-105 acceptance tests
    ...
    - `291x-112` landed: `ArrayBox.clear()` is now catalog-backed, uses the
      Unified receiver-only path, and publishes `Void` like `push` / `set` /
      `insert`
    - `291x-113` landed: `ArrayBox.contains(value)` is now catalog-backed,
      uses the Unified receiver-plus-value path, and publishes `Bool`
    - `291x-114` landed: `ArrayBox.indexOf(value)` is now catalog-backed,
      uses the Unified receiver-plus-value path, and publishes `Integer`
    - `291x-115` landed: `ArrayBox.join(delimiter)` is now catalog-backed,
      uses the Unified receiver-plus-delimiter path, and publishes `String`
    ...
    - `291x-119` landed: phase-291x stale Active/Deferred/status wording is
      closed as docs-only BoxShape cleanup; no CoreBox behavior changed
