...
28. `phase-111x selfhost runtime route naming cleanup` (active)

## Current Front

- Active lane: `phase-111x selfhost runtime route naming cleanup`
- Active micro: `--runtime-route mainline|compat` を public surface に足し、--runtime-mode を compatibility alias に落とす`
- Current blocker: `none`
- Exact focus: `run.sh` / `selfhost_run_routes.sh` / docs 上の route naming を canonical route 読みに寄せる`
