...
30. `phase-113x kernel vs vm-reference cluster wording correction` (active)

## Current Front

- Active lane: `phase-113x kernel vs vm-reference cluster wording correction`
- Active micro: `nyash_kernel` だけを kernel と呼び、`lang/src/vm` を VM/reference cluster に固定する`
- Current blocker: `none`
- Exact focus: `crates/nyash_kernel/README.md` / `lang/src/vm/README.md` / execution SSOT の wording を current role に揃える`
