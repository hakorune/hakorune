...
2. `docs/development/current/main/phases/phase-296x/296x-705-MIMALLOC-RUNTIME-BOUNDARY-DIRECT-PROBE-001.md`
...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `MIMALLOC-RUNTIME-BOUNDARY-DIRECT-PROBE-001`; exact resident kernels no
  ...
  scaled the body timing repeat and selected runtime boundary direct probe
...
- optimization resumed through `MIMALLOC-AOT-KERNEL-FRONT-SELECT-002`,
  ...
  `MIMALLOC-BODY-TIMER-ALIGNMENT-PROBE-001`, and now continues at
