...
- resume point: continue Phase 293x after `VMHAKO-EXTERN-SPEC-001`; current blocker is
  `VMHAKO-EXTERN-SPEC-002`, a post-subset-validator row selection. VM-LIM-001
...
- next 293x order:
  1. `VMHAKO-EXTERN-SPEC-002`: post-subset-validator row selection
  2. selected next row after `VMHAKO-EXTERN-SPEC-002`
