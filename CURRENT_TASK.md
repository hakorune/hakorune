...
2. `docs/development/current/main/phases/phase-296x/296x-703-MIMALLOC-RUNTIME-BOUNDARY-INVENTORY-001.md`
...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `MIMALLOC-RUNTIME-BOUNDARY-INVENTORY-001`; exact resident kernels no
  ...
  selected no implementation owner because confidence remains low
