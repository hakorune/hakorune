...
2. `docs/development/current/main/phases/phase-296x/296x-686-CALL-OPERAND-MATERIALIZATION-FORWARDING-GUARD-SURFACE-001.md`
...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `CALL-OPERAND-MATERIALIZATION-FORWARDING-GUARD-SURFACE-001`; exact resident kernels no
  ...
  tiny `same_block_root_receiver_operand_forwarding` keeper; the next step
  fixes the post-implementation guard surface before code changes
