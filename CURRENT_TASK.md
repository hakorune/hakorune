...
`CURRENT_STATE.toml`. D0, CONTRACT0, ENTRY-SELECTION0, SOURCE-ENTRY0, PHYSICAL-THUNK0, VM-REFERENCE0, and EXE-AOT0 are closed; the next exact task is
the disconnected `ENTRY-RESULT-PROJECTION0-PARITY-G0` slice. Do not infer implementation authority from Legacy
