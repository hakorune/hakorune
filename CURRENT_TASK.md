...
47. `phase-130x vm public gate final cleanup` (active)

## Current Front

- Active lane: `phase-130x vm public gate final cleanup`
- Active micro: public `vm` gate の最終整理を source-backed に決める
...
- Exact focus: route-first wording は揃ったので、次は explicit legacy `vm` gate を最後まで孤立させるかを決める
...
1. `docs/development/current/main/05-Restart-Quick-Resume.md`
2. `docs/development/current/main/15-Workstream-Map.md`
3. `docs/development/current/main/phases/phase-129x/README.md`
...
- `phase-129x` now follows the remaining public `vm` gate / orchestrator surfaces.
