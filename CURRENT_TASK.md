...
- resume point: continue Phase 293x with `MIMAP-175A`,
  the post-segment-map-released-span-local-free-candidate-bridge-closeout
  planning row selected by MIMAP-174A.
...
- next 293x order:
  1. `MIMAP-175A`: choose the next narrow row after segment-map released-span
