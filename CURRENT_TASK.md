...
- second foundation owner is CorePlan / JoinIR expressivity: B1 remaining
  ...
  the C1 planner_required fail-fast, D1 normalizer AST-boundary, and E1 active-v0
  inventory guards are landed; next is `COREPLAN-E1-002` to retire exactly one
  v0 box with fixture/gate proof
