...
34. `phase-117x vm compat/proof env hardening` (active)

## Current Front

- Active lane: `phase-117x vm compat/proof env hardening`
- Active micro: `compat route が raw --backend vm に入る前に explicit env を要求する`
- Current blocker: `none`
- Exact focus: `selfhost_run_routes.sh` / `tools/selfhost/README.md` / execution SSOT で compat preflight を NYASH_VM_USE_FALLBACK=1 要求に固定する`
