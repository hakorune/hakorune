...
- resume point: continue Phase 293x after MIMAP-005B; next blocker is
  MIMAP-005C enum/transition lifecycle skeleton. Keep LoopRange on the Stage1 route; do not source-desugar range loops.
