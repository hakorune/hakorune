...
2. `docs/development/current/main/phases/phase-296x/296x-696-CALL-OPERAND-CFG-STABLE-RECEIVER-REWRITE-IMPLEMENTATION-001.md`
...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `CALL-OPERAND-CFG-STABLE-RECEIVER-REWRITE-IMPLEMENTATION-001`; exact resident kernels no
  ...
  CFG-stable owner; 296x-695 fixed the post target; the next step implements
  the narrow receiver rewrite
