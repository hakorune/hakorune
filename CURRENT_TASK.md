...
- current blocker token:
  `MIMAP-017B realloc grow / move route`
...
- resume point: continue Phase 293x after MIMAP-017A realloc shrink same-page
  route; next primary blocker is MIMAP-017B realloc grow / move route over the
