...
2. `docs/development/current/main/phases/phase-296x/296x-709-MIMALLOC-POST-ARRAY-LEN-HELPER-OWNER-REFRESH-001.md`
...
- optimization resumed through `MIMALLOC-AOT-KERNEL-FRONT-SELECT-002`,
  ...
  continues at `MIMALLOC-POST-ARRAY-LEN-HELPER-OWNER-REFRESH-001`;
