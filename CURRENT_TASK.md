...
- active semantic-structure follow-on:
  ...
  - phase-166x is active; the semantic refresh owner cut is landed, and the next order is `generic value_origin / phi_relation owner -> compat semantic recovery quarantine -> only then boundary/lifecycle extraction decision`
