...
23. `phase-102 real-app read_quoted loop regression (VM + LLVM EXE)` (active)

## Current Front

- Active lane: `phase-102 real-app read_quoted loop regression (VM + LLVM EXE)`
- Active micro: `MiniJsonLoader.read_quoted_from 最小抽出 fixture を VM/LLVM EXE parity で固定する`
- Current blocker: `none`
- Exact focus: `accumulator + escape + quote 終端を含む read_quoted loop を実アプリ由来 fixture で固定する`
...
1. `docs/development/current/main/05-Restart-Quick-Resume.md`
2. `docs/development/current/main/15-Workstream-Map.md`
3. `docs/development/current/main/phases/phase-102/README.md`
