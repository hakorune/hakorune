...
2. `docs/development/current/main/phases/phase-296x/296x-695-CALL-OPERAND-CFG-STABLE-RECEIVER-REWRITE-GUARD-SURFACE-001.md`
...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `CALL-OPERAND-CFG-STABLE-RECEIVER-REWRITE-GUARD-SURFACE-001`; exact resident kernels no
  ...
  CFG-stable owner; the next step fixes the post-implementation guard surface
