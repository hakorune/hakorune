...
- resume point: continue Phase 293x after `MIMAP-090A`; the next selected
  blocker is `MIMAP-091A`, segment allocation modeled consume route.
...
- next 293x order:
  1. `MIMAP-091A`: implement the modeled scalar consume route after accepted
