...
- split:
  ...
  - `backend-zero`: accepted pointer / `phase-29ck` queued
    ...
    - landed slice:
      ...
      - next B1 front is no longer “generic caller cutover”; it is pinned to `CodegenBridgeBox` temporary-bridge freeze and `lang/src/runner/launcher.hako` daily stop-point migration
