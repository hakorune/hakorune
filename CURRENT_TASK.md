...
36. `phase-119x vm debug/observability surface review` (active)

## Current Front

- Active lane: `phase-119x vm debug/observability surface review`
- Active micro: `vm-family debug/observability surface を keep-now と candidate-thin に分ける`
- Current blocker: `none`
- Exact focus: `phase29x` observability scripts と `bug_origin_triage.sh` を source-backed に見直し、live keep の役割を fixed buckets に落とす`
