...
- resume point: continue Phase 293x with `MIMAP-137A`, the planning-only row
...
- next 293x order:
  1. `MIMAP-137A`: select exactly one next allocator or compiler row after
     the local-free reuse ledger release closeout
