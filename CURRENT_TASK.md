...
- current blocker token:
  `M198 purge decommit state marker`
...
- resume point: continue Phase 293x from M198. C207 emits
  ...
  execution while keeping unreserve and OS release inactive, and M196 connects
  that bounded policy to the page-source decommit adapter only, and M197
  composes dry-run observation, bounded policy, and page-source adapter for heap
  page/backing state.
