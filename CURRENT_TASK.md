...
2. `docs/development/current/main/phases/phase-296x/296x-684-CALL-OPERAND-MATERIALIZATION-COPY-CHAIN-INVENTORY-001.md`
...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `CALL-OPERAND-MATERIALIZATION-COPY-CHAIN-INVENTORY-001`; exact resident kernels no
  ...
  296x-683 selected `call_operand_materialization_copy_chain_inventory`; the
  next step inventories that owner before any implementation attempt
