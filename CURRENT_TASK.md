...
current latest card is MIRBUILDER-GLOBAL-CALL-TARGET-SHAPE-LABEL-FORMATTER-HAKO-ADOPTION-DECISION-001
global_call_target_shape_label_formatter is HakoAdopted as the fiftieth parity pilot; next is pilot selection rerun 050
```
