...
31. `phase-114x execution surface wording closeout` (active)

## Current Front

- Active lane: `phase-114x execution surface wording closeout`
- Active micro: `mainline route と explicit keep/reference override を public/help surface で分離する`
- Current blocker: `none`
- Exact focus: `src/cli/args.rs` / `src/runner/dispatch.rs` / `README*` / `cli-hakorune-stage1.md` を route-first wording に揃える`
...
- `phase-114x` is closing out remaining public/help wording where raw `--backend vm` still looked like a normal execution route.
