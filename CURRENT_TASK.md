...
35. `phase-118x proof wrapper surface review` (active)

## Current Front

- Active lane: `phase-118x proof wrapper surface review`
- Active micro: `public proof surface と internal proof helper を分けて narrow keep に固定する`
- Current blocker: `none`
- Exact focus: `tools/selfhost/proof/*` のうち front-door に見せる surface を絞り、README/Makefile/route SSOT を追従させる`
