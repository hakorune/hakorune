...
- resume point: prune direct legacy type re-exports from
...
- next: JoinIR route detector direct legacy type export prune; keep module
  exports in the same card
...
- latest cleanup card: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- latest checkpoint: `291x-355`; detailed landed history lives in phase card
