...
2. `docs/development/current/main/phases/phase-296x/296x-1114-BUILD-MIR-JSON-DTO-SERIALIZER-CLOSEOUT-001.md`
3. `docs/development/current/main/phases/phase-296x/296x-1113-BUILD-MIR-JSON-DTO-SERIALIZER-RETURN-SWITCH-001.md`
4. `docs/development/current/main/phases/phase-296x/296x-1112-BUILD-MIR-JSON-DTO-SERIALIZER-PARITY-WIRING-001.md`
...
- active work has moved from exact-AOT fastpath optimization pause into
  ...
  serializer seam is closed, and the next blocker is
