...
20. `phase-98 Plugin loader fail-fast + LLVM parityの持続化` (active)

## Current Front

- Active lane: `phase-98 Plugin loader fail-fast + LLVM parityの持続化`
- Active micro: `plugin missing の fail-fast/best-effort 境界を固めつつ、phase-97 parity green を日常運用で維持する`
- Current blocker: `none`
- Exact focus: `plugin loader の strict fail-fast 契約を source と smoke で固定し、phase-97 LLVM EXE parity green を sustain する`
