...
- current blocker token:
  `GUARD-MANIFEST-008 final closeout wrapper selection`
...
- resume point: continue Phase 293x after `GUARD-MANIFEST-007`; the next
  selected blocker is `GUARD-MANIFEST-008`, the final closeout wrapper
  selection.
...
- next 293x order:
  1. `GUARD-MANIFEST-008`: select the final closeout wrapper migration or
