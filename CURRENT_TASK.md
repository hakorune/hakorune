...
- current allocator/provider ladder:
  `docs/development/current/main/design/allocator-provider-current-task-breakdown-ssot.md`
  (closed through M95; next safe row is M96 selection decision diagnostic report)
- detailed landed history: phase-291x card files and
  `docs/development/current/main/CURRENT_STATE.toml`
- next: continue after M95 activation diagnostic closeout inventory; M92 names
  ...
  report through an explicit TOML-path CLI, M95 fixes closeout coverage, and
  active registry construction, provider selection, proof consumption, rollback
