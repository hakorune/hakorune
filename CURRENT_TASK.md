...
53. `phase-76x next source lane selection` (active)
...
- Active lane: `phase-76x next source lane selection`
...
- Active next: `phase-76x next source lane selection`
- Current blocker: `none`
- Exact focus: `76xA1 successor lane inventory lock`
