...
- resume point: verify and prune zero-caller parent `trim_loop_helper`
...
- next: JoinIR route detector trim compatibility export prune
...
- latest cleanup card: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- latest checkpoint: `291x-374`; detailed landed history lives in phase card
