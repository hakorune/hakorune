...
2. `docs/development/current/main/phases/phase-296x/296x-685-CALL-OPERAND-MATERIALIZATION-FORWARDING-DESIGN-001.md`
...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `CALL-OPERAND-MATERIALIZATION-FORWARDING-DESIGN-001`; exact resident kernels no
  ...
  296x-684 inventoried 26 chains / 29 unique copies and selected
  `call_operand_materialization_forwarding_design`; the next step designs a
  narrow keeper before any implementation attempt
