...
40. `phase-63x rust-vm final retirement decision` (active)
...
- Active next: `phase-63x rust-vm final retirement decision`
- Current blocker: `none`
- Exact focus: `63xA1 retirement-decision evidence lock`
- exact handoff order:
  ...
  55. `63xA1` retirement-decision evidence lock (active)
  56. `63xA2` retire-vs-residual decision (planned)
  57. `63xB1` residual keep stop-line or retirement plan freeze (planned)
  58. `63xD1` proof / closeout (planned)
