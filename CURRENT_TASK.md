...
graph are complete. S2 has reached the explicit source-owner design stop
...
Do not invent a projection owner or implement the S2 manifest until this
consultation is resolved; runtime activation remains zero.
