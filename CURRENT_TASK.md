...
- resume point: continue Phase 293x with `MIMAP-258A`,
  the segment arena backing modeled arena slot closeout pack selected by
  MIMAP-257A.
...
- next 293x order:
  1. `MIMAP-258A`: close out the modeled arena-slot family with representative
