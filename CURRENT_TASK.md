...
- resume point: migrate `trim_loop_helper` callers to
...
- next: JoinIR route detector trim support family migration
...
- latest cleanup card: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- latest checkpoint: `291x-373`; detailed landed history lives in phase card
