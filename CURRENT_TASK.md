...
- resume point: continue Phase 293x after `MIMAP-116A`; the next selected
  blocker is `MIMAP-117A`, segment allocation modeled local-free page-apply
  closeout guard.
...
- next 293x order:
  1. `MIMAP-117A`: close out the page-model local-free apply seam with a
