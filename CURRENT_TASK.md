...
- latest known checkpoint: `291x-474` closes the `GenericMethodRoute`
  root re-export prune lane
...
- latest cleanup card: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- latest checkpoint: `291x-474`; detailed landed history lives in phase card
