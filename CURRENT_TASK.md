...
- latest known checkpoint: `291x-470` closes the `GenericMethodRoute`
  component field privacy lane
...
- latest cleanup card: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- latest checkpoint: `291x-470`; detailed landed history lives in phase card
