...
- resume point: continue Phase 293x from M201. C207 emits
  ...
  page-source execution, and M200 classifies decommitted pages as unavailable
  until a future recommit path exists.
