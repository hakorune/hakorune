...
29. `phase-112x vm-family lane naming hardening` (active)

## Current Front

- Active lane: `phase-112x vm-family lane naming hardening`
- Active micro: `backend family=vm` と internal lane を `rust-vm-keep / vm-hako-reference / vm-compat-fallback` に揃える`
- Current blocker: `none`
- Exact focus: `route_orchestrator.rs` / `dispatch.rs` / observability smokes の lane labels を canonical 名に揃える`
