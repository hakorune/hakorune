...
- current blocker token: `phase-291x CoreMethod mirror-pruning preflight pending`
- primary mode: compiler cleanup lane
- phase-137x: observe-only unless app work reopens a real blocker

## Next

- inventory CoreMethod mirror-pruning readiness before deleting `.inc` mirror rows
