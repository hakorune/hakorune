...
`CURRENT_STATE.toml`. D0, CONTRACT0, and ENTRY-SELECTION0 are closed; the next exact task is
the disconnected `ENTRY-RESULT-PROJECTION0-SOURCE-ENTRY0` slice. Do not infer implementation authority from Legacy
