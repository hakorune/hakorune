...
44. `phase-67x selfhost folder split` (active)
...
- Active next: `phase-67x selfhost folder split`
- Current blocker: `none`
- Exact focus: `67xA1 selfhost folder inventory lock`
...
- exact handoff order:
  ...
  69. `67xA1` selfhost folder inventory lock (active)
  70. `67xA2` target layout ranking (planned)
  71. `67xB1` top-level selfhost split (planned)
  72. `67xD1` proof / closeout (planned)
