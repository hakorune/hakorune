...
- resume point: continue Phase 293x with `MIMAP-191A`,
  the post-segment-map-local-free-reuse-bridge-closeout planning row selected
  by MIMAP-190A.
...
- next 293x order:
  1. `MIMAP-191A`: choose the next narrow row after segment-map local-free
