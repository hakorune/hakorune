...
- resume point: continue Phase 293x after RESULT-002C; next blocker is
  RESULT-002D generic enum expected-type diagnostics. Keep LOOP-003 open until a
...
- next 293x order:
  RESULT-002D generic enum expected-type diagnostics
  GUARDLET-001 guard-let pattern sugar
