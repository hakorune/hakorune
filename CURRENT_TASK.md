...
33. `phase-116x execution surface alias pruning` (active)

## Current Front

- Active lane: `phase-116x execution surface alias pruning`
- Active micro: `naked stage-a alias を削り、compat surface を route/mode の二段に揃える`
- Current blocker: `none`
- Exact focus: `run.sh` / `selfhost_run_routes.sh` / `tools/selfhost/README.md` / execution SSOT から `stage-a` thin alias を落とす`
