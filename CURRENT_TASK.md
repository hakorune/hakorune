...
- resume point: continue Phase 293x after MIMAP-007; next blocker is
  MIMAP-008 page/free-list model pilot. Keep LoopRange on the Stage1 route; do not source-desugar range loops.
