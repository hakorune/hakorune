...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `POST-CALL-OPERAND-MATERIALIZATION-FORWARDING-OWNER-REFRESH-001`; exact resident kernels no
  ...
  family; 296x-688 measured no body-time win; the next step refreshes the owner
