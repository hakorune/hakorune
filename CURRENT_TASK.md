...
- resume point: continue Phase 293x with `MIMAP-264A`,
  the segment arena backing modeled source accounting inventory selected by
  MIMAP-263A.
...
- next 293x order:
  1. `MIMAP-264A`: add scalar/model source-backed arena accounting after
