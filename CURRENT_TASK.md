...
- current blocker token:
  `GUARD-MANIFEST-009 final closeout thin wrappers`
...
- resume point: continue Phase 293x after `GUARD-MANIFEST-008`; the next
  selected blocker is `GUARD-MANIFEST-009`, the final closeout thin-wrapper
  implementation.
...
- next 293x order:
  1. `GUARD-MANIFEST-009`: move the final public hako_alloc closeout wrappers
