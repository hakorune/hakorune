...
- latest known checkpoint: `291x-458` closes the
  `GenericMethodRouteEvidence` split lane
...
- next: select the next compiler-cleanliness lane
...
- latest cleanup card: read `latest_card_path` in
  `docs/development/current/main/CURRENT_STATE.toml`
- latest checkpoint: `291x-458`; detailed landed history lives in phase card
