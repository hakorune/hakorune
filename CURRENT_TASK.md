...
`CURRENT_STATE.toml`. D0 and CONTRACT0 are closed; the next exact task is
the disconnected `ENTRY-RESULT-PROJECTION0-ENTRY-SELECTION0` slice. Do not infer implementation authority from Legacy
