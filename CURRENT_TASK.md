...
2. `docs/development/current/main/phases/phase-296x/296x-706-MIMALLOC-DIRECT-ARRAY-LENGTH-BOUNDARY-DESIGN-001.md`
...
- active work has moved from boot-amortized exact-kernel selection through
  ...
  `MIMALLOC-DIRECT-ARRAY-LENGTH-BOUNDARY-DESIGN-001`; exact resident kernels no
...
- optimization resumed through `MIMALLOC-AOT-KERNEL-FRONT-SELECT-002`,
  ...
  `MIMALLOC-RUNTIME-BOUNDARY-DIRECT-PROBE-001`, and now continues at
