...
- resume point: continue Phase 293x with `MIMAP-260A`,
  the segment arena backing modeled source bridge inventory selected by
  MIMAP-259A.
...
- next 293x order:
  1. `MIMAP-260A`: add the modeled source bridge inventory after modeled
     arena-slot closeout
