 ...
 * - Call(Method getField): Field reading from Box objects
 * - Call(Method setField): Field writing to Box objects
...
fn build_refget_refset_mir_module() -> MirModule {
    ...
    let field_value = ValueId::new(5); // "value"
    ...
    block.add_instruction(MirInstruction::Call {
        ...
        callee: Some(Callee::Method {
            ...
            receiver: Some(ref_ptr),
            certainty: TypeCertainty::Known,
            box_kind: CalleeBoxKind::RuntimeData,
        }),
        args: vec![field_value, new_val],
...
fn build_complete_workflow_mir_module() -> MirModule {
    ...
    let field_value = ValueId::new(10); // "value"
