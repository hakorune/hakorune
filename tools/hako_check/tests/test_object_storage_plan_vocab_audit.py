...
class ObjectStoragePlanVocabAuditTest(unittest.TestCase):
    def test_reports_keep_and_merge_candidates_without_merging(self) -> None:
        ...
        self.assertEqual(rows["fastpath_deny_owner_code_retired"], "1")
        self.assertEqual(rows["fastpath_deny_owner_source_presence_count"], "0")
        self.assertEqual(rows["fastpath_deny_owner_mapping_owner"], "docs_report")
