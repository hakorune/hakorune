...
def build_source_inventory(root: Any, input_kind: str) -> dict[str, Any]:
    ...
    source_dedicated_lowerer_enabled = int(region_count > 0)
    report.update(
        {
...
def base_inventory(input_kind: str) -> dict[str, Any]:
    return {
        ...
        "fastmem_free_head_push_plan_count": 0,
        "fastmem_free_head_pop_plan_count": 0,
        "fastmem_free_head_nonlowerable_count": 0,
        "fastmem_free_head_push_lowerable_count": 0,
        ...
        **{f"typed_page_meta_field_{field}": 0 for field in PAGE_META_FIELDS},
        ...
        "atomic_remote_head_drain_exchange_selected": 0,
        ...
        "drain_remote_list_to_local_plan_count": 0,
        "drain_remote_list_to_local_token_provenance_valid": 0,
        "drain_remote_list_to_local_page_operand_valid": 0,
