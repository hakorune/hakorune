...
Rationale: Python llvmlite remains an explicit compat/probe keep lane. The daily MIR(JSON)->obj/exe backend moved to ny-llvmc, and the old Rust backend was archived as part of the De-Rust Phase-0.
EOF
