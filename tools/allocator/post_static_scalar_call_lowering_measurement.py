#!/usr/bin/env python3
"""Measure exact-EXE after static-scalar call lowering."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_static_scalar_lowering.") as tmp:
        tmp_dir = Path(tmp)
    ...
    lines.extend(
        [
            ...
            f"static_scalar_lowering_effect={classify_effect(after_median)}",
            "winner_claim=0",
