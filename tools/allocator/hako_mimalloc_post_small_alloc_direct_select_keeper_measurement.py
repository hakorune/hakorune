#!/usr/bin/env python3
"""Measure the object-lifecycle EXE after the small-alloc direct select keeper."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_small_alloc_direct_select.") as tmp:
        tmp_dir = Path(tmp)
