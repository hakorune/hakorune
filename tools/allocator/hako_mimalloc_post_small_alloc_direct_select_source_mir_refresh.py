#!/usr/bin/env python3
"""Refresh hot-owner selection after the small-alloc direct select keeper."""
...
def main() -> int:
    ...
    require(
        measurement,
        "output_contract",
        "hako-mimalloc-post-small-alloc-direct-select-keeper-measurement-v0",
        "measurement",
    )
    ...
    if selected.source_method == "objectLifecycleSmallAlloc":
