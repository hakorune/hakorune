#!/usr/bin/env python3
"""Measure the object-lifecycle EXE after rolling back inline success result."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_rollback_inline_success.") as tmp:
        tmp_dir = Path(tmp)
