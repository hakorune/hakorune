#!/usr/bin/env python3
"""Measure the object-lifecycle EXE after rolling back the active field fast path."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_rollback_active_field.") as tmp:
        tmp_dir = Path(tmp)
