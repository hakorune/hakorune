#!/usr/bin/env python3
"""Close out the MIR builder env method single-eval owner fix."""
...
def main() -> int:
    ...
    require(values, "output_contract", "mir-builder-env-method-single-eval-fixture-v0")
    require(values, "fixture", "env_method_single_eval")
