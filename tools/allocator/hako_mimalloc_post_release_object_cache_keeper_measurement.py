#!/usr/bin/env python3
"""Measure the object-lifecycle EXE after the release object cache keeper."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_release_object_cache_keeper.") as tmp:
        tmp_dir = Path(tmp)
    ...
    lines.extend(
        [
            ...
            "previous_keeper=small_alloc_selected_page_cache_reuse",
            "winner_claim=0",
