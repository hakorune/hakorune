#!/usr/bin/env python3
"""Measure the object-lifecycle small-block EXE after the selectPage keeper."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_select_page_keeper.") as tmp:
        tmp_dir = Path(tmp)
