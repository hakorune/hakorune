#!/usr/bin/env python3
"""Measure the object-lifecycle EXE after the select first-page cache keeper."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_select_first_page_cache_keeper.") as tmp:
        tmp_dir = Path(tmp)
