#!/usr/bin/env python3
"""Measure the object-lifecycle EXE after the active field fast path keeper."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_active_field_fast_path_keeper.") as tmp:
        tmp_dir = Path(tmp)
