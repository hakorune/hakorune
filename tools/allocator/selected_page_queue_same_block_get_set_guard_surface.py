#!/usr/bin/env python3
"""Freeze selected page-queue same-block field get/add/set fusion candidates."""
...
TARGET_PREFIX = "HakoAllocObjectLifecyclePageQueue."
...
def main() -> int:
    ...
    require(owner, "output_contract", "page-queue-field-owner-selection-v0")
    require(owner, "selected_owner", "selected_page_queue_same_block_get_set_fusion")
