#!/usr/bin/env python3
"""Refresh collection-method direct-array ownership after the retirement smoke."""
...
def classify(rows: list[tuple[str, float]]) -> dict[str, str]:
    ...
    if dominates:
        ...
        selected_boundary = "collection_method_call_direct_array_lane_post_retirement_perf_owner_refresh"
        next_diagnostic = "collection_method_call_direct_array_lane_post_retirement_perf_owner_refresh"
    ...
    return {
        ...
        "array_repr_design_open": array_repr_design_open,
