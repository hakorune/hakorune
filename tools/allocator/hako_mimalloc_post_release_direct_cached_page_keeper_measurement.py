#!/usr/bin/env python3
"""Measure the object-lifecycle EXE after the release direct cached-page keeper."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_release_direct_cached_page_keeper.") as tmp:
        tmp_dir = Path(tmp)
    ...
    lines.extend(
        [
            ...
            "previous_keeper=release_known_page_object_cache",
            "winner_claim=0",
