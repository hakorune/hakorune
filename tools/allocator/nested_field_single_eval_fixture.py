#!/usr/bin/env python3
"""Report nested field single-evaluation fixture MIR call counts."""
...
DEFAULT_METHOD = "NestedFieldProbe.run/0"
DEFAULT_NESTED_SYMBOL = "NestedFieldSide.make/0"
...
def main() -> int:
    ...
    selected_next = (
        "mir_builder_nested_field_single_eval_owner_fix"
        if actual != 1
        else "single_eval_surface_sweep"
    )
