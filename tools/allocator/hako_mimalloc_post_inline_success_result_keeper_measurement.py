#!/usr/bin/env python3
"""Measure the object-lifecycle EXE after the inline success result keeper."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_inline_success_result.") as tmp:
        tmp_dir = Path(tmp)
