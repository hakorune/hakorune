#!/usr/bin/env python3
"""Refresh the DirectI64 ArrayRepr perf owner after the rebase smoke."""
...
def classify(rows: list[tuple[str, float]]) -> dict[str, str]:
    ...
    if dominates:
        selected_boundary = "directarray_family_optional_next_member_selection"
        next_diagnostic = "directarray_family_optional_next_member_selection"
        selected_next = "directarray_family_optional_next_member_selection"
        selected_reason = "direct_array_path_still_dominant_after_arrayrepr_rebase_smoke"
        optional_next_member_open = "1"
    else:
        selected_boundary = "legacy_helper_cache_owner_selection_after_arrayrepr_rebase"
        next_diagnostic = "legacy_helper_cache_owner_selection_after_arrayrepr_rebase"
    ...
    return {
        ...
        "optional_next_member_open": optional_next_member_open,
