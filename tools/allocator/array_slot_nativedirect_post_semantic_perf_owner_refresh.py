#!/usr/bin/env python3
"""Refresh the ArraySlot NativeDirect perf owner after semantic smoke."""
...
def classify(rows: list[tuple[str, float]]) -> dict[str, str]:
    ...
    if dominates:
        ...
        selected_boundary = "array_slot_nativedirect_post_semantic_owner_refresh"
        next_diagnostic = "array_slot_nativedirect_post_semantic_owner_refresh"
        selected_next = "array_slot_nativedirect_post_semantic_owner_refresh"
