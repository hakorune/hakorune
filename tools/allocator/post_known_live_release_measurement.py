#!/usr/bin/env python3
"""Measure exact-EXE after the known-live release keeper."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hakorune_post_known_live_release.") as tmp:
        tmp_dir = Path(tmp)
        samples = [
    ...
    lines.extend(
        [
            ...
            "previous_checkpoint_source=296x-139-post-static-scalar-call-lowering-measurement",
