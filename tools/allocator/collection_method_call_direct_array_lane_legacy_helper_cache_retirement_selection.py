#!/usr/bin/env python3
"""Select the first legacy helper/cache retirement target after row408 refresh."""
...
def classify(rows: list[tuple[str, float]]) -> dict[str, str]:
    ...
    if dominates:
        ...
        selected_retirement_candidate = "single_thread_exact_array_helper_backend"
        ...
        selected_retirement_candidate = "single_thread_exact_array_helper_backend"
        selected_retirement_reason = "legacy_helper_cache_still_dominant_after_semantic_smoke"
        retirement_open = "0"
    ...
    return {
        ...
        "selected_retirement_candidate": selected_retirement_candidate,
        "selected_retirement_reason": selected_retirement_reason,
