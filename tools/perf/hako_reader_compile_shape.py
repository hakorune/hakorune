...
def measure(binary: pathlib.Path, case: str, timeout: float, optimize: bool) -> dict:
    tracked = {
        ...
        "tracked_direct_reader": "tools/checks/fixtures/bounded_body_snapshot_direct_reader_v0.hako",
    }
    if case in tracked:
...
def main() -> int:
    ...
    parser.add_argument(
        "--cases",
        default=(
            "baseline,tracked_model,tracked_root_reader,tracked_leaf_reader,tracked_child_reader,tracked_call_reader,tracked_stmt_reader,tracked_direct_reader,"
