...
json='{"schema_version":"1.0","functions":[{"name":"main","metadata":{"generic_method_routes":[{"route_id":"generic_method.set","block":0,"instruction_index":3,"box_name":"MapBox","method":"set","receiver_origin_box":"MapBox","key_route":"i64_const","arity":2,"receiver_value":3,"key_value":1,"result_value":4,"emit_kind":"set","route_kind":"map_store_any","helper_symbol":"nyash.map.slot_store_hhh","proof":"set_surface_policy","core_method":{"op":"MapSet","proof":"core_method_contract_manifest","lowering_tier":"cold_fallback"},"return_shape":null,"value_demand":"write_any","publication_policy":null,"effects":["mutate.slot"]},{"route_id":"generic_method.len","block":0,"instruction_index":4,"box_name":"MapBox","method":"size","receiver_origin_box":"MapBox","key_route":null,"arity":0,"receiver_value":3,"key_value":null,"result_value":5,"emit_kind":"len","route_kind":"map_entry_count","helper_symbol":"nyash.map.entry_count_i64","proof":"len_surface_policy","core_method":{"op":"MapLen","proof":"core_method_contract_manifest","lowering_tier":"warm_direct_abi"},"return_shape":"scalar_i64","value_demand":"scalar_i64","publication_policy":"no_publication","effects":["observe.len"]}]},"blocks":[{"id":0,"instructions":[{"op":"mir_call","dst":3,"mir_call":{"callee":{"type":"Constructor","box_type":"MapBox"},"args":[],"effects":[]}},{"op":"const","dst":1,"value":{"type":"i64","value":1}},{"op":"const","dst":2,"value":{"type":"i64","value":1}},{"op":"mir_call","dst":4,"mir_call":{"callee":{"type":"Method","box_name":"MapBox","method":"set","receiver":3},"args":[1,2],"effects":[]}},{"op":"mir_call","dst":5,"mir_call":{"callee":{"type":"Method","box_name":"MapBox","method":"size","receiver":3},"args":[],"effects":[]}},{"op":"ret","value":5}]}]}]}'
