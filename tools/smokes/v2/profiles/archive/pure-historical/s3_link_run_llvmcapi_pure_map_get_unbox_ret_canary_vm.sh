...
json='{"schema_version":"1.0","functions":[{"name":"main","metadata":{"generic_method_routes":[{"route_id":"generic_method.set","block":0,"instruction_index":3,"box_name":"MapBox","method":"set","receiver_origin_box":"MapBox","key_route":"i64_const","arity":2,"receiver_value":1,"key_value":2,"result_value":null,"emit_kind":"set","route_kind":"map_store_any","helper_symbol":"nyash.map.slot_store_hhh","proof":"set_surface_policy","core_method":{"op":"MapSet","proof":"core_method_contract_manifest","lowering_tier":"cold_fallback"},"return_shape":null,"value_demand":"write_any","publication_policy":null,"effects":["mutate.slot"]},{"route_id":"generic_method.get","block":0,"instruction_index":4,"box_name":"MapBox","method":"get","receiver_origin_box":"MapBox","key_route":"i64_const","arity":1,"receiver_value":1,"key_value":2,"result_value":4,"emit_kind":"get","route_kind":"map_load_any","helper_symbol":"nyash.map.slot_load_hh","proof":"get_surface_policy","core_method":{"op":"MapGet","proof":"core_method_contract_manifest","lowering_tier":"warm_direct_abi"},"return_shape":null,"value_demand":"read_ref","publication_policy":null,"effects":["read.key"]}]},"blocks":[{"id":0,"instructions":[
