...
run_gate_step "phase29y_vm_hako_caps_gate_vm" "tools/smokes/v2/profiles/integration/vm_hako_caps/file/filebox_newbox_vm.sh"
run_gate_step "phase29y_vm_hako_caps_gate_vm" "tools/smokes/v2/profiles/integration/vm_hako_caps/args/args_vm.sh"
...
run_gate_step "phase29y_vm_hako_caps_gate_vm" "tools/smokes/v2/profiles/integration/vm_hako_caps/env/env_get_ported_vm.sh"
...
run_gate_step "phase29y_vm_hako_caps_gate_vm" "tools/smokes/v2/profiles/integration/vm_hako_caps/file/file_read_ported_vm.sh"
run_gate_step "phase29y_vm_hako_caps_gate_vm" "tools/smokes/v2/profiles/integration/vm_hako_caps/file/file_close_ported_vm.sh"
