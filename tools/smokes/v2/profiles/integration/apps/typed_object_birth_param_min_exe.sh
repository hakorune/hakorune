...
#
# Contract pin:
# - declared i64 fields receive constructor/birth parameters.
# - source enters the selected physical lifecycle V4 owner directly;
#   the retired selfhost --mir route is not an artifact caller for
#   this lifecycle cohort (Invoke stays intentionally rejected there).
# - birth/2 and sum/0 lower through same-module uniform ABI.
