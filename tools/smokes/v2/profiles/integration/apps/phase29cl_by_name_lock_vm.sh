...
run_step "bash tools/smokes/v2/lib/emit_mir_route.sh --route hako-helper --timeout-secs \"\${HAKO_BUILD_TIMEOUT:-60}\" --out /tmp/phase29cl_launcher_cutover.mir.json --input lang/src/runner/entry/launcher_native_entry.hako"
