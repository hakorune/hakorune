#!/bin/bash
# scan_with_init_strict_shadow_vm.sh - scan_with_init strict shadow adopt tag gate (VM)
# current semantic wrapper; canonical entry for scan_with_init_strict_shadow_vm
#
# Expected:
# - Exit code 1
...
FIXTURE="$NYASH_ROOT/apps/tests/scan_with_init_ok_min.hako"
