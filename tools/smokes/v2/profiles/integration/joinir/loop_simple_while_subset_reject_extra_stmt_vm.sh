#!/bin/bash
# loop_simple_while_subset_reject_extra_stmt_vm.sh - loop_simple_while subset reject extra stmt (VM)
# current semantic wrapper; canonical entry for loop_simple_while_subset_reject_extra_stmt_vm
#
# Purpose:
