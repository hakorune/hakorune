...
run_filter "loop_break_release_adopt_vm" "phase29ao_pattern2_release_adopt_vm" || exit 1
run_filter "if_phi_join_vm" "phase118_pattern3_if_sum_vm" || exit 1
run_filter "if_phi_join_release_adopt_vm" "phase29ao_pattern3_release_adopt_vm" || exit 1
run_filter "loop_continue_only_vm" "phase29ap_pattern4_continue_min_vm" || exit 1
run_filter "loop_simple_while_strict_shadow_vm" "phase29ao_pattern1_strict_shadow_vm" || exit 1
run_filter "loop_simple_while_subset_reject_extra_stmt_vm" "phase29ao_pattern1_subset_reject_extra_stmt_vm" || exit 1
...
run_filter "loop_true_early_exit_vm" "phase286_pattern5_break_vm" || exit 1
run_filter "loop_true_early_exit_strict_shadow_vm" "phase29ao_pattern5_strict_shadow_vm" || exit 1
run_filter "loop_true_early_exit_release_adopt_vm" "phase29ao_pattern5_release_adopt_vm" || exit 1
run_filter "scan_with_init_strict_shadow_vm" "phase29ao_pattern6_strict_shadow_vm" || exit 1
run_filter "scan_with_init_release_adopt_vm" "phase29ao_pattern6_release_adopt_vm" || exit 1
run_filter "scan_with_init_pack_vm" "phase29ae_pattern6_scan_with_init_pack_vm" || exit 1
run_filter "nested_loop_minimal_release_adopt_vm" "phase29ap_pattern6_nested_release_adopt_vm" || exit 1
run_filter "nested_loop_minimal_strict_shadow_vm" "phase29ap_pattern6_nested_strict_shadow_vm" || exit 1
run_filter "split_scan_strict_shadow_vm" "phase29ao_pattern7_strict_shadow_vm" || exit 1
run_filter "split_scan_release_adopt_vm" "phase29ao_pattern7_release_adopt_vm" || exit 1
run_filter "split_scan_pack_vm" "phase29ae_pattern7_scan_split_pack_vm" || exit 1
