#!/bin/bash
# loop_continue_only_multidelta_planner_required_vm.sh - legacy compat wrapper target for loop_continue_only multidelta gate
# current semantic wrapper; canonical entry for loop_continue_only_multidelta_planner_required_vm
...
run_planner_first_gate \
    "loop_continue_only_multidelta_planner_required_vm" \
    "$FIXTURE" \
    "$expected" \
