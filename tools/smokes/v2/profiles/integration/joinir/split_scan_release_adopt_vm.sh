#!/bin/bash
# current semantic wrapper; canonical entry for split_scan release-adopt smoke

source "$(dirname "$0")/../../../lib/test_runner.sh"
require_env || exit 2

SEMANTIC_STEM="split_scan_release_adopt_vm"
...
test_pass "${LABEL_PREFIX}: PASS (exit=3)"
exit 0
