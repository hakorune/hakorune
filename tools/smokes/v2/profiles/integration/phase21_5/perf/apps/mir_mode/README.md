...
App MIR input-mode comparison family.
...
- The smoke set keeps the app MIR mode compare path pinned.
- The benchmark driver remains `tools/perf/bench_apps_mir_mode_compare.sh`.
