...
emit_failure_summary_from_log() {
  ...
  echo "[diag/selfhost] env=NYASH_DEV=${NYASH_DEV:-} NYASH_OPERATOR_BOX_ALL=${NYASH_OPERATOR_BOX_ALL:-} NYASH_OPERATOR_BOX_STRINGIFY=${NYASH_OPERATOR_BOX_STRINGIFY:-} NYASH_OPERATOR_BOX_COMPARE=${NYASH_OPERATOR_BOX_COMPARE:-} NYASH_OPERATOR_BOX_ADD=${NYASH_OPERATOR_BOX_ADD:-} NYASH_OPERATOR_BOX_COMPARE_ADOPT=${NYASH_OPERATOR_BOX_COMPARE_ADOPT:-} NYASH_OPERATOR_BOX_ADD_ADOPT=${NYASH_OPERATOR_BOX_ADD_ADOPT:-} NYASH_DISABLE_PLUGINS=${NYASH_DISABLE_PLUGINS:-} NYASH_VM_HAKO_PREFER_STRICT_DEV=${NYASH_VM_HAKO_PREFER_STRICT_DEV:-} HAKO_JOINIR_STRICT=${HAKO_JOINIR_STRICT:-} HAKO_JOINIR_PLANNER_REQUIRED=${HAKO_JOINIR_PLANNER_REQUIRED:-} HAKO_JOINIR_DEBUG=${HAKO_JOINIR_DEBUG:-} NYASH_FEATURES=${NYASH_FEATURES:-} NYASH_USING_AST=${NYASH_USING_AST:-}"
