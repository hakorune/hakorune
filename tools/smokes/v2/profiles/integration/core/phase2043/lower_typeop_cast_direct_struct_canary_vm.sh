...
static box Main { method main(args) {
  local j = '{"version":0,"kind":"Program","body":[{"type":"Local","name":"x","expr":{"type":"Int","value":7}},{"type":"Return","expr":{"type":"Method","recv":{"type":"Var","name":"x"},"method":"as","args":[{"type":"String","value":"IntegerBox"}]}}]}'
