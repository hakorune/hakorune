...
set +e
OUT=$(HAKO_FAIL_FAST_ON_HAKO_IN_NYASH_VM=0 NYASH_ENABLE_USING=1 HAKO_ENABLE_USING=1 NYASH_JOINIR_STRICT=0 NYASH_JOINIR_PLANNER_REQUIRED=0 HAKO_JOINIR_STRICT=0 HAKO_JOINIR_PLANNER_REQUIRED=0 NYASH_VM_HAKO_PREFER_STRICT_DEV=0 NYASH_VM_USE_FALLBACK=1 run_nyash_vm -c "$CODE" 2>&1)
RC=$?
set -e
