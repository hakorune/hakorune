...
def hako_observation(
    ...
    try:
        ...
        return {
            "accepted": False,
            "normalized_kind": "",
            "stable_reject_tag": "parser/hako_adapter_timeout",
        }
...
def main() -> int:
    ...
    parser.add_argument("--hako-timeout-sec", type=float, default=1.0)
    ...
    payload = json.dumps({"schema": "language-v1-grammar-drift-v0", "probes": report}, indent=2)
    if args.output:
