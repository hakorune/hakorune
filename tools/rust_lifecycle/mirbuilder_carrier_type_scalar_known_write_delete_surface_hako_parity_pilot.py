#!/usr/bin/env python3
"""Freeze the ScalarKnown write Delete surface .hako parity pilot fixture."""
...
def oracle_row(oracle: dict[str, Any]) -> dict[str, Any]:
    ...
    if len(rows) != 1:
        raise SystemExit("expected exactly one write Delete Rust oracle row")
    return rows[0]
...
def build_fixture() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderCarrierTypeScalarKnownWriteDeleteSurfaceHakoParityPilotV1",
        "token": TOKEN,
        "input_state": {
        ...
        "hako_implementation": {
            ...
            "box": "WriteDeleteSurfacePolicyClassifierBox",
            "method": "classify",
        ...
        "parity_pilot_fixture": {
            "fixture_id": "WriteDeleteSurfaceHakoParityPilotV0",
            "row_count": 1,
            "rows": [
                {
                    "case_id": row["case_id"],
        ...
        "selection_rule": {
            "name": "WriteDeleteSurfaceHakoParityPilotImplementationOnlyV1",
        ...
        "decision": {
            "kind": "SelectWriteDeleteSurfaceParityGate",
            "reason_token": "WriteDeleteSurfaceHakoParityPilotLanded",
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-carrier-type-scalar-known-write-delete-surface-hako-parity-pilot unchanged")
        return 0
