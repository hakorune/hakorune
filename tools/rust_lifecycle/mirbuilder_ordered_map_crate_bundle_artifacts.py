...
def _bundle_header() -> list[str]:
    return [
        ...
        "// bundle-members: hakorune_mir_builder::binding_context, hakorune_mir_builder::context, hakorune_mir_builder::core_context.scalar_counters, hakorune_mir_builder::variable_context.simple_map, hakorune_mir_builder::variable_context.snapshot_restore",
...
def build_ordered_map_crate_bundle_manifest_text(hako_text: str) -> str:
    ...
    manifest = build_rust_derived_hako_manifest(
        ...
        generator_version="mirbuilder-easy-v0-ordered-map-bundle-v3",
