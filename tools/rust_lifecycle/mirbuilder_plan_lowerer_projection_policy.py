#!/usr/bin/env python3
"""Resolve PlanLowerer projection policy."""
...
OUTPUT = FIXTURES / "mirbuilder-plan-lowerer-projection-policy-v0.json"
SELECTED_CLUSTER_ID = (
    "projection_policy::UnsupportedDirectShape::shape.plan_lowerer::"
    "FixtureMapped::PlanLowererCluster"
)
...
def selected_surfaces(report: dict[str, Any]) -> list[dict[str, Any]]:
    return [
        ...
        and item.get("shape_signature") == "shape.plan_lowerer"
        and item.get("joinir_plan_subcluster") == "PlanLowererCluster"
...
def build_policy() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderPlanLowererProjectionPolicyV1",
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-plan-lowerer-projection-policy unchanged")
        return 0
