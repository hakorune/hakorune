#!/usr/bin/env python3
"""Freeze the ScalarKnown write Push surface .hako adoption decision fixture."""
...
PARITY_GATE = (
    ROOT
    / "tools/checks/rust_lifecycle_mirbuilder_carrier_type_scalar_known_write_push_surface_parity_gate.sh"
)
...
def build_fixture() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderCarrierTypeScalarKnownWritePushSurfaceHakoAdoptionDecisionV1",
        "token": TOKEN,
        "input_state": {
        ...
        "adoption_decision": {
            "decision": "Adopt",
            "reason_token": "WritePushSurfaceRustOracleParityGateGreen",
            "adopted_owner": "write_push_surface_policy_classifier",
            "adopted_surface": "PushSurfacePolicy/ArrayAppendAny",
            "hako_adopted": True,
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-carrier-type-scalar-known-write-push-surface-hako-adoption-decision unchanged")
        return 0
