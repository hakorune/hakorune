...
def validate_report(report: dict[str, Any]) -> None:
    ...
    require(first_gap["edge_id"] == "finalize_module.composition", "first materialization gap drift")
    require(
        first_gap["required_capability"] == "FinalizeModuleComposition",
        "first materialization gap capability drift",
    )
    require(
        first_gap["next_slice_token"] == "MIRBUILDER-BOUNDED-FINALIZE-DERIVED-HAKO-ARTIFACT-001",
