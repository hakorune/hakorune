...
def build_hako() -> str:
    return """// @generated by tools/rust_lifecycle/generate_variable_context_simple_map_artifact.py
// artifact-manifest: lang/generated/rust_derived/hakorune_mir_builder/variable_context_simple_map.artifact.json
// family: hakorune_mir_builder::variable_context
// pilot-scope: VariableContext_simple_map_only
...
static box VariableContextApi {
    ...
    len(ctx): i64 {
        return ctx.variable_map.length()
    }
...
def build_manifest(hako_text: str, recipe_text: str, verifier_text: str) -> dict[str, Any]:
    return {
        ...
        "generator": {
            "tool": "tools/rust_lifecycle/generate_variable_context_simple_map_artifact.py",
            "version": "variable-context-simple-map-derived-artifact-v0",
        },
        "inputs": {
