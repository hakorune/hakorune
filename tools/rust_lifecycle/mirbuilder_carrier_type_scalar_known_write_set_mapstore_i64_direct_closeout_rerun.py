#!/usr/bin/env python3
"""Rerun the Write Set MapStoreI64 typed direct closeout contract."""
...
def build_fixture() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderCarrierTypeScalarKnownWriteSetMapStoreI64DirectCloseoutRerunV1",
        "token": TOKEN,
        "input_state": {
        ...
        "materialized_contract": mapstore_i64_contract,
        "remaining_write_scoped_surfaces": ["SetSurfacePolicy/MapStoreAny"],
        "remaining_write_surface_blockers": {
            "SetSurfacePolicy/MapStoreAny": "AnyWriteBoundaryRequired",
        },
        "summary": {
        ...
        "decision": {
            "kind": "SelectWriteSetMapStoreAnyBoundarySelection",
            "reason_token": "MapStoreI64ScopedCloseoutMaterializedMapStoreAnyRemains",
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-carrier-type-scalar-known-write-set-mapstore-i64-direct-closeout-rerun unchanged")
        return 0
