#!/usr/bin/env python3
"""Rerun ScalarKnown fastpath-connected closeout inventory after String."""
...
def build_fixture() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderScalarKnownFastpathConnectedCloseoutInventoryRerun005V1",
        "token": TOKEN,
        "input_state": {
            ...
            "string_shadow_consume": rel(STRING),
            "string_shadow_consume_hash": sha256_file(STRING),
            "string_decision": (string.get("decision") or {}).get("kind"),
        ...
        "provenance": {
            ...
            "absent_read_policy_sources": absent([COLLECTION_HAKO]),
            "absent_read_generated_artifacts": absent([COLLECTION_ARTIFACT]),
        },
        "inventory": {
            ...
            "read_homogeneous_surface_connection_complete": True,
            ...
            "selected_candidate": {
                ...
                "selection_kind": "RemainingAcceptedScalarKnownReadSurfaceAfterHomogeneousReadPilots",
                "reason": "Collection is the remaining accepted ScalarKnown read/observe surface after Write, MapLoad, and String generated typed artifact shadow handoffs.",
            },
            "selection_rule": {
                "name": "RemainingAcceptedScalarKnownReadSurfaceAfterHomogeneousReadPilotsV1",
                "prior_mapload_shadow_consumed": True,
                "prior_string_shadow_consumed": True,
        ...
        "decision": {
            "kind": "SelectCollectionScalarI64GeneratedTypedArtifactBasis",
            "reason_token": "RemainingAcceptedScalarKnownReadSurfaceAfterHomogeneousReadPilots",
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-scalar-known-fastpath-connected-closeout-inventory-rerun-005 unchanged")
        return 0
