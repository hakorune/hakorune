...
PROBE_RESULT_CONTRACT = ROOT / "docs/development/current/main/design/fixtures/rust-lifecycle/box-compilation-context-crate-smoke-probe-result-contract-v0.json"
PROBE_CLOSEOUT_CONTRACT = ROOT / "docs/development/current/main/design/fixtures/rust-lifecycle/box-compilation-context-crate-smoke-probe-closeout-contract-v0.json"
REFERENCE = ROOT / "docs/development/current/main/design/fixtures/rust-lifecycle/box-compilation-context-crate-smoke-probe-verification-bundle-v0.json"


def verify_box_compilation_context_crate_smoke_bundle() -> dict[str, Any]:
    ...
    probe_result_contract = json.loads(PROBE_RESULT_CONTRACT.read_text())
    probe_closeout_contract = json.loads(PROBE_CLOSEOUT_CONTRACT.read_text())

    require_current_task_pointer(current_task, "Run representative BoxCompilationContext crate smoke consultation bundle", "current task pointer not set to probe verification bundle")
    ...
    require(probe_result_contract.get("current_contract") == "probe_result_contract_only", "probe result contract fixture does not describe the representative result contract")
    require(probe_closeout_contract.get("current_contract") == "probe_closeout_contract_only", "probe closeout contract fixture does not describe the representative closeout contract")

    return {
        "schema_version": 0,
        "kind": "MirBuilderEasyTierCrateSmokeProbeVerificationBundle",
        ...
        "current_contract": "probe_verification_bundle_only",
        "source": {
            ...
            "probe_result_contract": "docs/development/current/main/design/fixtures/rust-lifecycle/box-compilation-context-crate-smoke-probe-result-contract-v0.json",
            "probe_closeout_contract": "docs/development/current/main/design/fixtures/rust-lifecycle/box-compilation-context-crate-smoke-probe-closeout-contract-v0.json",
        },
        "bundle_commands": [
            ...
            "python3 tools/rust_lifecycle/mirbuilder_box_compilation_context_crate_smoke_probe_output_contract.py --check-reference",
            "python3 tools/rust_lifecycle/mirbuilder_box_compilation_context_crate_smoke_probe_result_contract.py --check-reference",
            "python3 tools/rust_lifecycle/mirbuilder_box_compilation_context_crate_smoke_probe_closeout_contract.py --check-reference",
        ],
        "decision": [
            "define a single machine-readable verification bundle over the landed probe consultation rows",
            "keep the bundle bounded to the landed ctor + is_empty slice",
        ...
        "harness_boundary": [
            ...
            "probe closeout contract guard",
            "probe verification bundle guard",
        ],
        "supporting_evidence": [
            ...
            "the probe result contract is already fixed",
            "the probe closeout contract is already fixed",
...
def main() -> int:
    ...
    report = verify_box_compilation_context_crate_smoke_bundle()
    if args.check_reference:
        expected = json.loads(REFERENCE.read_text())
        require(report == expected, "crate smoke verification bundle differs from reference fixture")
    if args.emit_json:
    ...
    print("selected_next_owner=representative crate smoke probe verification bundle")
