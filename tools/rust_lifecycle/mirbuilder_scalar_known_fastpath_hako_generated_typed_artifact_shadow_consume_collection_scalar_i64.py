#!/usr/bin/env python3
"""Record CollectionScalarI64 generated typed Hako artifact shadow consumption."""
...
HAKO_SOURCE = ROOT / "lang/src/compiler/lib/collection_len_scalar_i64_policy_classifier.hako"
GENERATED_ARTIFACT = (
...
def build_fixture() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderScalarKnownFastpathHakoGeneratedTypedArtifactShadowConsumeCollectionScalarI64V1",
        "token": TOKEN,
        "input_state": {
            "basis": rel(BASIS),
        ...
        "implementation": {
            ...
            "collection_fastpath_shadow_consumed": True,
            "rust_hako_policy_match": True,
            "mismatch_policy": "panic_guard_fail",
            "rust_authority_retained": True,
        },
        "decision": {
            "kind": "SelectConnectedCloseoutInventoryRerun006",
            "reason_token": "CollectionScalarI64GeneratedTypedArtifactShadowConsumed",
            "selected_next_card": NEXT_CARD,
        },
        "claims": {
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-scalar-known-fastpath-hako-generated-typed-artifact-shadow-consume-collection-scalar-i64 unchanged")
        return 0
