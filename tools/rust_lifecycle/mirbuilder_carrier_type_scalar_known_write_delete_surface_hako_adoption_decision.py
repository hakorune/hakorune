#!/usr/bin/env python3
"""Freeze the ScalarKnown write Delete surface .hako adoption decision fixture."""
...
def build_fixture() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderCarrierTypeScalarKnownWriteDeleteSurfaceHakoAdoptionDecisionV1",
        "token": TOKEN,
        "input_state": {
        ...
        "adoption_decision": {
            "decision": "Adopt",
            "reason_token": "WriteDeleteSurfaceRustOracleParityGateGreen",
            "adopted_owner": "write_delete_surface_policy_classifier",
            "adopted_surface": "DeleteSurfacePolicy/MapDeleteAny",
            "hako_adopted": True,
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-carrier-type-scalar-known-write-delete-surface-hako-adoption-decision unchanged")
        return 0
