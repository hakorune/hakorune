#!/usr/bin/env python3
"""Resolve PlanComposer projection policy."""
...
OUTPUT = FIXTURES / "mirbuilder-plan-composer-projection-policy-v0.json"
SELECTED_CLUSTER_ID = (
    "projection_policy::UnsupportedDirectShape::shape.plan_composer::"
    "FixtureMapped::PlanComposerCluster"
)
...
def selected_surfaces(report: dict[str, Any]) -> list[dict[str, Any]]:
    return [
        ...
        and item.get("shape_signature") == "shape.plan_composer"
        and item.get("joinir_plan_subcluster") == "PlanComposerCluster"
...
def build_policy() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderPlanComposerProjectionPolicyV1",
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-plan-composer-projection-policy unchanged")
        return 0
