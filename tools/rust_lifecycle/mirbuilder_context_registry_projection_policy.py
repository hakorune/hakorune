#!/usr/bin/env python3
"""Resolve ContextRegistry projection policy."""
...
OUTPUT = FIXTURES / "mirbuilder-context-registry-projection-policy-v0.json"
SELECTED_CLUSTER_ID = (
    "projection_policy::UnsupportedDirectShape::shape.context_registry::"
    "FixtureMapped::ContextRegistryCluster"
)
...
def selected_surfaces(report: dict[str, Any]) -> list[dict[str, Any]]:
    return [
        ...
        and item.get("shape_signature") == "shape.context_registry"
...
def build_policy() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderContextRegistryProjectionPolicyV1",
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-context-registry-projection-policy unchanged")
        return 0
