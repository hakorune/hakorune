#!/usr/bin/env python3
"""Resolve LoopCondReturnInBody cleanup projection policy."""
...
OUTPUT = FIXTURES / "mirbuilder-loop-cond-return-in-body-projection-policy-v0.json"
SELECTED_CLUSTER_ID = (
    "projection_policy::UnsupportedDirectShape::shape.loop_cond_return_in_body::"
    "FixtureMapped::LoopCondReturnInBodyCluster"
)
...
def selected_surfaces(report: dict[str, Any]) -> list[dict[str, Any]]:
    return [
        ...
        and item.get("shape_signature") == "shape.loop_cond_return_in_body"
        and item.get("loop_cond_feature_subcluster") == "LoopCondReturnInBodyCluster"
...
def build_policy() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderLoopCondReturnInBodyProjectionPolicyV1",
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-loop-cond-return-in-body-projection-policy unchanged")
        return 0
