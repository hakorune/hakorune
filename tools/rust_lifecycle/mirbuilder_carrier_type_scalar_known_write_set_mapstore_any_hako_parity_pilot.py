#!/usr/bin/env python3
"""Freeze the Set MapStoreAny .hako parity pilot fixture."""
...
def oracle_row(oracle: dict[str, Any]) -> dict[str, Any]:
    ...
    if len(rows) != 1:
        raise SystemExit("expected exactly one Set MapStoreAny Rust oracle row")
    return rows[0]
...
def build_fixture() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderCarrierTypeScalarKnownWriteSetMapStoreAnyHakoParityPilotV1",
        "token": TOKEN,
        "input_state": {
        ...
        "hako_implementation": {
            ...
            "box": "WriteSetMapStoreAnyPolicyClassifierBox",
            "method": "classify",
        ...
        "parity_pilot_fixture": {
            "fixture_id": "WriteSetMapStoreAnyHakoParityPilotV0",
            "row_count": 1,
            "rows": [
                {
                    "case_id": row["case_id"],
        ...
        "selection_rule": {
            "name": "WriteSetMapStoreAnyHakoParityPilotImplementationOnlyV1",
        ...
        "decision": {
            "kind": "SelectWriteSetMapStoreAnyParityGate",
            "reason_token": "WriteSetMapStoreAnyHakoParityPilotLanded",
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-carrier-type-scalar-known-write-set-mapstore-any-hako-parity-pilot unchanged")
        return 0
