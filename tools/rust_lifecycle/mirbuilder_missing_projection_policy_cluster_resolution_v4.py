#!/usr/bin/env python3
"""Resolve MissingProjectionPolicy clusters after checkpoint rerun 002."""
...
OUTPUT = FIXTURES / "mirbuilder-missing-projection-policy-cluster-resolution-v4-v0.json"

TOKEN = "MIRBUILDER-MISSING-PROJECTION-POLICY-CLUSTER-RESOLUTION-V4"
DESIGN_STOP = "SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001"
NEXT_TRANSPORT = "MIRBUILDER-CARRIER-TYPE-TRANSPORT-POLICY-INVENTORY-RERUN-003"
CHECKPOINT_RERUN = FIXTURES / "source-selfhost-native-owner-checkpoint-rerun-002-v0.json"
...
def build_fixture() -> dict[str, Any]:
    ...
    if not eligible and type_transport_missing:
        decision = {
            "kind": "SelectCarrierTypeTransportPolicyInventoryRerun003",
        ...
        decision = {
            "kind": "KeepStopped",
            "reason_token": "NoMachineDerivedMissingProjectionPolicyV4Lane",
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderMissingProjectionPolicyClusterResolutionV4",
        "token": TOKEN,
        "input_state": {
        ...
        "selection_rule": {
            "manual_projection_policy_selection": False,
            "manual_lane_selection": False,
            "cluster_size_as_proof": False,
            "coverage_percentage_as_proof": False,
            "type_transport_missing_blocks_projection_policy": True,
            "exactly_one_next_lane_or_keep_stopped": True,
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-missing-projection-policy-cluster-resolution-v4 unchanged")
        return 0
