#!/usr/bin/env python3
"""Rerun native-owner seed capability after strict emission evidence."""
...
OUTPUT = FIXTURES / "mirbuilder-crate-wide-native-owner-seed-capability-survey-rerun-003-v0.json"
...
def build_fixture() -> dict[str, Any]:
    ...
    if priority_summary.get("selectable_cluster_count") != 0:
        ...
        decision = {
            ...
            "reason_token": "UnconvertedSurfaceReportStaleAfterStrictEmissionProbe",
        }
    else:
        decision = {
            "kind": "KeepStopped",
            ...
            "reason_token": "NoMachineDerivedNativeOwnerSeedCandidateAfterStrictEmissionProbe",
        }

    return {
        "schema_version": 0,
        "kind": "MirBuilderCrateWideNativeOwnerSeedCapabilitySurveyRerunV3",
        "token": TOKEN,
        "input_state": {
        ...
        "strict_emission_evidence": {
            "verified_hako_family_ir_count": strict_probe["summary"]["verified_hako_family_ir_count"],
            "hako_generation": strict_probe["claims"]["hako_generation"],
            "strict_rules_changed": strict_probe["claims"]["strict_rules_changed"],
        },
        "freshness": {
        ...
        "claims": {
            ...
            "strict_emission_probe_consumed": 1,
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-crate-wide-native-owner-seed-capability-survey-rerun-003 unchanged")
        return 0
