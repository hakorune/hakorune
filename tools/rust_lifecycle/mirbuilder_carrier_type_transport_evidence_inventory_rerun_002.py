#!/usr/bin/env python3
"""Normalize evidence for carrier/type transport inventory rerun 002."""
...
OUTPUT = FIXTURES / "mirbuilder-carrier-type-transport-evidence-inventory-rerun-002-v0.json"

TOKEN = "MIRBUILDER-CARRIER-TYPE-TRANSPORT-EVIDENCE-INVENTORY-RERUN-002"
DESIGN_STOP = "SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001"
NEXT_UNCLASSIFIED = "MIRBUILDER-CARRIER-TYPE-TRANSPORT-UNCLASSIFIED-EVIDENCE-RESOLUTION-001"
NEXT_PRIORITY = "MIRBUILDER-CARRIER-TYPE-TRANSPORT-POLICY-LANE-PRIORITY-RESOLUTION-RERUN-002"
INPUT = FIXTURES / "mirbuilder-carrier-type-transport-policy-inventory-rerun-002-v0.json"
...
def build_fixture() -> dict[str, Any]:
    ...
    if unclassified:
        decision = {
            ...
            "reason_token": "UnclassifiedCarrierTypeTransportEvidenceRemainsAfterRerun002",
            "selected_next_card": NEXT_UNCLASSIFIED,
        }
    else:
        decision = {
            "kind": "SelectCarrierTypeTransportPolicyLanePriorityResolutionRerun002",
            "reason_token": "MultipleCarrierTypeTransportPolicyLanesRequirePriorityResolutionAfterRerun002",
            "selected_next_card": NEXT_PRIORITY,
        }

    return {
        "schema_version": 0,
        "kind": "MirBuilderCarrierTypeTransportEvidenceInventoryRerunV2",
        "token": TOKEN,
        "input_state": {
            "current_blocker": DESIGN_STOP,
            "carrier_type_transport_policy_inventory_rerun_002": rel(INPUT),
            "unconverted_surface_report": rel(REPORT),
        },
        "provenance": {
            "carrier_type_transport_policy_inventory_rerun_002_hash": sha256_file(INPUT),
        ...
        "decision": decision,
        "claims": {
            "carrier_type_transport_policy_inventory_rerun_002_consumed": 1,
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-carrier-type-transport-evidence-inventory-rerun-002 unchanged")
        return 0
