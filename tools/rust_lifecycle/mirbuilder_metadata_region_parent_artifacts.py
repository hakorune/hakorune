...
def metadata_region_parent_spec() -> FamilyArtifactSpec:
    ...
    return FamilyArtifactSpec(
        ...
        main_operations=[
            ...
            op("AssertOptionSomeI64Eq", source="first_parent", expected=10, fail_message="metadata_region_parent_first=fail", fail_code=2),
            ...
            op("AssertOptionSomeI64Eq", source="second_parent", expected=20, fail_message="metadata_region_parent_second=fail", fail_code=3),
