#!/usr/bin/env python3
"""Freeze the ScalarKnown write Set MapStoreI64 .hako adoption decision fixture."""
...
PARITY_GATE = (
    ROOT
    / "tools/checks/rust_lifecycle_mirbuilder_carrier_type_scalar_known_write_set_mapstore_i64_parity_gate.sh"
)
...
def build_fixture() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderCarrierTypeScalarKnownWriteSetMapStoreI64HakoAdoptionDecisionV1",
        "token": TOKEN,
        "input_state": {
        ...
        "adoption_decision": {
            "decision": "Adopt",
            "reason_token": "WriteSetMapStoreI64RustOracleParityGateGreen",
            "adopted_owner": "write_set_mapstore_i64_policy_classifier",
            "adopted_surface": "SetSurfacePolicy/MapStoreI64",
            "hako_adopted": True,
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-carrier-type-scalar-known-write-set-mapstore-i64-hako-adoption-decision unchanged")
        return 0
