#!/usr/bin/env python3
"""Inventory carrier/type transport gaps blocking remaining projection clusters."""
...
OUTPUT = FIXTURES / "mirbuilder-carrier-type-transport-policy-inventory-rerun-002-v0.json"

TOKEN = "MIRBUILDER-CARRIER-TYPE-TRANSPORT-POLICY-INVENTORY-RERUN-002"
DESIGN_STOP = "SOURCE-SELFHOST-WIDER-ROUTE-SELECTION-DESIGN-STOP-001"
NEXT_EVIDENCE = "MIRBUILDER-CARRIER-TYPE-TRANSPORT-EVIDENCE-INVENTORY-RERUN-002"
V3 = FIXTURES / "mirbuilder-missing-projection-policy-cluster-resolution-v3-v0.json"
...
def build_fixture() -> dict[str, Any]:
    ...
    if len(eligible_lanes) == 1:
        ...
        decision = {
            "kind": "SelectCarrierTypeTransportEvidenceInventoryRerun002",
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderCarrierTypeTransportPolicyInventoryRerunV2",
        "token": TOKEN,
        "input_state": {
            "current_blocker": DESIGN_STOP,
            "missing_projection_policy_cluster_resolution_v3": rel(V3),
            "unconverted_surface_report": rel(REPORT),
        },
        "provenance": {
            "missing_projection_policy_cluster_resolution_v3_hash": sha256_file(V3),
            "unconverted_surface_report_hash": sha256_file(REPORT),
        },
        "input_decision": v3.get("decision"),
        ...
        "selection_rule": {
            "consume_missing_projection_policy_v3_type_transport_gaps": True,
        ...
        "decision": decision,
        "claims": {
            "missing_projection_policy_v3_consumed": 1,
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-carrier-type-transport-policy-inventory-rerun-002 unchanged")
        return 0
