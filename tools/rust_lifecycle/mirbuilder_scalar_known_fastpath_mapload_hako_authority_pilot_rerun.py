#!/usr/bin/env python3
"""Rerun after the scoped MapLoad `.hako` authority pilot."""
...
OUTPUT = FIXTURES / "mirbuilder-scalar-known-fastpath-mapload-hako-authority-pilot-rerun-v0.json"

TOKEN = "MIRBUILDER-SCALAR-KNOWN-FASTPATH-MAPLOAD-HAKO-AUTHORITY-PILOT-RERUN-001"
NEXT_CARD = "MIRBUILDER-SCALAR-KNOWN-FASTPATH-NEXT-HAKO-AUTHORITY-SURFACE-DESIGN-STOP-001"
...
def build_fixture() -> dict[str, Any]:
    ...
    return {
        "schema_version": 0,
        "kind": "MirBuilderScalarKnownFastpathMaploadHakoAuthorityPilotRerunV1",
        "token": TOKEN,
        "input_state": {
            ...
            "mapload_hako_route_decision_authority_pilot": (pilot.get("summary") or {}).get(
        ...
        "rerun": {
            ...
            "mapload_rust_oracle_compat_checker": True,
            "mapload_mismatch_fail_fast": True,
        ...
        "decision": {
            ...
            "reason_token": "MapLoadScopedAuthorityPilotCompleteNextSurfaceStillConsultationGated",
            "selected_next_card": NEXT_CARD,
        },
        "summary": {
            "mapload_hako_authority_pilot_rerun": 1,
...
def main() -> int:
    ...
    if args.check:
        ...
        print("mirbuilder-scalar-known-fastpath-mapload-hako-authority-pilot-rerun unchanged")
        return 0
