...
require_text "$TASK_BREAKDOWN" "M64-M73"
require_text "$TASK_BREAKDOWN" "M74 may add a native system provider proof boundary"
...
require_text "$CURRENT_STATE" 'latest_card = "293x-125-M73-DEBUG-GUARDED-PROVIDER-PROOF-FIXTURE"'
require_text "$CURRENT_STATE" 'latest_card_path = "docs/development/current/main/phases/phase-293x/293x-125-M73-DEBUG-GUARDED-PROVIDER-PROOF-FIXTURE.md"'
