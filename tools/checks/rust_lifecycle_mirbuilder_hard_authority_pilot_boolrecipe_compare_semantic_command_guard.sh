...
need(state.get("latest_card") in [token, follow_on_card, second_follow_on_card, third_follow_on_card], "CURRENT_STATE latest card drift")
need(state.get("latest_card_path") in [str(card_path), follow_on_card_path, second_follow_on_card_path, third_follow_on_card_path], "CURRENT_STATE latest path drift")
