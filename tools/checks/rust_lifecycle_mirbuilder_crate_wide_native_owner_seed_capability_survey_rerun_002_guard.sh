...
TAG="rust-lifecycle-mirbuilder-crate-wide-native-owner-seed-capability-survey-rerun-002-guard"
source "$ROOT_DIR/tools/checks/lib/guard_common.sh"

TOOL="$ROOT_DIR/tools/rust_lifecycle/mirbuilder_crate_wide_native_owner_seed_capability_survey_rerun_002.py"
FIXTURE="$ROOT_DIR/docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-crate-wide-native-owner-seed-capability-survey-rerun-002-v0.json"
CARD="$ROOT_DIR/docs/development/current/main/phases/phase-296x/1950-MIRBUILDER-CRATE-WIDE-NATIVE-OWNER-SEED-CAPABILITY-SURVEY-RERUN-002.md"
...
fixture = json.loads(Path("docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-crate-wide-native-owner-seed-capability-survey-rerun-002-v0.json").read_text())
card = Path("docs/development/current/main/phases/phase-296x/1950-MIRBUILDER-CRATE-WIDE-NATIVE-OWNER-SEED-CAPABILITY-SURVEY-RERUN-002.md").read_text()

token = "MIRBUILDER-CRATE-WIDE-NATIVE-OWNER-SEED-CAPABILITY-SURVEY-RERUN-002"
if fixture.get("kind") != "MirBuilderCrateWideNativeOwnerSeedCapabilitySurveyRerunV2":
...
if freshness["needs_unconverted_surface_report_rerun"] is not False:
    raise SystemExit("source report should be fresh for rerun 002")
...
if decision["reason_token"] != "NoMachineDerivedNativeOwnerSeedCandidateAfterProjectionQueueExhaustion":
...
cat <<'REPORT'
output_contract=rust-lifecycle-mirbuilder-crate-wide-native-owner-seed-capability-survey-rerun-002-v0
