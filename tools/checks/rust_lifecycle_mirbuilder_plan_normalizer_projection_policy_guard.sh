...
TAG="rust-lifecycle-mirbuilder-plan-normalizer-projection-policy-guard"
source "$ROOT_DIR/tools/checks/lib/guard_common.sh"

TOOL="$ROOT_DIR/tools/rust_lifecycle/mirbuilder_plan_normalizer_projection_policy.py"
FIXTURE="$ROOT_DIR/docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-plan-normalizer-projection-policy-v0.json"
CARD="$ROOT_DIR/docs/development/current/main/phases/phase-296x/1891-MIRBUILDER-PLAN-NORMALIZER-PROJECTION-POLICY-001.md"
...
fixture = json.loads(Path("docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-plan-normalizer-projection-policy-v0.json").read_text())
card = Path("docs/development/current/main/phases/phase-296x/1891-MIRBUILDER-PLAN-NORMALIZER-PROJECTION-POLICY-001.md").read_text()

token = "MIRBUILDER-PLAN-NORMALIZER-PROJECTION-POLICY-001"
if fixture.get("kind") != "MirBuilderPlanNormalizerProjectionPolicyV1":
...
if symbols != ["create_phi_bindings", "is_pure_value_expr"]:
...
if policy["owner_edge"] != "mirbuilder::plan_normalizer":
...
for marker in [
    ...
    if marker not in fixture["normalizer_evidence"]:
        raise SystemExit(f"normalizer marker missing: {marker}")
...
cat <<'REPORT'
output_contract=rust-lifecycle-mirbuilder-plan-normalizer-projection-policy-v0
