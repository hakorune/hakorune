...
cargo test -q subset_accepts_boxcall_atomiccore_ordered_fence_i64 -- --nocapture
cargo test -q subset_rejects_boxcall_atomiccore_order_constant_with_arg -- --nocapture
