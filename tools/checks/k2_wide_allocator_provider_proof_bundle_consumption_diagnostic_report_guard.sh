...
require_text "$SOURCE" "Diagnostic-only allocator provider registry, selection, proof bundle, and"
...
require_text "$SOURCE" "validate_allocator_provider_proof_bundle_consumption("
require_text "$SOURCE" "validate_allocator_provider_proof_bundle_consumption_from_text"
require_text "$SOURCE" "DIAG_PROVIDER_PROOF_BUNDLE_CONSUMPTION_INACTIVE"
require_text "$SOURCE" "proof_bundle_consumption_fact_checks"
require_text "$SOURCE" "proof_bundle_consumption_malformed_text_reports_parse_error_without_consuming_proof"
require_text "$SOURCE" "REGISTRY_SNAPSHOT_INACTIVE_ACTIONS"
require_text "$SOURCE" "diagnostic_actions.would_consume_proof"
require_text "$SOURCE" "would_consume_proof_bundle"
