...
ARTIFACT_GUARD_LOG="/tmp/hako_variable_context_simple_map_derived_artifact_guard.out"
SEAM_GUARD_LOG="/tmp/hako_family_artifact_route_seam_guard.out"

bash tools/checks/rust_lifecycle_variable_context_simple_map_derived_artifact_guard.sh >"$ARTIFACT_GUARD_LOG" 2>&1
...
artifact_path = Path("lang/generated/rust_derived/hakorune_mir_builder/variable_context_simple_map.artifact.json")
...
assert route["guard_command"] == "bash tools/checks/rust_lifecycle_variable_context_simple_map_derived_route_selection_guard.sh"
