...
artifact_path = Path("lang/generated/rust_derived/hakorune_mir_builder/variable_context_snapshot_restore.artifact.json")
...
assert route["pilot_scope"] == "VariableContext_snapshot_restore_only"
...
assert route["guard_command"] == "bash tools/checks/rust_lifecycle_variable_context_snapshot_restore_derived_route_selection_guard.sh"
...
assert "VariableContext::variable_map_mut" in excluded
PY
