...
require_text "$SOURCE" "active_registry_built: false"
require_text "$SOURCE" "would_build_registry: false"
...
require_text "$CURRENT_STATE" "293x-146-M93-ALLOCATOR-PROVIDER-REGISTRY-SNAPSHOT-DIAGNOSTIC-REPORT"
