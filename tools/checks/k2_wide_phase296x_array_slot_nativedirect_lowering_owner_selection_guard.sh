...
DOC="$ROOT_DIR/docs/development/current/main/phases/phase-296x/296x-361-ARRAY-SLOT-NATIVEDIRECT-LOWERING-OWNER-SELECTION.md"
PREV="$ROOT_DIR/docs/development/current/main/phases/phase-296x/296x-360-ARRAY-SLOT-NATIVEDIRECT-LOWERING-GUARD-SURFACE.md"

require_line() {
  local file="$1"
  local expected="$2"
  if ! grep -Fqx "$expected" "$file"; then
    echo "[row361-array-slot-nativedirect-lowering-owner-selection] missing line in ${file#$ROOT_DIR/}: $expected" >&2
    exit 1
  fi
}
...
require_line "$DOC" "output_contract=array-slot-nativedirect-lowering-owner-selection-v0"
require_line "$DOC" "input_contract=array-slot-nativedirect-lowering-guard-surface-v0"
require_line "$DOC" "selected_owner=llvm_collection_method_call_direct_array_nativedirect_selected_method_hook"
...
require_line "$DOC" "direct_array_i64_exact_only=1"
...
require_line "$DOC" "selected_next=array_slot_nativedirect_lowering_selected_method_pilot"
require_line "$DOC" "summary=ok"

echo "[row361-array-slot-nativedirect-lowering-owner-selection] ok"
