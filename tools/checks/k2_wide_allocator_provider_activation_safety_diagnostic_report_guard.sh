...
require_text "$TEST_SOURCE" "activation_safety_malformed_text_reports_parse_error_without_activation"
...
require_text "$TEST_SOURCE" "allocator-provider-activation-safety-gate-v0.toml"
