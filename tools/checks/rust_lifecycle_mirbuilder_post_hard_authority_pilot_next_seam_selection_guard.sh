...
need(state.get("latest_card") in [token, selected_card], "CURRENT_STATE latest card drift")
need(state.get("latest_card_path") in [str(card_path), selected_card_path], "CURRENT_STATE latest path drift")
