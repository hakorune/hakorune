...
| source_entry_canonical_vm_reference | semantic_reference | HMI-C0/X0 .hako semantic-reference parity plus normal-file-canonical-core-vm-reference cutover and caller zero, then HMI-R1 |
