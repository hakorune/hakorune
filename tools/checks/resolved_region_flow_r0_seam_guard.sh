...
private = (root / "src/mir/join_ir/ownership/ast_analyzer/core.rs").read_text()
...
required = {
    ...
    "private duplicate BindingId": (private, r"pub\(super\) struct BindingId\(u32\)"),
    "private allocator": (private, r"next_binding_id"),
...
if "hakorune_mir_core::BindingId" in private:
    raise SystemExit("private ownership analyzer unexpectedly imports canonical BindingId; reclassify R0")
...
print("ownership_private_binding_id=SchemaMismatchStop")
