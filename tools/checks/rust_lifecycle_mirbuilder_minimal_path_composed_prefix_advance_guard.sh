...
TAG="rust-lifecycle-mirbuilder-minimal-path-composed-prefix-advance-guard"
source "$ROOT_DIR/tools/checks/lib/guard_common.sh"

SCRIPT="$ROOT_DIR/tools/rust_lifecycle/mirbuilder_minimal_path_composed_prefix_advance.py"
FIXTURE="$ROOT_DIR/docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-minimal-path-composed-prefix-advance-v1.json"
...
guard_require_files "$TAG" "$SCRIPT" "$FIXTURE" "$REPORT" "$CONTINUATION" "$ROUTE" "$STATE" "$TASK_ORDER" "$ROLE_SSOT" "$CONTRACT"
