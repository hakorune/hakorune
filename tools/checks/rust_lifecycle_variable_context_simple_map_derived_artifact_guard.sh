...
FAMILY="variable-context-simple-map"
...
result = subprocess.run(
    [
        ...
        "--case",
        "variable_context_simple_map_unsupported_resolved_call_target",
    ],
    check=True,
    capture_output=True,
    text=True,
)
assert "variable_context_simple_map_unsupported_resolved_call_target=green" in result.stdout
PY
