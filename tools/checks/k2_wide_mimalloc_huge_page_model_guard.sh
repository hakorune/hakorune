...
guard_expect_in_file "$TAG" 'allocate_count: i64 = 0' "$HUGE_MODEL" "M180 allocate_count remains i64 until the event-counter row"
guard_expect_in_file "$TAG" 'release_count: i64 = 0' "$HUGE_MODEL" "M180 release_count remains i64 until the event-counter row"
guard_expect_in_file "$TAG" 'release_reject_count: i64 = 0' "$HUGE_MODEL" "M180 release_reject_count remains i64 until the event-counter row"
