...
rg -F -q 'const RAWBUF_CORE_METHODS: &[&str]' "$VM_SUBSET_FILE"
rg -F -q '"RawBufCoreBox" => ("rawbuf", RAWBUF_CORE_METHODS)' "$VM_SUBSET_FILE"
rg -F -q '"alloc_bytes_i64",' "$VM_SUBSET_FILE"
rg -F -q '"realloc_bytes_i64",' "$VM_SUBSET_FILE"
rg -F -q '"free_bytes_i64",' "$VM_SUBSET_FILE"
