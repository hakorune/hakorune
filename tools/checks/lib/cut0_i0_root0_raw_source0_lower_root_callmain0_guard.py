...
def main() -> int:
    ...
    require(state, 'current_execution_row = "RAW-SOURCE0-LOWER0-ROOT0-CALLMAIN0-S0"', "active row")
    require(state, 'latest_card = "cut0-i0-raw-source0-lower-root-callmain0-s0-execution-task-2026-07-24"', "latest card")
    for fragment in (
