...
PROGRAM_ROOT_LOWERING, PROGRAM_STATIC_TABLE_METADATA, MODULE_FINALIZATION_DECLARATION_METADATA = ROOT / "src/mir/builder/program_root_lowering.rs", ROOT / "src/mir/builder/program_static_table_metadata.rs", ROOT / "src/mir/builder/module_finalization_declaration_metadata.rs"
...
def main() -> int:
    ...
    declaration_facts, static_table_metadata, finalization_declaration_metadata = production_code(ROOT / "src/mir/builder/program_declaration_facts.rs"), production_code(PROGRAM_STATIC_TABLE_METADATA), production_code(MODULE_FINALIZATION_DECLARATION_METADATA)
