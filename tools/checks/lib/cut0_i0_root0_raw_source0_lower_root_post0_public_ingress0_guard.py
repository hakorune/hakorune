...
def main() -> int:
    ...
    work_plan, script_runtime_work, script_direct_owner, script_nonbox_disposition, raw_expression_dispatch, top_level_admission, constructor_admission = production_code(ROOT / "src/mir/builder/program_root_work_plan.rs"), production_code(ROOT / "src/mir/builder/normal_script_runtime_work.rs"), production_code(ROOT / "src/mir/builder/normal_script_direct_statement_owner.rs"), production_code(ROOT / "src/mir/builder/normal_script_nonbox_statement_disposition.rs"), production_code(RAW_EXPRESSION_DISPATCH), production_code(TOP_LEVEL_ADMISSION), production_code(CONSTRUCTOR_ADMISSION)
