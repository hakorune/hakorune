...
def main() -> int:
    ...
    require(
        state,
        "CUT0-S0-OWNER0, CUT0-S0-COMPAT0, and CUT0-P0 are closed as disconnected proofs; CUT0-I0-CONSULT0 is closed with Candidate T-prime-r1; CUT0-I0-ID0-S0 is closed as a disconnected identity/token proof; CUT0-I0-ID0-P0 is closed as a disconnected branded owner-chain proof; CUT0-I0-COLLECT0-S0 is next",
        "state pointer",
    )
