...
def main() -> int:
    ...
    require(texts["task"], "P0-R1-CLOSEOUT0 closeout (2026-07-23)", "closeout evidence")
    require(texts["task"], "OWNER-RETENTION0", "owner-retention successor")
    require(texts["task"], "OWNER-RETENTION0-ROOT", "root owner-retention subrow")
    require(texts["task"], "OWNER-RETENTION0-FINAL", "finalizer owner-retention subrow")
    require(texts["task"], "OWNER-RETENTION0-POST", "postprocess owner-retention subrow")
