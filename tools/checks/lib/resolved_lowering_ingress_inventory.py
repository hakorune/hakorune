...
def main() -> None:
    ...
    sa3_files = {
        ...
        "identity_ledger": resolved_lowering_dir / "identity/ledger.rs",
        "value_environment": resolved_lowering_dir / "identity/value_environment.rs",
    ...
    for anchor, label in (
        ...
        ("struct ResolvedIdentityLedgerV2<'a>", "identity_ledger"),
        ("values: BTreeMap<BindingRefV1, ValueId>", "value_environment"),
    ...
    for anchor, label in (
        ...
        ("retired: BTreeSet<BindingRefV1>", "identity_ledger"),
        ("struct PreSsaValueEnvironmentV1", "value_environment"),
