...
impl fmt::Display for ModuleTopologyErrorV1 {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::UnsupportedIncludeContext { path } => write!(formatter, "[rust-source-topology/include/context-unsupported] path={path:?}"),
            Self::UnsupportedIncludeAttribute { path, attribute } => write!(formatter, "[rust-source-topology/include/unsupported-attribute] path={path:?} attribute={attribute:?}"),
            Self::NonLiteralInclude { path } => write!(formatter, "[rust-source-topology/include/nonliteral-path] path={path:?}"),
            Self::IncludeMacroIdentityUnresolved { path } => write!(formatter, "[rust-source-topology/include/macro-identity-unresolved] path={path:?}"),
            Self::UnsupportedIncludedPreamble { path } => write!(formatter, "[rust-source-topology/include/preamble-unsupported] path={path:?}"),
            Self::AbsoluteIncludePath { path } => write!(formatter, "[rust-source-topology/include/absolute-path-unsupported] path={path:?}"),
