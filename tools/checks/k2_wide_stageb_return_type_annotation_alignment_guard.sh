...
TAG="k2-wide-stageb-return-type-annotation-alignment"
cd "$ROOT_DIR"
...
if helper.get("return_type") != "usize":
    raise SystemExit(f"expected return_type usize, got {helper.get('return_type')!r}")
if helper.get("params") != ["me", "x"]:
...
rg -F -q 'parse_return_type_json' lang/src/compiler/entry/func_scanner_helpers.hako
rg -F -q 'return_type' lang/src/compiler/entry/func_scanner.hako
rg -F -q 'return_type_json' lang/src/compiler/entry/stageb/stageb_json_builder_box.hako
