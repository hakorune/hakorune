...
guard_expect_fixed_in_file "$TAG" 'small_alloc_call_count=19' "$report" "tool must record small alloc call count"
guard_expect_fixed_in_file "$TAG" 'small_alloc_copy_count=91' "$report" "tool must record small alloc copy count"
guard_expect_fixed_in_file "$TAG" 'small_alloc_record_failure_call_count=0' "$report" "tool must record failure helper calls"
