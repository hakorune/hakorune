...
guard_expect_in_file "$TAG" 'allocator_comparison_c_mimalloc_explicit_runner_evidence_diagnostic_box.hako' "$MEMORY_README" "memory README must name explicit runner evidence diagnostics owner"
