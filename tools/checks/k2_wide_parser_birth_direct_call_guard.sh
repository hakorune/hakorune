...
CARD="$(guard_require_phase293x_card "$TAG" "293x-401-PARSER-BIRTH-001-DIRECT-BIRTH-NEGATIVE-FIXTURE.md")"
NEXT_CARD="$(guard_require_phase293x_card "$TAG" "293x-402-PARSER-BIRTH-002-DIRECT-BIRTH-DIAGNOSTIC-HINT.md")"
