...
guard_expect_fixed_in_file "$TAG" 'helper_copy_count=16' "$CARD_155" "row155 must record helper copies"
guard_expect_fixed_in_file "$TAG" 'receiver_copy_count=13' "$CARD_155" "row155 must record receiver copies"
guard_expect_fixed_in_file "$TAG" 'arg_copy_count=0' "$CARD_155" "row155 must record arg copies"
guard_expect_fixed_in_file "$TAG" 'result_copy_count=3' "$CARD_155" "row155 must record result copies"
...
guard_expect_fixed_in_file "$TAG" 'dominant_callee_family=page_hotpath_helpers' "$CARD_155" "row155 must classify dominant callee family"
...
guard_expect_fixed_in_file "$TAG" 'helper_copy_count=16' "$report" "probe must record helper copies"
guard_expect_fixed_in_file "$TAG" 'receiver_copy_count=13' "$report" "probe must record receiver copies"
guard_expect_fixed_in_file "$TAG" 'arg_copy_count=0' "$report" "probe must record arg copies"
guard_expect_fixed_in_file "$TAG" 'result_copy_count=3' "$report" "probe must record result copies"
guard_expect_fixed_in_file "$TAG" 'local_ssa_copy_count=85' "$report" "probe must record local SSA copies"
...
guard_expect_fixed_in_file "$TAG" 'dominant_callee_family=page_hotpath_helpers' "$report" "probe must classify dominant callee family"
...
guard_expect_fixed_in_file "$TAG" 'top_helper_0=resetSmallAllocResult' "$report" "probe must record top helper"
guard_expect_fixed_in_file "$TAG" 'top_helper_1=beginSelection' "$report" "probe must record top helper"
guard_expect_fixed_in_file "$TAG" 'top_helper_2=selectSinglePageFastPath' "$report" "probe must record top helper"
guard_expect_fixed_in_file "$TAG" 'top_helper_3=selectPage' "$report" "probe must record top helper"
guard_expect_fixed_in_file "$TAG" 'top_helper_4=reuse' "$report" "probe must record top helper"
