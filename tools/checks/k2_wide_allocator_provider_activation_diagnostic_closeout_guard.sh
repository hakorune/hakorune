...
require_text "$RUNTIME_REGISTRY" "REGISTRY_SNAPSHOT_INACTIVE_ACTIONS"
require_text "$RUNTIME_REGISTRY" "inactive.active_registry_built"
require_text "$RUNTIME_REGISTRY" "inactive.would_build_registry"
require_text "$RUNTIME_REGISTRY" "diagnostic_actions.would_select_provider"
require_text "$RUNTIME_REGISTRY" "diagnostic_actions.would_consume_proof"
require_text "$RUNTIME_REGISTRY" "diagnostic_actions.would_prepare_rollback"
require_text "$RUNTIME_REGISTRY" "diagnostic_actions.would_open_activation_gate"
require_text "$RUNTIME_REGISTRY" "diagnostic_actions.would_install_hook"
require_text "$RUNTIME_REGISTRY" "diagnostic_actions.would_replace_process_allocator"
require_text "$RUNTIME_REGISTRY" "diagnostic_actions.would_activate"
