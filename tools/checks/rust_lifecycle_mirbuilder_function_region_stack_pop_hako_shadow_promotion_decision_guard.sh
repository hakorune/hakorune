...
TAG="rust-lifecycle-mirbuilder-function-region-stack-pop-hako-shadow-promotion-decision-guard"
source "$ROOT_DIR/tools/checks/lib/guard_common.sh"

SCRIPT="$ROOT_DIR/tools/rust_lifecycle/mirbuilder_function_region_stack_pop_hako_shadow_promotion_decision.py"
FIXTURE="$ROOT_DIR/docs/development/current/main/design/fixtures/rust-lifecycle/function-region-stack-pop-hako-shadow-promotion-decision-v0.json"
DERIVED_ARTIFACT_GUARD="$ROOT_DIR/tools/checks/rust_lifecycle_mirbuilder_function_region_stack_pop_derived_artifact_guard.sh"
