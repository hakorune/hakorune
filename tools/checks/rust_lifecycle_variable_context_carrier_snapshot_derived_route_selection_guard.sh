...
ARTIFACT_GUARD_LOG="/tmp/hako_variable_context_carrier_snapshot_derived_artifact_guard.out"
SEAM_GUARD_LOG="/tmp/hako_family_artifact_route_seam_guard.out"

bash tools/checks/rust_lifecycle_variable_context_carrier_snapshot_derived_artifact_guard.sh >"$ARTIFACT_GUARD_LOG" 2>&1
...
artifact_path = Path("lang/generated/rust_derived/hakorune_mir_builder/variable_context_carrier_snapshot.artifact.json")
...
assert route["pilot_scope"] == "VariableContext_carrier_snapshot_only"
...
assert route["guard_command"] == "bash tools/checks/rust_lifecycle_variable_context_carrier_snapshot_derived_route_selection_guard.sh"
