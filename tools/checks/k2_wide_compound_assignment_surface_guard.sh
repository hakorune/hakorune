...
CARD="$(guard_require_phase293x_card "$TAG" "293x-205-C199-COMPOUND-ASSIGNMENT-SURFACE.md")"
ORDER_CARD="$(guard_require_phase293x_card "$TAG" "293x-202-C197-C200-PROOF-APPLICATION-SURFACE-ORDER.md")"
