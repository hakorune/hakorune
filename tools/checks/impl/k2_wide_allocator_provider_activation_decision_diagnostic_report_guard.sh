...
require_text "$SOURCE" "DIAGNOSTIC_INACTIVE_ACTIONS"
require_text "$SOURCE" "inactive.would_select_provider"
require_text "$SOURCE" "inactive.would_consume_proof"
require_text "$SOURCE" "inactive.would_prepare_rollback"
require_text "$SOURCE" "inactive.would_open_activation_gate"
require_text "$SOURCE" "inactive.would_install_hook"
require_text "$SOURCE" "inactive.would_replace_process_allocator"
require_text "$SOURCE" "inactive.would_activate"
...
require_text "$DECISION_FAMILY" "tools/checks/k2_wide_allocator_provider_activation_decision_diagnostic_report_guard.sh"
