...
guard_expect_in_file "$TAG" 'cache.observedWorkerIdValid' "$OWNER" "policy must read the worker-id validity helper from cache"
...
for fragment in (
    ...
    "HakoAllocWorkerTlsCache.observedWorkerIdValid",
