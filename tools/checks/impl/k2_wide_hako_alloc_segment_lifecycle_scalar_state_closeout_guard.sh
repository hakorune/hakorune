...
guard_expect_in_file "$TAG" "Status:" "$CARD_084A" "MIMAP-084A selection card must have status"
guard_expect_in_file "$TAG" "MIMAP-084A" "$CARD_084A" "MIMAP-084A selection card must stay present after closeout"
