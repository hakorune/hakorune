...
ALLOCATOR_GROUP_STEPS="tools/checks/allocator/families/provider/activation.steps"
...
require_text "$ALLOCATOR_GROUP_STEPS" "tools/checks/k2_wide_allocator_provider_rollback_preflight_guard.sh"
