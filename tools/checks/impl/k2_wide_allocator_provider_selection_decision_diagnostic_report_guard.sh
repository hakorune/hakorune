...
IMPL_SOURCE="src/runtime/allocator_provider_selection_decision.rs"
...
ALLOCATOR_GROUP_STEPS="tools/checks/allocator/families/provider/diagnostics.steps"
...
require_text "$IMPL_SOURCE" "validate_allocator_provider_selection_decision("
...
require_text "$IMPL_SOURCE" "selection_decision_fact_checks"
require_text "$TEST_SOURCE" "selection_decision_malformed_text_reports_parse_error_without_selection"
require_text "$IMPL_SOURCE" "DIAG_PROVIDER_SELECTION_DECISION_INACTIVE"
require_text "$IMPL_SOURCE" "DIAG_PROVIDER_SELECTION_UNSUPPORTED_PROVIDER"
require_text "$IMPL_SOURCE" "REGISTRY_SNAPSHOT_INACTIVE_ACTIONS"
require_text "$IMPL_SOURCE" "diagnostic_actions.would_select_provider"
require_text "$IMPL_SOURCE" "diagnostic_actions.would_consume_proof"
require_text "$IMPL_SOURCE" "diagnostic_actions.would_prepare_rollback"
require_text "$IMPL_SOURCE" "diagnostic_actions.would_open_activation_gate"
require_text "$IMPL_SOURCE" "diagnostic_actions.would_install_hook"
require_text "$IMPL_SOURCE" "diagnostic_actions.would_replace_process_allocator"
require_text "$IMPL_SOURCE" "diagnostic_actions.would_activate"
require_text "$IMPL_SOURCE" "inactive.active_registry_built"
require_text "$IMPL_SOURCE" "inactive.would_build_registry"
...
require_text "$ALLOCATOR_GROUP_STEPS" "tools/checks/k2_wide_allocator_provider_selection_decision_diagnostic_report_guard.sh"
