...
FAMILY="tools/checks/allocator/families/provider/activation.steps"
...
require_text "$FAMILY" "tools/checks/k2_wide_allocator_provider_proof_bundle_consumption_guard.sh"
