...
require_text "$TASK_BREAKDOWN" "M75 | native mimalloc provider proof boundary"
...
require_text "$ALLOCATOR_GROUP_STEPS" "tools/checks/k2_wide_allocator_provider_native_system_proof_guard.sh"
