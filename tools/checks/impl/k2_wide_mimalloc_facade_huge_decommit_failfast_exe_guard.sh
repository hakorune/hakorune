...
SELF_SCRIPT="tools/checks/k2_wide_mimalloc_facade_huge_decommit_failfast_exe_guard.sh"
README="lang/src/hako_alloc/memory/README.md"
OWNER_CONTRACTS="lang/src/hako_alloc/memory/OWNER_CONTRACTS_ARENA_RECLAIM.md"
...
guard_expect_in_file "$TAG" 'MIMAP-030A' "$OWNER_CONTRACTS" "arena-reclaim owner contracts must name MIMAP-030A owner"
...
guard_expect_in_file "$TAG" "$SELF_SCRIPT" "$INDEX" "check script index must list MIMAP-030A guard"
