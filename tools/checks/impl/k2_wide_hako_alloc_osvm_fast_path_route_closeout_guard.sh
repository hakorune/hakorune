...
guard_expect_in_file "$TAG" "Status:" "$CARD_044B" "MIMAP-044B selection card must have status"
guard_expect_in_file "$TAG" "MIMAP-044B" "$CARD_044B" "MIMAP-044B selection card must stay present after closeout"
