...
SELF_SCRIPT="tools/checks/k2_wide_mimalloc_facade_huge_release_failfast_exe_guard.sh"
...
guard_expect_in_file "$TAG" "$SELF_SCRIPT" "$INDEX" "check script index must list MIMAP-025A guard"
