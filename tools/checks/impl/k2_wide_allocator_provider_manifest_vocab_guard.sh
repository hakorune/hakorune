...
CARD="$(guard_require_phase293x_card "$TAG" "293x-117-M65-ALLOCATOR-PROVIDER-MANIFEST-VOCAB.md")"
...
require_text "$ALLOCATOR_GROUP_STEPS" "tools/checks/k2_wide_allocator_provider_manifest_vocab_guard.sh"
