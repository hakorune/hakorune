...
SELF_SCRIPT="tools/checks/k2_wide_mimalloc_worker_identity_exe_guard.sh"
...
guard_expect_in_file "$TAG" "$SELF_SCRIPT" "$INDEX" "check script index must list worker identity guard"
