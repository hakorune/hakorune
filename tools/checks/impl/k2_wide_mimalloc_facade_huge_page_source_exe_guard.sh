...
SELF_SCRIPT="tools/checks/k2_wide_mimalloc_facade_huge_page_source_exe_guard.sh"
...
guard_expect_in_file "$TAG" 'MIMAP-028A' "$OWNER_CONTRACTS" "arena-reclaim owner contracts must name MIMAP-028A owner"
...
guard_expect_in_file "$TAG" "$SELF_SCRIPT" "$INDEX" "check script index must list MIMAP-028A guard"
