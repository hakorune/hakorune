...
DECISION_FAMILY="tools/checks/allocator/families/provider/activation_decision.steps"
DIAGNOSTICS_FAMILY="tools/checks/allocator/families/provider/diagnostics.steps"
...
require_file "$INDEX"
require_file "$DECISION_FAMILY"
require_file "$DIAGNOSTICS_FAMILY"
...
require_text "$DECISION_FAMILY" "tools/checks/k2_wide_allocator_provider_activation_implementation_entry_contract_guard.sh"
require_text "$DIAGNOSTICS_FAMILY" "tools/checks/k2_wide_allocator_provider_registry_snapshot_diagnostic_report_guard.sh"
require_text "$DIAGNOSTICS_FAMILY" "tools/checks/k2_wide_allocator_provider_diagnostic_inactive_actions_guard.sh"
require_text "$DIAGNOSTICS_FAMILY" "tools/checks/k2_wide_allocator_provider_registry_snapshot_cli_surface_guard.sh"
require_text "$DIAGNOSTICS_FAMILY" "tools/checks/k2_wide_allocator_provider_activation_diagnostic_closeout_guard.sh"
