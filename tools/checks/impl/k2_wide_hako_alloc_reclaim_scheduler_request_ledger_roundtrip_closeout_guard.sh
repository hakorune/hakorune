...
guard_expect_in_file "$TAG" "Status:" "$CARD_076A" "MIMAP-076A selection card must have status"
guard_expect_in_file "$TAG" "MIMAP-076A" "$CARD_076A" "MIMAP-076A selection card must stay present after closeout"
