...
ALLOCATOR_GROUP_STEPS="tools/checks/allocator/k2_wide_allocator_gate.steps"
...
require_text "$ALLOCATOR_GROUP_STEPS" "tools/checks/k2_wide_allocator_provider_proof_bundle_consumption_cli_surface_guard.sh"
