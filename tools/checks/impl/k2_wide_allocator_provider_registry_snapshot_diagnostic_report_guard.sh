...
IMPL_SOURCE="src/runtime/allocator_provider_registry_snapshot.rs"
...
FAMILY="tools/checks/allocator/families/provider/diagnostics.steps"
...
require_text "$IMPL_SOURCE" "validate_allocator_provider_registry_snapshot("
...
require_text "$IMPL_SOURCE" "registry_snapshot_fact_checks"
require_text "$TEST_SOURCE" "registry_snapshot_malformed_text_reports_parse_error_without_building_registry"
require_text "$IMPL_SOURCE" "DIAG_PROVIDER_REGISTRY_SNAPSHOT_INACTIVE"
...
require_text "$TEST_SOURCE" "allocator-provider-registry-snapshot-v0.toml"
...
require_text "$FAMILY" "tools/checks/k2_wide_allocator_provider_registry_snapshot_diagnostic_report_guard.sh"
