...
rg -F -q 'last_error_is_ok_i64()' "$TLS_CORE_FILE"
rg -F -q 'last_error_code_i64()' "$TLS_CORE_FILE"
...
rg -F -q 'if method == "last_error_is_ok_i64"' "$VM_BOXCALL_FILE"
rg -F -q 'if method == "last_error_code_i64"' "$VM_BOXCALL_FILE"
