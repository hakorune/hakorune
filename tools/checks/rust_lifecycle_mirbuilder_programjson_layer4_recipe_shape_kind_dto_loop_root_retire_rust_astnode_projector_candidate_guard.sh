...
TAG="rust-lifecycle-mirbuilder-programjson-layer4-recipe-shape-kind-dto-loop-root-retire-rust-astnode-projector-candidate-guard"

source "$ROOT_DIR/tools/checks/lib/guard_common.sh"

FIXTURE="$ROOT_DIR/docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-programjson-layer4-recipe-shape-kind-dto-loop-root-retire-rust-astnode-projector-candidate-v0.json"
PARITY_GATE="$ROOT_DIR/tools/checks/rust_lifecycle_mirbuilder_programjson_layer4_recipe_shape_kind_dto_loop_root_parity_gate.sh"
...
do
  if ! grep -q "$required" <<<"$PARITY_OUT"; then
    printf '%s\n' "$PARITY_OUT" >&2
    guard_fail "$TAG" "Recipe shape-kind loop-root prerequisite drift: $required"
  fi
done
...
if fixture.get("kind") != "MirBuilderProgramJsonLayer4RecipeShapeKindDtoLoopRootRustAstNodeProjectorRetireCandidateV1":
    raise SystemExit("bad fixture kind")
if fixture.get("token") != "MIRBUILDER-PROGRAMJSON-LAYER4-RECIPE-SHAPE-KIND-DTO-LOOP-ROOT-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001":
    raise SystemExit("bad fixture token")

expected_hashes = {
    "hako_snapshot_source_hash": "sha256:d93a402ace8ebf29a0ea6a95580641a1131df9cc93b4f77915175baf7dc276ce",
    "recipe_seq_source_hash": "sha256:c3026c9d185e5347c39ef4f2666c13ea3a622a198608ef2bd287d041bd2ab91f",
    "parity_fixture_hash": "sha256:9220977c9b7e33cb0aa9e26d96e4c98b9c7a285f2111cba1566745739d4b1d1d",
    "parity_gate_hash": "sha256:33ec99fe7009ad548c0f98721e36b2c754d18d665726d79744a89390d9a5bd4d",
}
...
if scope.get("shape_scope") != "covered ProgramJSON Layer4 Recipe shape-kind loop-root DTO rows":
...
expected_criteria = {
    "recipe_shape_kind_loop_root_parity_gate": "Green",
...
cat <<'REPORT'
output_contract=rust-lifecycle-mirbuilder-programjson-layer4-recipe-shape-kind-dto-loop-root-retire-rust-astnode-projector-candidate-guard-v0
token=MIRBUILDER-PROGRAMJSON-LAYER4-RECIPE-SHAPE-KIND-DTO-LOOP-ROOT-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001
retire_candidate=RecipeShapeKindDtoSnapshotV1
shape_scope=covered ProgramJSON Layer4 Recipe shape-kind loop-root DTO rows
covered_rows=6
deferred_rows=
