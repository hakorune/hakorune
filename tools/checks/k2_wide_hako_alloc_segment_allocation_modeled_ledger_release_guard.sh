...
guard_expect_in_file "$TAG" 'box HakoAllocSegmentAllocationModeledLedgerReleaseReport' "$OWNER" "MIMAP-097A release report box must exist"
...
required = {
    ...
    "HakoAllocSegmentAllocationModeledLedger.rejectRelease/8",
}
