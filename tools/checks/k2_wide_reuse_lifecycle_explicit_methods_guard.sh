...
CARD="$(guard_require_phase293x_card "$TAG" "293x-403-REUSE-LIFECYCLE-001-EXPLICIT-REUSE-METHODS.md")"
NEXT_CARD="$(guard_require_phase293x_card "$TAG" "293x-404-MIMAP-022A-POST-LIFECYCLE-ROW-SELECTION.md")"
