...
TAG="rust-lifecycle-mirbuilder-generic-loop-body-feature-projection-policy-guard"
source "$ROOT_DIR/tools/checks/lib/guard_common.sh"

TOOL="$ROOT_DIR/tools/rust_lifecycle/mirbuilder_generic_loop_body_feature_projection_policy.py"
FIXTURE="$ROOT_DIR/docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-generic-loop-body-feature-projection-policy-v0.json"
CARD="$ROOT_DIR/docs/development/current/main/phases/phase-296x/1893-MIRBUILDER-GENERIC-LOOP-BODY-FEATURE-PROJECTION-POLICY-001.md"
...
fixture = json.loads(Path("docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-generic-loop-body-feature-projection-policy-v0.json").read_text())
card = Path("docs/development/current/main/phases/phase-296x/1893-MIRBUILDER-GENERIC-LOOP-BODY-FEATURE-PROJECTION-POLICY-001.md").read_text()

token = "MIRBUILDER-GENERIC-LOOP-BODY-FEATURE-PROJECTION-POLICY-001"
if fixture.get("kind") != "MirBuilderGenericLoopBodyFeatureProjectionPolicyV1":
...
expected_symbols = [
    ...
    "has_non_loop_assignment",
    "stmt_has_blockexpr_prelude_loop",
    "matches_loop_increment",
    "body_plans_exit_on_all_paths",
    "plans_require_continue_edge",
]
...
if policy["owner_edge"] != "mirbuilder::generic_loop_body_feature":
...
for marker in [
    ...
    if marker not in fixture["generic_loop_body_feature_evidence"]:
        raise SystemExit(f"generic loop body feature marker missing: {marker}")
...
cat <<'REPORT'
output_contract=rust-lifecycle-mirbuilder-generic-loop-body-feature-projection-policy-v0
