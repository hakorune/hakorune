...
TAG="rust-lifecycle-mirbuilder-scalar-known-fastpath-write-push-arrayappendany-caller-orientation-contract-artifact"
source "$ROOT/tools/checks/lib/guard_common.sh"

FIXTURE="$ROOT/docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-scalar-known-fastpath-write-push-arrayappendany-caller-orientation-contract-artifact-v0.json"
TOOL="$ROOT/tools/rust_lifecycle/mirbuilder_scalar_known_fastpath_write_push_arrayappendany_caller_orientation_contract_artifact.py"
CARD="$ROOT/docs/development/current/main/phases/phase-296x/3433-MIRBUILDER-SCALAR-KNOWN-FASTPATH-WRITE-PUSH-ARRAYAPPENDANY-CALLER-ORIENTATION-CONTRACT-ARTIFACT-001.md"
CONTRACT="$ROOT/lang/src/compiler/lib/write_push_arrayappendany_caller_orientation_contract.hako"
POLICY="$ROOT/lang/src/compiler/lib/write_push_surface_policy_classifier.hako"
ARTIFACT="$ROOT/src/mir/generic_method_route_plan/generated/write_push_arrayappendany_caller_orientation_contract.rs"
POLICY_ARTIFACT="$ROOT/src/mir/generic_method_route_plan/generated/write_push_hako_policy.rs"
GENERATED_MOD="$ROOT/src/mir/generic_method_route_plan/generated/mod.rs"
GENERATOR="$ROOT/tools/rust_lifecycle/generate_write_push_arrayappendany_caller_orientation_contract.py"
...
token = "MIRBUILDER-SCALAR-KNOWN-FASTPATH-WRITE-PUSH-ARRAYAPPENDANY-CALLER-ORIENTATION-CONTRACT-ARTIFACT-001"
next_card = "MIRBUILDER-SCALAR-KNOWN-FASTPATH-WRITE-SET-MAPSTORE-ANY-CALLER-ORIENTATION-CONTRACT-ARTIFACT-001"
...
need("pub(super) mod write_push_arrayappendany_caller_orientation_contract;" in generated_mod, "generated module missing")
need("write_push_hako_route_authority_pilot_decision" in shadow, "Push Rust oracle missing")
for source in (root / "src/mir").rglob("*.rs"):
    if source == artifact_path:
        continue
    need("WRITE_PUSH_ARRAYAPPENDANY_CALLER_ORIENTATION_CONTRACT" not in source.read_text(encoding="utf-8"), f"live consumer registered caller contract: {source.relative_to(root)}")
claims = fixture.get("claims") or {}
for key in [
    "push_caller_orientation_hako_contract_materialized", "push_caller_orientation_generated_typed_artifact",
    "push_caller_orientation_policy_row_reference_verified", "push_caller_orientation_artifact_current",
    "push_caller_orientation_no_live_consumer_guard", "push_hako_route_decision_authority_retained",
    "push_rust_oracle_compat_checker_retained", "push_mismatch_fail_fast",
]:
...
for key in [
    ...
    "value_boundary_copied_to_caller_contract", "caller_orientation_live_consumer", "caller_orientation_runtime_path",
    "route_selection_authority_switch", "hako_runtime_route_authority", "scalar_known_hako_runtime_route_authority",
    ...
    "backend_lowering_authority", "runtime_fallback", "new_backend_route", "new_abi", "source_selfhost_claim",
]:
    need(claims.get(key) == 0, f"non-claim drift: {key}")
print("output_contract=rust-lifecycle-mirbuilder-scalar-known-fastpath-write-push-arrayappendany-caller-orientation-contract-artifact")
print("push_caller_orientation_generated_typed_artifact=1")
print("push_caller_orientation_no_live_consumer_guard=1")
