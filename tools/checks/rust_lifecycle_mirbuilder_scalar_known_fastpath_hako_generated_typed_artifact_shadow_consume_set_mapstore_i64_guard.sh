...
need("scalar_known_hako_shadow::mapstore_i64_shadow_consumed_decision()" in write_routes, "fast path no longer consumes shadow decision")
need("map_store_i64_set_surface|SetSurfacePolicy|MapStoreI64" in hako_policy, "hako source row missing")
need("read_policy_row" in generator and "MapStoreI64 policy row" in generator, "generator does not read policy row")
