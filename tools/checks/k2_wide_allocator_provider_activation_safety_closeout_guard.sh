...
require_text "$RUNTIME_OWNER" "SAFETY_GATE_INACTIVE_ACTIONS"
require_text "$RUNTIME_OWNER" "inactive.activation_gate_open"
require_text "$RUNTIME_OWNER" "inactive.would_open_activation_gate"
require_text "$RUNTIME_OWNER" "inactive.would_activate_hook"
