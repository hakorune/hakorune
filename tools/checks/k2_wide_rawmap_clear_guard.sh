...
rg -F -q 'pub(super) fn map_slot_clear(handle: i64) -> i64' "$MAP_SLOT_MUTATE_FILE"
rg -F -q 'nyash.map.clear_h' "$MAP_ALIASES_FILE"
rg -F -q 'method_name == MAP_METHOD_CLEAR' "$MIR_COLLECTION_FILE"
