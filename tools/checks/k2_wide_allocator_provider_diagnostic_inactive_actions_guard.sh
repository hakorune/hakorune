...
require_text "$REGISTRY_SOURCE" "REGISTRY_SNAPSHOT_INACTIVE_ACTIONS"
require_text "$REGISTRY_SOURCE" "SAFETY_GATE_INACTIVE_ACTIONS"
require_text "$REGISTRY_SOURCE" "diagnostic_actions.would_select_provider"
require_text "$REGISTRY_SOURCE" "inactive.active_registry_built"
require_text "$REGISTRY_SOURCE" "inactive.activation_gate_open"
