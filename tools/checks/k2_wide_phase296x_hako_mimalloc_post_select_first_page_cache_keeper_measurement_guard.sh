...
guard_expect_fixed_in_file "$TAG" 'sample_count=1' "$CARD_99" "row99 must record sample count"
guard_expect_fixed_in_file "$TAG" 'sample_0_hako_external_elapsed_ms=350' "$CARD_99" "row99 must record measured elapsed"
guard_expect_fixed_in_file "$TAG" 'after_hako_elapsed_median_ms=350' "$CARD_99" "row99 must record median"
guard_expect_fixed_in_file "$TAG" 'after_hako_external_rss_median_bytes=3633152' "$CARD_99" "row99 must record rss"
