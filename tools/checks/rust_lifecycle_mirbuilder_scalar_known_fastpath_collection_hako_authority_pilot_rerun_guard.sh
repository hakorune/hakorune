...
TAG="rust-lifecycle-mirbuilder-scalar-known-fastpath-collection-hako-authority-pilot-rerun"

source "$ROOT/tools/checks/lib/guard_common.sh"

FIXTURE="$ROOT/docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-scalar-known-fastpath-collection-hako-authority-pilot-rerun-v0.json"
TOOL="$ROOT/tools/rust_lifecycle/mirbuilder_scalar_known_fastpath_collection_hako_authority_pilot_rerun.py"
CARD="$ROOT/docs/development/current/main/phases/phase-296x/3398-MIRBUILDER-SCALAR-KNOWN-FASTPATH-COLLECTION-HAKO-AUTHORITY-PILOT-RERUN-001.md"
NEXT_CARD="$ROOT/docs/development/current/main/phases/phase-296x/3399-MIRBUILDER-SCALAR-KNOWN-FASTPATH-READ-SURFACE-AUTHORITY-CLOSEOUT-DESIGN-STOP-001.md"
...
next_token = "MIRBUILDER-SCALAR-KNOWN-FASTPATH-READ-SURFACE-AUTHORITY-CLOSEOUT-DESIGN-STOP-001"

need(fixture.get("kind") == "MirBuilderScalarKnownFastpathCollectionHakoAuthorityPilotRerunV1", "bad kind")
...
for key in [
    "collection_hako_authority_pilot_rerun",
...
print("output_contract=rust-lifecycle-mirbuilder-scalar-known-fastpath-collection-hako-authority-pilot-rerun")
print("collection_hako_authority_pilot_rerun=1")
print("collection_hako_route_decision_authority_pilot=1")
print("read_surface_authority_closeout_design_required=1")
