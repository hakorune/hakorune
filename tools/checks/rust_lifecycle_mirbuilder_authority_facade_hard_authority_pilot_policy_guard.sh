...
need(state.get("latest_card") in [token, next_card, follow_on_card], "CURRENT_STATE latest card drift")
need(state.get("latest_card_path") in [str(card_path), next_card_path, follow_on_card_path], "CURRENT_STATE latest path drift")
