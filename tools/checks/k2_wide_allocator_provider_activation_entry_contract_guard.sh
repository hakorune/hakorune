...
require_text "$CURRENT_STATE" 'latest_card = "293x-128-M76-ALLOCATOR-PROVIDER-ACTIVATION-ENTRY-CONTRACT"'
require_text "$CURRENT_STATE" 'latest_card_path = "docs/development/current/main/phases/phase-293x/293x-128-M76-ALLOCATOR-PROVIDER-ACTIVATION-ENTRY-CONTRACT.md"'
