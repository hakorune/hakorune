...
if summary["excluded_existing_decision_cluster_count"] != 6:
    raise SystemExit("excluded existing decision count drift")
if summary["selectable_cluster_count"] != 36:
...
expected_cluster = "projection_policy::UnsupportedDirectShape::shape.other_join_i_r_plan::FixtureMapped::OtherJoinIRPlanCluster"
...
if ranked[0]["next_card"] != "MIRBUILDER-OTHER-JOIN-I-R-PLAN-PROJECTION-POLICY-001":
...
if decision["selected_next_card"] != "MIRBUILDER-OTHER-JOIN-I-R-PLAN-PROJECTION-POLICY-001":
...
if claims.get("excluded_existing_decision_cluster_count") != 6:
    raise SystemExit("excluded existing decision claim drift")
if claims.get("selectable_cluster_count") != 36:
...
selected_next_card=MIRBUILDER-OTHER-JOIN-I-R-PLAN-PROJECTION-POLICY-001
