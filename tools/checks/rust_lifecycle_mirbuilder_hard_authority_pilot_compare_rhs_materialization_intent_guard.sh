...
seventh_follow_on_card = "MIRBUILDER-HARD-AUTHORITY-PILOT-COMPARE-RHS-SYMBOLREF-LOOKUP-CONTRACT-PARITY-001"
seventh_follow_on_card_path = "docs/development/current/main/phases/phase-296x/3336-MIRBUILDER-HARD-AUTHORITY-PILOT-COMPARE-RHS-SYMBOLREF-LOOKUP-CONTRACT-PARITY-001.md"
eighth_follow_on_card = "MIRBUILDER-HARD-AUTHORITY-PILOT-COMPARE-RHS-SYMBOLREF-LOOKUP-BRIDGE-001"
eighth_follow_on_card_path = "docs/development/current/main/phases/phase-296x/3337-MIRBUILDER-HARD-AUTHORITY-PILOT-COMPARE-RHS-SYMBOLREF-LOOKUP-BRIDGE-001.md"
...
need(state.get("latest_card") in [token, follow_on_card, second_follow_on_card, third_follow_on_card, fourth_follow_on_card, fifth_follow_on_card, sixth_follow_on_card, seventh_follow_on_card, eighth_follow_on_card], "CURRENT_STATE latest card drift")
need(state.get("latest_card_path") in [str(card_path), follow_on_card_path, second_follow_on_card_path, third_follow_on_card_path, fourth_follow_on_card_path, fifth_follow_on_card_path, sixth_follow_on_card_path, seventh_follow_on_card_path, eighth_follow_on_card_path], "CURRENT_STATE latest path drift")
