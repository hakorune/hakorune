...
TAG="rust-lifecycle-mirbuilder-loop-cond-co-helper-carrier-sync-projection-policy-guard"
source "$ROOT_DIR/tools/checks/lib/guard_common.sh"

FIXTURE="$ROOT_DIR/docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-loop-cond-co-helper-carrier-sync-projection-policy-v0.json"
...
CARD="$ROOT_DIR/docs/development/current/main/phases/phase-296x/1861-MIRBUILDER-LOOP-COND-CO-HELPER-CARRIER-SYNC-PROJECTION-POLICY-001.md"
...
fixture = json.loads(Path("docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-loop-cond-co-helper-carrier-sync-projection-policy-v0.json").read_text())
...
card = Path("docs/development/current/main/phases/phase-296x/1861-MIRBUILDER-LOOP-COND-CO-HELPER-CARRIER-SYNC-PROJECTION-POLICY-001.md").read_text()
...
token = "MIRBUILDER-LOOP-COND-CO-HELPER-CARRIER-SYNC-PROJECTION-POLICY-001"
if fixture.get("kind") != "MirBuilderLoopCondCoHelperCarrierSyncProjectionPolicyV1":
...
if fixture.get("decision", {}).get("selected_next_card") != "MIRBUILDER-LOOP-COND-CO-STATEMENT-LOWERING-SURFACE-CLASSIFICATION-001":
    raise SystemExit("next card drift")

report_items = {
    item["source_id"]: item
    for item in report.get("items", [])
    if item.get("loop_cond_co_helper_subcluster") == "LoopCondCoHelperCarrierSyncCluster"
}
...
cat <<'REPORT'
output_contract=rust-lifecycle-mirbuilder-loop-cond-co-helper-carrier-sync-projection-policy-v0
