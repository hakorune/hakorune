...
require_text "$RUNTIME_OWNER" "would_select_provider: false"
require_text "$RUNTIME_OWNER" "would_consume_proof: false"
require_text "$RUNTIME_OWNER" "would_prepare_rollback: false"
require_text "$RUNTIME_OWNER" "would_open_activation_gate: false"
require_text "$RUNTIME_OWNER" "would_install_hook: false"
require_text "$RUNTIME_OWNER" "would_replace_process_allocator: false"
