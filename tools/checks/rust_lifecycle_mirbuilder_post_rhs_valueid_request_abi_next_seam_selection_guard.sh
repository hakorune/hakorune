...
need(f'latest_card = "{token}"' in state or f'latest_card = "{selected_card}"' in state, "CURRENT_STATE latest card drift")
need(f'latest_card_path = "{card_path.as_posix()}"' in state or f'latest_card_path = "{follow_on_path}"' in state, "CURRENT_STATE latest path drift")
