...
TAG="rust-lifecycle-mirbuilder-direct-state-plan-refresh-hako-native-source-seed-guard"
source "$ROOT_DIR/tools/checks/lib/guard_common.sh"

TOOL="$ROOT_DIR/tools/rust_lifecycle/mirbuilder_direct_state_plan_refresh_hako_native_source_seed.py"
FIXTURE="$ROOT_DIR/docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-direct-state-plan-refresh-hako-native-source-seed-v0.json"
CARD="$ROOT_DIR/docs/development/current/main/phases/phase-296x/1992-MIRBUILDER-DIRECT-STATE-PLAN-REFRESH-HAKO-NATIVE-SOURCE-SEED-001.md"
NATIVE_SEED="$ROOT_DIR/lang/src/compiler/lib/direct_state_plan_refresh_native_seed.hako"
MODULE="$ROOT_DIR/lang/src/compiler/hako_module.toml"
GENERATED="$ROOT_DIR/lang/generated/rust_derived/hakorune_mir_builder/mirbuilder_direct_state_plan_refresh.hako"
GENERATED_MANIFEST="$ROOT_DIR/lang/generated/rust_derived/hakorune_mir_builder/mirbuilder_direct_state_plan_refresh.artifact.json"
...
guard_require_files "$TAG" "$TOOL" "$FIXTURE" "$CARD" "$NATIVE_SEED" "$MODULE" "$GENERATED" "$GENERATED_MANIFEST" "$SELECTION" "$BRIDGE_V2" "$VERIFIER"
...
fixture = json.loads(Path("docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-direct-state-plan-refresh-hako-native-source-seed-v0.json").read_text())
if fixture.get("kind") != "MirBuilderDirectStatePlanRefreshHakoNativeSourceSeedV1":
    raise SystemExit("fixture kind mismatch")
if fixture.get("token") != "MIRBUILDER-DIRECT-STATE-PLAN-REFRESH-HAKO-NATIVE-SOURCE-SEED-001":
    raise SystemExit("fixture token mismatch")
if fixture.get("family_id") != "hakorune_mir_builder::direct_state_plan_refresh":
...
if selection["decision"]["selected_owner_edge_id"] != "hakorune_mir_builder::direct_state_plan_refresh":
    raise SystemExit("selection did not select direct_state_plan_refresh")
...
if policy["mention_only_forbidden_nonclaim_blocks_clean_narrow_seed_surface"] is not False:
    raise SystemExit("mention-only forbidden nonclaim must not block clean narrow seed surface")
...
if 'lib.direct_state_plan_refresh_native_seed = "lib/direct_state_plan_refresh_native_seed.hako"' not in module:
    raise SystemExit("module export missing direct_state_plan_refresh_native_seed")
...
cat <<'REPORT'
output_contract=rust-lifecycle-mirbuilder-direct-state-plan-refresh-hako-native-source-seed-v0
family_id=hakorune_mir_builder::direct_state_plan_refresh
native_source_seed=lang/src/compiler/lib/direct_state_plan_refresh_native_seed.hako
