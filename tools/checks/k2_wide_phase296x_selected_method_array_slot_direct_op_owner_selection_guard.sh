...
require_line "$DOC" "selected_owner=llvm_block_lower_array_slot_direct_op_fusion"
require_line "$DOC" "implementation_owner_file=src/llvm_py/builders/block_lower.py"
require_line "$DOC" "helper_owner_file=src/llvm_py/instructions/array_slot_direct_op.py"
...
require_line "$REPORT" "selected_owner=llvm_block_lower_array_slot_direct_op_fusion"
require_line "$REPORT" "implementation_owner_file=src/llvm_py/builders/block_lower.py"
require_line "$REPORT" "helper_owner_file=src/llvm_py/instructions/array_slot_direct_op.py"
