...
TAG="rust-lifecycle-mirbuilder-programjson-layer4-exit-recipe-dto-expanded-return-retire-rust-astnode-projector-candidate-guard"

source "$ROOT_DIR/tools/checks/lib/guard_common.sh"

FIXTURE="$ROOT_DIR/docs/development/current/main/design/fixtures/rust-lifecycle/mirbuilder-programjson-layer4-exit-recipe-dto-expanded-return-retire-rust-astnode-projector-candidate-v0.json"
PARITY_GATE="$ROOT_DIR/tools/checks/rust_lifecycle_mirbuilder_programjson_layer4_exit_recipe_dto_expanded_return_parity_gate.sh"
...
do
  if ! grep -q "$required" <<<"$PARITY_OUT"; then
    printf '%s\n' "$PARITY_OUT" >&2
    guard_fail "$TAG" "expanded Return Exit Recipe DTO prerequisite drift: $required"
  fi
done
...
if fixture.get("kind") != "MirBuilderProgramJsonLayer4ExitRecipeDtoExpandedReturnRustAstNodeProjectorRetireCandidateV1":
    raise SystemExit("bad fixture kind")
if fixture.get("token") != "MIRBUILDER-PROGRAMJSON-LAYER4-EXIT-RECIPE-DTO-EXPANDED-RETURN-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001":
    raise SystemExit("bad fixture token")

expected_hashes = {
    "hako_snapshot_source_hash": "sha256:d9f1cb3d6f94e0818269821f96babc4e67b6b0d83496386b363897608a3003c8",
    "if_handler_source_hash": "sha256:3a4453ff641552a5fc78748cf30fcf875662fd15dcea45ee1fd74a8a4768960c",
    "parity_fixture_hash": "sha256:3bdd20f11da3bbad53e4e3b3243159c8f5a26bf62f8ef224c619462e9559f60a",
    "parity_gate_hash": "sha256:cbfc043aef03ccc85f64cb48c27c36ed7a62ee3f36d7c4a4ecbc58a9c125468b",
}
...
if scope.get("shape_scope") != "expanded Return payload ProgramJSON Layer4 Exit Recipe DTO rows":
...
expected_criteria = {
    "expanded_return_exit_snapshot_parity_gate": "Green",
...
cat <<'REPORT'
output_contract=rust-lifecycle-mirbuilder-programjson-layer4-exit-recipe-dto-expanded-return-retire-rust-astnode-projector-candidate-guard-v0
token=MIRBUILDER-PROGRAMJSON-LAYER4-EXIT-RECIPE-DTO-EXPANDED-RETURN-RUST-ASTNODE-PROJECTOR-RETIRE-CANDIDATE-001
retire_candidate=ExitRecipeDtoSnapshotV1
shape_scope=expanded Return payload ProgramJSON Layer4 Exit Recipe DTO rows
covered_rows=6
deferred_rows=
decision=RetireCandidateScoped
expanded_return_exit_parity_gate=green
programjson_runtime_parity_green=1
legacy_exit_parity_guard_still_green=1
loop_body_exit_parity_guard_still_green=1
