...
echo "[vm-plugin-smoke] delegate: phase29cc CounterBox + Wave-1 pilots + Wave-2 Json/TOML pilot smokes"
...
bash tools/smokes/v2/profiles/integration/apps/phase29cc_plg05_json_pilot_vm.sh
bash tools/smokes/v2/profiles/integration/apps/phase29cc_plg05_toml_pilot_vm.sh
