# Hakmem Random Mixed System Fixture

This directory vendors the minimal `hakmem` random-mixed allocation benchmark
needed for Hakorune LD_PRELOAD allocator replacement checks.
...
```sh
benchmarks/external/hakmem/random-mixed-system/build/bench_random_mixed_system 1000 128 42
```

Expected stdout contains:

```text
Throughput = <ops/s> ops/s [iter=<n> ws=<n>] time=<s>s
```
