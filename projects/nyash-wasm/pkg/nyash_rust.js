...
export class NyashWasm {
    ...
    version() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.nyashwasm_version(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
if (Symbol.dispose) NyashWasm.prototype[Symbol.dispose] = NyashWasm.prototype.free;
